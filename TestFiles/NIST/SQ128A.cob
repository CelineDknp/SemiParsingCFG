...
001900     Linux.                                                       SQ1284.2
002000 OBJECT-COMPUTER.                                                 SQ1284.2
002100     Linux.                                                       SQ1284.2
002200 INPUT-OUTPUT SECTION.                                            SQ1284.2
002300 FILE-CONTROL.                                                    SQ1284.2
002400*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1284.2
002500*P   "XXXXX062"                                                   SQ1284.2
002600*P          ORGANIZATION IS INDEXED                               SQ1284.2
002700*P          ACCESS MODE IS RANDOM                                 SQ1284.2
002800*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1284.2
002900     SELECT PRINT-FILE ASSIGN TO                                  SQ1284.2
003000     "report.log".                                                SQ1284.2
...
003900*P                                                                SQ1284.2
004000*PD  RAW-DATA.                                                    SQ1284.2
004100*P                                                                SQ1284.2
004200*P1  RAW-DATA-SATZ.                                               SQ1284.2
004300*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1284.2
004400*P   05  C-DATE              PIC 9(6).                            SQ1284.2
004500*P   05  C-TIME              PIC 9(8).                            SQ1284.2
004600*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1284.2
004700*P   05  C-OK                PIC 999.                             SQ1284.2
004800*P   05  C-ALL               PIC 999.                             SQ1284.2
004900*P   05  C-FAIL              PIC 999.                             SQ1284.2
005000*P   05  C-DELETED           PIC 999.                             SQ1284.2
005100*P   05  C-INSPECT           PIC 999.                             SQ1284.2
005200*P   05  C-NOTE              PIC X(13).                           SQ1284.2
005300*P   05  C-INDENT            PIC X.                               SQ1284.2
005400*P   05  C-ABORT             PIC X(8).                            SQ1284.2
005500 FD  PRINT-FILE                                                   SQ1284.2
005600*C   LABEL RECORDS                                                SQ1284.2
005700*C       OMITTED                                                  SQ1284.2
005800*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1284.2
005900               .                                                  SQ1284.2
006000 01  PRINT-REC PICTURE X(120).                                    SQ1284.2
006100 01  DUMMY-RECORD PICTURE X(120).                                 SQ1284.2
006200 FD  SQ-FS1                                                       SQ1284.2
006300*C   LABEL RECORD STANDARD                                        SQ1284.2
006400     DATA RECORD IS SQ-FS1R1-F-G-120.                             SQ1284.2
006500 01  SQ-FS1R1-F-G-120 PIC X(120).                                 SQ1284.2
006600 FD  SQ-FS2                                                       SQ1284.2
006700*C   LABEL RECORD STANDARD                                        SQ1284.2
...
025400*P   OPEN I-O RAW-DATA.                                           SQ1284.2
025500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1284.2
025600*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1284.2
025700*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1284.2
025800*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1284.2
025900*P   ACCEPT C-DATE  FROM DATE.                                    SQ1284.2
026000*P   ACCEPT C-TIME  FROM TIME.                                    SQ1284.2
026100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1284.2
026200*PND-E-1.                                                         SQ1284.2
026300*P   CLOSE RAW-DATA.                                              SQ1284.2
...
027800*P   OPEN I-O RAW-DATA.                                           SQ1284.2
027900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1284.2
028000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1284.2
028100*P   MOVE "OK.     " TO C-ABORT.                                  SQ1284.2
028200*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1284.2
028300*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1284.2
028400*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1284.2
028500*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1284.2
028600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1284.2
028700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1284.2
028800*PND-E-2.                                                         SQ1284.2
028900*P   CLOSE RAW-DATA.                                              SQ1284.2
029000 TERMINATE-CCVS.                                                  SQ1284.2
029100*S   EXIT PROGRAM.                                                SQ1284.2
029200*SERMINATE-CALL.                                                  SQ1284.2
...
035700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1284.2
