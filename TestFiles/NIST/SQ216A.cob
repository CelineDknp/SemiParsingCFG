...
003100     Linux.                                                       SQ2164.2
003200 OBJECT-COMPUTER.                                                 SQ2164.2
003300     Linux.                                                       SQ2164.2
003400 INPUT-OUTPUT SECTION.                                            SQ2164.2
003500 FILE-CONTROL.                                                    SQ2164.2
003600*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2164.2
003700*P   "XXXXX062"                                                   SQ2164.2
003800*P          ORGANIZATION IS INDEXED                               SQ2164.2
003900*P          ACCESS MODE IS RANDOM                                 SQ2164.2
004000*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2164.2
004100     SELECT PRINT-FILE ASSIGN TO                                  SQ2164.2
004200     "report.log".                                                SQ2164.2
...
005000*P                                                                SQ2164.2
005100*PD  RAW-DATA.                                                    SQ2164.2
005200*P                                                                SQ2164.2
005300*P1  RAW-DATA-SATZ.                                               SQ2164.2
005400*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2164.2
005500*P   05  C-DATE              PIC 9(6).                            SQ2164.2
005600*P   05  C-TIME              PIC 9(8).                            SQ2164.2
005700*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2164.2
005800*P   05  C-OK                PIC 999.                             SQ2164.2
005900*P   05  C-ALL               PIC 999.                             SQ2164.2
006000*P   05  C-FAIL              PIC 999.                             SQ2164.2
006100*P   05  C-DELETED           PIC 999.                             SQ2164.2
006200*P   05  C-INSPECT           PIC 999.                             SQ2164.2
006300*P   05  C-NOTE              PIC X(13).                           SQ2164.2
006400*P   05  C-INDENT            PIC X.                               SQ2164.2
006500*P   05  C-ABORT             PIC X(8).                            SQ2164.2
006600 FD  PRINT-FILE                                                   SQ2164.2
006700*C   LABEL RECORDS                                                SQ2164.2
006800*C       OMITTED                                                  SQ2164.2
006900*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2164.2
007000               .                                                  SQ2164.2
007100 01  PRINT-REC PICTURE X(120).                                    SQ2164.2
007200 01  DUMMY-RECORD PICTURE X(120).                                 SQ2164.2
007300 FD  SQ-FS1                                                       SQ2164.2
007400*C   LABEL RECORD STANDARD                                        SQ2164.2
...
026000*P   OPEN I-O RAW-DATA.                                           SQ2164.2
026100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2164.2
026200*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2164.2
026300*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2164.2
026400*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2164.2
026500*P   ACCEPT C-DATE  FROM DATE.                                    SQ2164.2
026600*P   ACCEPT C-TIME  FROM TIME.                                    SQ2164.2
026700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2164.2
026800*PND-E-1.                                                         SQ2164.2
026900*P   CLOSE RAW-DATA.                                              SQ2164.2
...
028400*P   OPEN I-O RAW-DATA.                                           SQ2164.2
028500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2164.2
028600*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2164.2
028700*P   MOVE "OK.     " TO C-ABORT.                                  SQ2164.2
028800*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2164.2
028900*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2164.2
029000*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2164.2
029100*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2164.2
029200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2164.2
029300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2164.2
029400*PND-E-2.                                                         SQ2164.2
029500*P   CLOSE RAW-DATA.                                              SQ2164.2
029600 TERMINATE-CCVS.                                                  SQ2164.2
029700*S   EXIT PROGRAM.                                                SQ2164.2
029800*SERMINATE-CALL.                                                  SQ2164.2
...
036300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2164.2
