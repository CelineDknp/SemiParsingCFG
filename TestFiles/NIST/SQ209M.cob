...
002700     Linux.                                                       SQ2094.2
002800 OBJECT-COMPUTER.                                                 SQ2094.2
002900     Linux.                                                       SQ2094.2
003000 INPUT-OUTPUT SECTION.                                            SQ2094.2
003100 FILE-CONTROL.                                                    SQ2094.2
003200*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2094.2
003300*P   "XXXXX062"                                                   SQ2094.2
003400*P          ORGANIZATION IS INDEXED                               SQ2094.2
003500*P          ACCESS MODE IS RANDOM                                 SQ2094.2
003600*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2094.2
003700     SELECT PRINT-FILE ASSIGN TO                                  SQ2094.2
003800     "report.log".                                                SQ2094.2
003900 DATA DIVISION.                                                   SQ2094.2
004000 FILE SECTION.                                                    SQ2094.2
004100*P                                                                SQ2094.2
004200*PD  RAW-DATA.                                                    SQ2094.2
004300*P                                                                SQ2094.2
004400*P1  RAW-DATA-SATZ.                                               SQ2094.2
004500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2094.2
004600*P   05  C-DATE              PIC 9(6).                            SQ2094.2
004700*P   05  C-TIME              PIC 9(8).                            SQ2094.2
004800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2094.2
004900*P   05  C-OK                PIC 999.                             SQ2094.2
005000*P   05  C-ALL               PIC 999.                             SQ2094.2
005100*P   05  C-FAIL              PIC 999.                             SQ2094.2
005200*P   05  C-DELETED           PIC 999.                             SQ2094.2
005300*P   05  C-INSPECT           PIC 999.                             SQ2094.2
005400*P   05  C-NOTE              PIC X(13).                           SQ2094.2
005500*P   05  C-INDENT            PIC X.                               SQ2094.2
005600*P   05  C-ABORT             PIC X(8).                            SQ2094.2
005700 FD  PRINT-FILE                                                   SQ2094.2
005800*C   LABEL RECORDS                                                SQ2094.2
005900*C       OMITTED                                                  SQ2094.2
006000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2094.2
...
024900*P   OPEN I-O RAW-DATA.                                           SQ2094.2
025000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2094.2
025100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2094.2
025200*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2094.2
025300*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2094.2
025400*P   ACCEPT C-DATE  FROM DATE.                                    SQ2094.2
025500*P   ACCEPT C-TIME  FROM TIME.                                    SQ2094.2
025600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2094.2
025700*PND-E-1.                                                         SQ2094.2
025800*P   CLOSE RAW-DATA.                                              SQ2094.2
...
026600*P   OPEN I-O RAW-DATA.                                           SQ2094.2
026700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2094.2
026800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2094.2
026900*P   MOVE "OK.     " TO C-ABORT.                                  SQ2094.2
027000*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2094.2
027100*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2094.2
027200*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2094.2
027300*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2094.2
027400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2094.2
027500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2094.2
027600*PND-E-2.                                                         SQ2094.2
027700*P   CLOSE RAW-DATA.                                              SQ2094.2
027800 TERMINATE-CCVS.                                                  SQ2094.2
027900*S   EXIT PROGRAM.                                                SQ2094.2
028000*SERMINATE-CALL.                                                  SQ2094.2
...
034500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2094.2
