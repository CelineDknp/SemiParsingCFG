...
005200*P          ACCESS MODE IS RANDOM                                 SQ1274.2
...
006800*P   05  C-TIME              PIC 9(8).                            SQ1274.2
006900*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1274.2
...
027500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1274.2
027600*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1274.2
027700*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1274.2
027800*P   ACCEPT C-DATE  FROM DATE.                                    SQ1274.2
027900*P   ACCEPT C-TIME  FROM TIME.                                    SQ1274.2
028000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1274.2
028100*PND-E-1.                                                         SQ1274.2
...
029800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1274.2
...
037600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1274.2
