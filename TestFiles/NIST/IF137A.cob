...
029600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IF1374.2
...
rogerw     COMPUTE WS-NUM = FUNCTION STANDARD-DEVIATION (4 0 5 3 7).
