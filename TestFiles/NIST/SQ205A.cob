...
002000     Linux.                                                       SQ2054.2
002100 OBJECT-COMPUTER.                                                 SQ2054.2
002200     Linux.                                                       SQ2054.2
002300 INPUT-OUTPUT SECTION.                                            SQ2054.2
002400 FILE-CONTROL.                                                    SQ2054.2
002500*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2054.2
002600*P   "XXXXX062"                                                   SQ2054.2
002700*P          ORGANIZATION IS INDEXED                               SQ2054.2
002800*P          ACCESS MODE IS RANDOM                                 SQ2054.2
002900*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2054.2
003000     SELECT PRINT-FILE ASSIGN TO                                  SQ2054.2
003100     "report.log".                                                SQ2054.2
...
004300*P                                                                SQ2054.2
004400*PD  RAW-DATA.                                                    SQ2054.2
004500*P                                                                SQ2054.2
004600*P1  RAW-DATA-SATZ.                                               SQ2054.2
004700*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2054.2
004800*P   05  C-DATE              PIC 9(6).                            SQ2054.2
004900*P   05  C-TIME              PIC 9(8).                            SQ2054.2
005000*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2054.2
005100*P   05  C-OK                PIC 999.                             SQ2054.2
005200*P   05  C-ALL               PIC 999.                             SQ2054.2
005300*P   05  C-FAIL              PIC 999.                             SQ2054.2
005400*P   05  C-DELETED           PIC 999.                             SQ2054.2
005500*P   05  C-INSPECT           PIC 999.                             SQ2054.2
005600*P   05  C-NOTE              PIC X(13).                           SQ2054.2
005700*P   05  C-INDENT            PIC X.                               SQ2054.2
005800*P   05  C-ABORT             PIC X(8).                            SQ2054.2
005900 FD  PRINT-FILE                                                   SQ2054.2
006000*C   LABEL RECORDS                                                SQ2054.2
006100*C       OMITTED                                                  SQ2054.2
006200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2054.2
006300               .                                                  SQ2054.2
006400 01  PRINT-REC PICTURE X(120).                                    SQ2054.2
006500 01  DUMMY-RECORD PICTURE X(120).                                 SQ2054.2
006600 FD  SQ-FS1                                                       SQ2054.2
006700*C   LABEL RECORD IS STANDARD                                     SQ2054.2
006800     BLOCK CONTAINS 5 RECORDS.                                    SQ2054.2
006900 01  SQ-FS1R1-F-G-120 PIC X(120).                                 SQ2054.2
007000 FD  SQ-FS2                                                       SQ2054.2
007100*C   LABEL RECORD IS STANDARD                                     SQ2054.2
...
028300*P   OPEN I-O RAW-DATA.                                           SQ2054.2
028400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2054.2
028500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2054.2
028600*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2054.2
028700*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2054.2
028800*P   ACCEPT C-DATE  FROM DATE.                                    SQ2054.2
028900*P   ACCEPT C-TIME  FROM TIME.                                    SQ2054.2
029000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2054.2
029100*PND-E-1.                                                         SQ2054.2
029200*P   CLOSE RAW-DATA.                                              SQ2054.2
...
030700*P   OPEN I-O RAW-DATA.                                           SQ2054.2
030800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2054.2
030900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2054.2
031000*P   MOVE "OK.     " TO C-ABORT.                                  SQ2054.2
031100*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2054.2
031200*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2054.2
031300*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2054.2
031400*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2054.2
031500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2054.2
031600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2054.2
031700*PND-E-2.                                                         SQ2054.2
031800*P   CLOSE RAW-DATA.                                              SQ2054.2
031900 TERMINATE-CCVS.                                                  SQ2054.2
032000*S   EXIT PROGRAM.                                                SQ2054.2
032100*SERMINATE-CALL.                                                  SQ2054.2
...
038600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2054.2
