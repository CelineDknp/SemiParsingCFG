...
001900     Linux.                                                       SQ2044.2
002000 OBJECT-COMPUTER.                                                 SQ2044.2
002100     Linux.                                                       SQ2044.2
002200 INPUT-OUTPUT SECTION.                                            SQ2044.2
002300 FILE-CONTROL.                                                    SQ2044.2
002400*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2044.2
002500*P   "XXXXX062"                                                   SQ2044.2
002600*P          ORGANIZATION IS INDEXED                               SQ2044.2
002700*P          ACCESS MODE IS RANDOM                                 SQ2044.2
002800*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2044.2
002900     SELECT PRINT-FILE ASSIGN TO                                  SQ2044.2
003000     "report.log".                                                SQ2044.2
...
004100*P                                                                SQ2044.2
004200*PD  RAW-DATA.                                                    SQ2044.2
004300*P                                                                SQ2044.2
004400*P1  RAW-DATA-SATZ.                                               SQ2044.2
004500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2044.2
004600*P   05  C-DATE              PIC 9(6).                            SQ2044.2
004700*P   05  C-TIME              PIC 9(8).                            SQ2044.2
004800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2044.2
004900*P   05  C-OK                PIC 999.                             SQ2044.2
005000*P   05  C-ALL               PIC 999.                             SQ2044.2
005100*P   05  C-FAIL              PIC 999.                             SQ2044.2
005200*P   05  C-DELETED           PIC 999.                             SQ2044.2
005300*P   05  C-INSPECT           PIC 999.                             SQ2044.2
005400*P   05  C-NOTE              PIC X(13).                           SQ2044.2
005500*P   05  C-INDENT            PIC X.                               SQ2044.2
005600*P   05  C-ABORT             PIC X(8).                            SQ2044.2
005700 FD  PRINT-FILE                                                   SQ2044.2
005800*C   LABEL RECORDS                                                SQ2044.2
005900*C       OMITTED                                                  SQ2044.2
006000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2044.2
006100               .                                                  SQ2044.2
006200 01  PRINT-REC PICTURE X(120).                                    SQ2044.2
006300 01  DUMMY-RECORD PICTURE X(120).                                 SQ2044.2
006400 FD  SQ-FS1                                                       SQ2044.2
006500*C   LABEL RECORDS ARE STANDARD                                   SQ2044.2
...
007100*C   LABEL RECORDS ARE STANDARD                                   SQ2044.2
...
025600*P   OPEN I-O RAW-DATA.                                           SQ2044.2
025700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2044.2
025800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2044.2
025900*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2044.2
026000*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2044.2
026100*P   ACCEPT C-DATE  FROM DATE.                                    SQ2044.2
026200*P   ACCEPT C-TIME  FROM TIME.                                    SQ2044.2
026300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2044.2
026400*PND-E-1.                                                         SQ2044.2
026500*P   CLOSE RAW-DATA.                                              SQ2044.2
...
028000*P   OPEN I-O RAW-DATA.                                           SQ2044.2
028100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2044.2
028200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2044.2
028300*P   MOVE "OK.     " TO C-ABORT.                                  SQ2044.2
028400*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2044.2
028500*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2044.2
028600*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2044.2
028700*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2044.2
028800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2044.2
028900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2044.2
029000*PND-E-2.                                                         SQ2044.2
029100*P   CLOSE RAW-DATA.                                              SQ2044.2
029200 TERMINATE-CCVS.                                                  SQ2044.2
029300*S   EXIT PROGRAM.                                                SQ2044.2
029400*SERMINATE-CALL.                                                  SQ2044.2
...
035900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2044.2
