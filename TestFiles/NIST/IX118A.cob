...
004300*P          ACCESS MODE IS RANDOM                                 IX1184.2
...
006500*P   05  C-TIME              PIC 9(8).                            IX1184.2
006600*P   05  C-NO-OF-TESTS       PIC 99.                              IX1184.2
...
007200*P   05  C-NOTE              PIC X(13).                           IX1184.2
...
043100        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1184.2
...
047700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1184.2
047800*P   MOVE "ABORTED " TO C-ABORT.                                  IX1184.2
047900*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1184.2
048000*P   ACCEPT C-DATE  FROM DATE.                                    IX1184.2
048100*P   ACCEPT C-TIME  FROM TIME.                                    IX1184.2
048200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1184.2
048300*PND-E-1.                                                         IX1184.2
...
049800*P   OPEN I-O RAW-DATA.                                           IX1184.2
...
057900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1184.2
