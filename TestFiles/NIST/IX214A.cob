...
018300     Linux.                                                       IX2144.2
018400 OBJECT-COMPUTER.                                                 IX2144.2
018500     Linux                                                        IX2144.2
...
019200*P   SELECT RAW-DATA   ASSIGN TO                                  IX2144.2
019300*P   "XXXXX062"                                                   IX2144.2
019400*P          ORGANIZATION IS INDEXED                               IX2144.2
019500*P          ACCESS MODE IS RANDOM                                 IX2144.2
019600*P          RECORD KEY IS RAW-DATA-KEY.                           IX2144.2
019700     SELECT PRINT-FILE ASSIGN TO                                  IX2144.2
019800     "report.log".                                                IX2144.2
019900     SELECT  IX-FS1                                               IX2144.2
020000     ASSIGN TO                                                    IX2144.2
020100     "XXXXX024"                                                   IX2144.2
020200*J   **** X-CARD UNDEFINED ****                                   IX2144.2
...
021100*P                                                                IX2144.2
021200*PD  RAW-DATA.                                                    IX2144.2
021300*P                                                                IX2144.2
021400*P1  RAW-DATA-SATZ.                                               IX2144.2
021500*P   05  RAW-DATA-KEY        PIC X(6).                            IX2144.2
021600*P   05  C-DATE              PIC 9(6).                            IX2144.2
021700*P   05  C-TIME              PIC 9(8).                            IX2144.2
021800*P   05  C-NO-OF-TESTS       PIC 99.                              IX2144.2
021900*P   05  C-OK                PIC 999.                             IX2144.2
022000*P   05  C-ALL               PIC 999.                             IX2144.2
022100*P   05  C-FAIL              PIC 999.                             IX2144.2
022200*P   05  C-DELETED           PIC 999.                             IX2144.2
022300*P   05  C-INSPECT           PIC 999.                             IX2144.2
022400*P   05  C-NOTE              PIC X(13).                           IX2144.2
022500*P   05  C-INDENT            PIC X.                               IX2144.2
022600*P   05  C-ABORT             PIC X(8).                            IX2144.2
...
023100*C   LABEL RECORDS ARE STANDARD                                   IX2144.2
023200*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX2144.2
...
065600*P   OPEN I-O RAW-DATA.                                           IX2144.2
065700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2144.2
065800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2144.2
065900*P   MOVE "ABORTED " TO C-ABORT.                                  IX2144.2
066000*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2144.2
066100*P   ACCEPT C-DATE  FROM DATE.                                    IX2144.2
066200*P   ACCEPT C-TIME  FROM TIME.                                    IX2144.2
066300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2144.2
066400*PND-E-1.                                                         IX2144.2
066500*P   CLOSE RAW-DATA.                                              IX2144.2
...
067900*P   OPEN I-O RAW-DATA.                                           IX2144.2
068000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2144.2
068100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2144.2
068200*P   MOVE "OK.     " TO C-ABORT.                                  IX2144.2
068300*P   MOVE PASS-COUNTER TO C-OK.                                   IX2144.2
068400*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2144.2
068500*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2144.2
068600*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2144.2
068700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2144.2
068800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2144.2
068900*PND-E-2.                                                         IX2144.2
069000*P   CLOSE RAW-DATA.                                              IX2144.2
069100     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2144.2
069200 TERMINATE-CCVS.                                                  IX2144.2
069300*S   EXIT PROGRAM.                                                IX2144.2
069400*SERMINATE-CALL.                                                  IX2144.2
...
076000         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2144.2
