...
006200     Linux.                                                       IX1044.2
006300 OBJECT-COMPUTER.                                                 IX1044.2
006400     Linux.                                                       IX1044.2
006500 INPUT-OUTPUT SECTION.                                            IX1044.2
006600 FILE-CONTROL.                                                    IX1044.2
006700*P   SELECT RAW-DATA   ASSIGN TO                                  IX1044.2
006800*P   "XXXXX062"                                                   IX1044.2
006900*P          ORGANIZATION IS INDEXED                               IX1044.2
007000*P          ACCESS MODE IS RANDOM                                 IX1044.2
007100*P          RECORD KEY IS RAW-DATA-KEY.                           IX1044.2
007200     SELECT PRINT-FILE ASSIGN TO                                  IX1044.2
007300     "report.log".                                                IX1044.2
007400     SELECT   IX-FS2 ASSIGN                                       IX1044.2
007500     "XXXXX025"                                                   IX1044.2
007600*J   **** X-CARD UNDEFINED ****                                   IX1044.2
...
008300*P                                                                IX1044.2
008400*PD  RAW-DATA.                                                    IX1044.2
008500*P                                                                IX1044.2
008600*P1  RAW-DATA-SATZ.                                               IX1044.2
008700*P   05  RAW-DATA-KEY        PIC X(6).                            IX1044.2
008800*P   05  C-DATE              PIC 9(6).                            IX1044.2
008900*P   05  C-TIME              PIC 9(8).                            IX1044.2
009000*P   05  C-NO-OF-TESTS       PIC 99.                              IX1044.2
009100*P   05  C-OK                PIC 999.                             IX1044.2
009200*P   05  C-ALL               PIC 999.                             IX1044.2
009300*P   05  C-FAIL              PIC 999.                             IX1044.2
009400*P   05  C-DELETED           PIC 999.                             IX1044.2
009500*P   05  C-INSPECT           PIC 999.                             IX1044.2
009600*P   05  C-NOTE              PIC X(13).                           IX1044.2
009700*P   05  C-INDENT            PIC X.                               IX1044.2
009800*P   05  C-ABORT             PIC X(8).                            IX1044.2
...
010300*C   LABEL RECORDS ARE STANDARD                                   IX1044.2
010400*C   DATA RECORDS IX-FS2R1-F-G-240                                IX1044.2
...
035700*P   OPEN I-O RAW-DATA.                                           IX1044.2
035800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1044.2
035900*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1044.2
036000*P   MOVE "ABORTED " TO C-ABORT.                                  IX1044.2
036100*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1044.2
036200*P   ACCEPT C-DATE  FROM DATE.                                    IX1044.2
036300*P   ACCEPT C-TIME  FROM TIME.                                    IX1044.2
036400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1044.2
036500*PND-E-1.                                                         IX1044.2
036600*P   CLOSE RAW-DATA.                                              IX1044.2
...
038000*P   OPEN I-O RAW-DATA.                                           IX1044.2
038100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1044.2
038200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1044.2
038300*P   MOVE "OK.     " TO C-ABORT.                                  IX1044.2
038400*P   MOVE PASS-COUNTER TO C-OK.                                   IX1044.2
038500*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1044.2
038600*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1044.2
038700*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1044.2
038800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1044.2
038900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1044.2
039000*PND-E-2.                                                         IX1044.2
039100*P   CLOSE RAW-DATA.                                              IX1044.2
039200     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1044.2
039300 TERMINATE-CCVS.                                                  IX1044.2
039400*S   EXIT PROGRAM.                                                IX1044.2
039500*SERMINATE-CALL.                                                  IX1044.2
...
046100         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1044.2
