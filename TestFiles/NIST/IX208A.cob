...
007900     Linux.                                                       IX2084.2
008000 OBJECT-COMPUTER.                                                 IX2084.2
008100     Linux.                                                       IX2084.2
008200 INPUT-OUTPUT SECTION.                                            IX2084.2
008300 FILE-CONTROL.                                                    IX2084.2
008400*P   SELECT RAW-DATA   ASSIGN TO                                  IX2084.2
008500*P   "XXXXX062"                                                   IX2084.2
008600*P          ORGANIZATION IS INDEXED                               IX2084.2
008700*P          ACCESS MODE IS RANDOM                                 IX2084.2
008800*P          RECORD KEY IS RAW-DATA-KEY.                           IX2084.2
008900     SELECT PRINT-FILE ASSIGN TO                                  IX2084.2
009000     "report.log".                                                IX2084.2
009100     SELECT   IX-FD1                                              IX2084.2
009200        ASSIGN TO                                                 IX2084.2
009300     "XXXXX024"                                                   IX2084.2
009400*J   **** X-CARD UNDEFINED ****                                   IX2084.2
...
010200*J   **** X-CARD UNDEFINED ****                                   IX2084.2
...
010900*P                                                                IX2084.2
011000*PD  RAW-DATA.                                                    IX2084.2
011100*P                                                                IX2084.2
011200*P1  RAW-DATA-SATZ.                                               IX2084.2
011300*P   05  RAW-DATA-KEY        PIC X(6).                            IX2084.2
011400*P   05  C-DATE              PIC 9(6).                            IX2084.2
011500*P   05  C-TIME              PIC 9(8).                            IX2084.2
011600*P   05  C-NO-OF-TESTS       PIC 99.                              IX2084.2
011700*P   05  C-OK                PIC 999.                             IX2084.2
011800*P   05  C-ALL               PIC 999.                             IX2084.2
011900*P   05  C-FAIL              PIC 999.                             IX2084.2
012000*P   05  C-DELETED           PIC 999.                             IX2084.2
012100*P   05  C-INSPECT           PIC 999.                             IX2084.2
012200*P   05  C-NOTE              PIC X(13).                           IX2084.2
012300*P   05  C-INDENT            PIC X.                               IX2084.2
012400*P   05  C-ABORT             PIC X(8).                            IX2084.2
...
012900*C   LABEL RECORD IS STANDARD                                     IX2084.2
013000*C   DATA RECORD IS IX-FD1R1-F-G-240                              IX2084.2
...
013900*U   10 FILLER           PICTURE X(5).                            IX2084.2
...
014500*U   10 FILLER                    PICTURE 9(5).                   IX2084.2
014600     10 FILLER                    PICTURE X(19).                  IX2084.2
014700     10 FILLER                    PICTURE X(45).                  IX2084.2
014800 FD  IX-FS2                                                       IX2084.2
014900*C   LABEL RECORDS ARE STANDARD                                   IX2084.2
015000*C   DATA RECORD IS IX-FS2R1-F-G-240                              IX2084.2
015100          .                                                       IX2084.2
...
015900*U      10 FILLER                 PICTURE 9(5).                   IX2084.2
...
016500*U      10 FILLER                 PICTURE 9(5).                   IX2084.2
...
039300*P   OPEN I-O RAW-DATA.                                           IX2084.2
039400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2084.2
039500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2084.2
039600*P   MOVE "ABORTED " TO C-ABORT.                                  IX2084.2
039700*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2084.2
039800*P   ACCEPT C-DATE  FROM DATE.                                    IX2084.2
039900*P   ACCEPT C-TIME  FROM TIME.                                    IX2084.2
040000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2084.2
040100*PND-E-1.                                                         IX2084.2
040200*P   CLOSE RAW-DATA.                                              IX2084.2
...
041600*P   OPEN I-O RAW-DATA.                                           IX2084.2
041700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2084.2
041800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2084.2
041900*P   MOVE "OK.     " TO C-ABORT.                                  IX2084.2
042000*P   MOVE PASS-COUNTER TO C-OK.                                   IX2084.2
042100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2084.2
042200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2084.2
042300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2084.2
042400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2084.2
042500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2084.2
042600*PND-E-2.                                                         IX2084.2
042700*P   CLOSE RAW-DATA.                                              IX2084.2
042800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2084.2
042900 TERMINATE-CCVS.                                                  IX2084.2
043000*S   EXIT PROGRAM.                                                IX2084.2
043100*SERMINATE-CALL.                                                  IX2084.2
...
049700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2084.2
