...
006800     Linux.                                                       IX2054.2
006900 OBJECT-COMPUTER.                                                 IX2054.2
007000     Linux.                                                       IX2054.2
007100 INPUT-OUTPUT SECTION.                                            IX2054.2
007200 FILE-CONTROL.                                                    IX2054.2
007300*P   SELECT RAW-DATA   ASSIGN TO                                  IX2054.2
007400*P   "XXXXX062"                                                   IX2054.2
007500*P          ORGANIZATION IS INDEXED                               IX2054.2
007600*P          ACCESS MODE IS RANDOM                                 IX2054.2
007700*P          RECORD KEY IS RAW-DATA-KEY.                           IX2054.2
007800     SELECT PRINT-FILE ASSIGN TO                                  IX2054.2
007900     "report.log".                                                IX2054.2
008000     SELECT   IX-FD1  ASSIGN TO                                   IX2054.2
008100     "XXXXX024"                                                   IX2054.2
008200*J   **** X-CARD UNDEFINED ****                                   IX2054.2
...
009000*J   **** X-CARD UNDEFINED ****                                   IX2054.2
...
010000*P                                                                IX2054.2
010100*PD  RAW-DATA.                                                    IX2054.2
010200*P                                                                IX2054.2
010300*P1  RAW-DATA-SATZ.                                               IX2054.2
010400*P   05  RAW-DATA-KEY        PIC X(6).                            IX2054.2
010500*P   05  C-DATE              PIC 9(6).                            IX2054.2
010600*P   05  C-TIME              PIC 9(8).                            IX2054.2
010700*P   05  C-NO-OF-TESTS       PIC 99.                              IX2054.2
010800*P   05  C-OK                PIC 999.                             IX2054.2
010900*P   05  C-ALL               PIC 999.                             IX2054.2
011000*P   05  C-FAIL              PIC 999.                             IX2054.2
011100*P   05  C-DELETED           PIC 999.                             IX2054.2
011200*P   05  C-INSPECT           PIC 999.                             IX2054.2
011300*P   05  C-NOTE              PIC X(13).                           IX2054.2
011400*P   05  C-INDENT            PIC X.                               IX2054.2
011500*P   05  C-ABORT             PIC X(8).                            IX2054.2
...
012000*C   LABEL  RECORDS ARE STANDARD                                  IX2054.2
...
013500*C   LABEL RECORDS ARE STANDARD                                   IX2054.2
...
015200*    **** X-CARD UNDEFINED ****.                                  IX2054.2
...
036300*P   OPEN I-O RAW-DATA.                                           IX2054.2
036400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2054.2
036500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2054.2
036600*P   MOVE "ABORTED " TO C-ABORT.                                  IX2054.2
036700*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2054.2
036800*P   ACCEPT C-DATE  FROM DATE.                                    IX2054.2
036900*P   ACCEPT C-TIME  FROM TIME.                                    IX2054.2
037000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2054.2
037100*PND-E-1.                                                         IX2054.2
037200*P   CLOSE RAW-DATA.                                              IX2054.2
...
038600*P   OPEN I-O RAW-DATA.                                           IX2054.2
038700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2054.2
038800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2054.2
038900*P   MOVE "OK.     " TO C-ABORT.                                  IX2054.2
039000*P   MOVE PASS-COUNTER TO C-OK.                                   IX2054.2
039100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2054.2
039200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2054.2
039300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2054.2
039400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2054.2
039500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2054.2
039600*PND-E-2.                                                         IX2054.2
039700*P   CLOSE RAW-DATA.                                              IX2054.2
039800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2054.2
039900 TERMINATE-CCVS.                                                  IX2054.2
040000*S   EXIT PROGRAM.                                                IX2054.2
040100*SERMINATE-CALL.                                                  IX2054.2
...
046700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2054.2
