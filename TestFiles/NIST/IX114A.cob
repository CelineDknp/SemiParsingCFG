...
003500     Linux.                                                       IX1144.2
003600 OBJECT-COMPUTER.                                                 IX1144.2
003700     Linux.                                                       IX1144.2
003800 INPUT-OUTPUT SECTION.                                            IX1144.2
003900 FILE-CONTROL.                                                    IX1144.2
004000*P   SELECT RAW-DATA   ASSIGN TO                                  IX1144.2
004100*P   "XXXXX062"                                                   IX1144.2
004200*P          ORGANIZATION IS INDEXED                               IX1144.2
004300*P          ACCESS MODE IS RANDOM                                 IX1144.2
004400*P          RECORD KEY IS RAW-DATA-KEY.                           IX1144.2
004500*                                                                 IX1144.2
004600     SELECT PRINT-FILE ASSIGN TO                                  IX1144.2
004700     "report.log".                                                IX1144.2
004800*                                                                 IX1144.2
...
005900*P                                                                IX1144.2
006000*PD  RAW-DATA.                                                    IX1144.2
006100*P                                                                IX1144.2
006200*P1  RAW-DATA-SATZ.                                               IX1144.2
006300*P   05  RAW-DATA-KEY        PIC X(6).                            IX1144.2
006400*P   05  C-DATE              PIC 9(6).                            IX1144.2
006500*P   05  C-TIME              PIC 9(8).                            IX1144.2
006600*P   05  C-NO-OF-TESTS       PIC 99.                              IX1144.2
006700*P   05  C-OK                PIC 999.                             IX1144.2
006800*P   05  C-ALL               PIC 999.                             IX1144.2
006900*P   05  C-FAIL              PIC 999.                             IX1144.2
007000*P   05  C-DELETED           PIC 999.                             IX1144.2
007100*P   05  C-INSPECT           PIC 999.                             IX1144.2
007200*P   05  C-NOTE              PIC X(13).                           IX1144.2
007300*P   05  C-INDENT            PIC X.                               IX1144.2
007400*P   05  C-ABORT             PIC X(8).                            IX1144.2
007500                                                                  IX1144.2
...
008300*C      DATA RECORDS IX-FS3R1-F-G-240                             IX1144.2
008400*C      LABEL RECORD STANDARD                                     IX1144.2
...
035600*P   OPEN I-O RAW-DATA.                                           IX1144.2
035700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1144.2
035800*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1144.2
035900*P   MOVE "OK.     " TO C-ABORT.                                  IX1144.2
036000*P   MOVE PASS-COUNTER TO C-OK.                                   IX1144.2
036100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1144.2
036200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1144.2
036300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1144.2
036400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1144.2
036500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1144.2
036600*P-END-E-2.                                                       IX1144.2
036700*P   CLOSE RAW-DATA.                                              IX1144.2
...
037100*S   EXIT PROGRAM.                                                IX1144.2
037200*S-TERMINATE-CALL.                                                IX1144.2
...
043100        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1144.2
...
047500*P   OPEN I-O RAW-DATA.                                           IX1144.2
047600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1144.2
047700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1144.2
047800*P   MOVE "ABORTED " TO C-ABORT.                                  IX1144.2
047900*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1144.2
048000*P   ACCEPT C-DATE  FROM DATE.                                    IX1144.2
048100*P   ACCEPT C-TIME  FROM TIME.                                    IX1144.2
048200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1144.2
048300*PND-E-1.                                                         IX1144.2
048400*P   CLOSE RAW-DATA.                                              IX1144.2
...
049800*P   OPEN I-O RAW-DATA.                                           IX1144.2
049900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1144.2
050000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1144.2
050100*P   MOVE "OK.     " TO C-ABORT.                                  IX1144.2
050200*P   MOVE PASS-COUNTER TO C-OK.                                   IX1144.2
050300*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1144.2
050400*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1144.2
050500*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1144.2
050600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1144.2
050700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1144.2
050800*PND-E-2.                                                         IX1144.2
050900*P   CLOSE RAW-DATA.                                              IX1144.2
051000     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1144.2
051100 TERMINATE-CCVS.                                                  IX1144.2
051200*S   EXIT PROGRAM.                                                IX1144.2
051300*SERMINATE-CALL.                                                  IX1144.2
...
057900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1144.2
