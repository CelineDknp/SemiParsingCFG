...
003200     Linux.                                                       SQ2074.2
003300 OBJECT-COMPUTER.                                                 SQ2074.2
003400     Linux.                                                       SQ2074.2
003500 SPECIAL-NAMES.                                                   SQ2074.2
003600     SYSOUT                                                       SQ2074.2
003700             IS MNEMONIC-NAME.                                    SQ2074.2
003800 INPUT-OUTPUT SECTION.                                            SQ2074.2
003900 FILE-CONTROL.                                                    SQ2074.2
004000*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2074.2
004100*P   "XXXXX062"                                                   SQ2074.2
004200*P          ORGANIZATION IS INDEXED                               SQ2074.2
004300*P          ACCESS MODE IS RANDOM                                 SQ2074.2
004400*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2074.2
004500     SELECT PRINT-FILE ASSIGN TO                                  SQ2074.2
004600     "report.log".                                                SQ2074.2
004700 DATA DIVISION.                                                   SQ2074.2
004800 FILE SECTION.                                                    SQ2074.2
004900*P                                                                SQ2074.2
005000*PD  RAW-DATA.                                                    SQ2074.2
005100*P                                                                SQ2074.2
005200*P1  RAW-DATA-SATZ.                                               SQ2074.2
005300*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2074.2
005400*P   05  C-DATE              PIC 9(6).                            SQ2074.2
005500*P   05  C-TIME              PIC 9(8).                            SQ2074.2
005600*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2074.2
005700*P   05  C-OK                PIC 999.                             SQ2074.2
005800*P   05  C-ALL               PIC 999.                             SQ2074.2
005900*P   05  C-FAIL              PIC 999.                             SQ2074.2
006000*P   05  C-DELETED           PIC 999.                             SQ2074.2
006100*P   05  C-INSPECT           PIC 999.                             SQ2074.2
006200*P   05  C-NOTE              PIC X(13).                           SQ2074.2
006300*P   05  C-INDENT            PIC X.                               SQ2074.2
006400*P   05  C-ABORT             PIC X(8).                            SQ2074.2
006500 FD  PRINT-FILE                                                   SQ2074.2
006600*C   LABEL RECORDS                                                SQ2074.2
006700*C       OMITTED                                                  SQ2074.2
006800*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2074.2
006900               .                                                  SQ2074.2
...
023300*P   OPEN I-O RAW-DATA.                                           SQ2074.2
023400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2074.2
023500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2074.2
023600*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2074.2
023700*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2074.2
023800*P   ACCEPT C-DATE  FROM DATE.                                    SQ2074.2
023900*P   ACCEPT C-TIME  FROM TIME.                                    SQ2074.2
024000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2074.2
024100*PND-E-1.                                                         SQ2074.2
024200*P   CLOSE RAW-DATA.                                              SQ2074.2
...
025000*P   OPEN I-O RAW-DATA.                                           SQ2074.2
025100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2074.2
025200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2074.2
025300*P   MOVE "OK.     " TO C-ABORT.                                  SQ2074.2
025400*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2074.2
025500*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2074.2
025600*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2074.2
025700*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2074.2
025800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2074.2
025900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2074.2
026000*PND-E-2.                                                         SQ2074.2
026100*P   CLOSE RAW-DATA.                                              SQ2074.2
026200 TERMINATE-CCVS.                                                  SQ2074.2
026300*S   EXIT PROGRAM.                                                SQ2074.2
026400*SERMINATE-CALL.                                                  SQ2074.2
...
032900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2074.2
