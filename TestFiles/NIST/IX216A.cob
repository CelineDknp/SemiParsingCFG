...
008100     Linux.                                                       IX2164.2
008200 OBJECT-COMPUTER.                                                 IX2164.2
008300     Linux.                                                       IX2164.2
008400 INPUT-OUTPUT SECTION.                                            IX2164.2
008500 FILE-CONTROL.                                                    IX2164.2
008600*P   SELECT RAW-DATA   ASSIGN TO                                  IX2164.2
008700*P   "XXXXX062"                                                   IX2164.2
008800*P          ORGANIZATION IS INDEXED                               IX2164.2
008900*P          ACCESS MODE IS RANDOM                                 IX2164.2
009000*P          RECORD KEY IS RAW-DATA-KEY.                           IX2164.2
009100     SELECT PRINT-FILE ASSIGN TO                                  IX2164.2
009200     "report.log".                                                IX2164.2
009300     SELECT OPTIONAL  IX-FS2 ASSIGN                               IX2164.2
009400     "XXXXX025"                                                   IX2164.2
009500*J   **** X-CARD UNDEFINED ****                                   IX2164.2
...
010200*P                                                                IX2164.2
010300*PD  RAW-DATA.                                                    IX2164.2
010400*P                                                                IX2164.2
010500*P1  RAW-DATA-SATZ.                                               IX2164.2
010600*P   05  RAW-DATA-KEY        PIC X(6).                            IX2164.2
010700*P   05  C-DATE              PIC 9(6).                            IX2164.2
010800*P   05  C-TIME              PIC 9(8).                            IX2164.2
010900*P   05  C-NO-OF-TESTS       PIC 99.                              IX2164.2
011000*P   05  C-OK                PIC 999.                             IX2164.2
011100*P   05  C-ALL               PIC 999.                             IX2164.2
011200*P   05  C-FAIL              PIC 999.                             IX2164.2
011300*P   05  C-DELETED           PIC 999.                             IX2164.2
011400*P   05  C-INSPECT           PIC 999.                             IX2164.2
011500*P   05  C-NOTE              PIC X(13).                           IX2164.2
011600*P   05  C-INDENT            PIC X.                               IX2164.2
011700*P   05  C-ABORT             PIC X(8).                            IX2164.2
...
012200*C   LABEL RECORDS ARE STANDARD                                   IX2164.2
012300*C   DATA RECORDS IX-FS2R1-F-G-240                                IX2164.2
...
037600*P   OPEN I-O RAW-DATA.                                           IX2164.2
037700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2164.2
037800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2164.2
037900*P   MOVE "ABORTED " TO C-ABORT.                                  IX2164.2
038000*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2164.2
038100*P   ACCEPT C-DATE  FROM DATE.                                    IX2164.2
038200*P   ACCEPT C-TIME  FROM TIME.                                    IX2164.2
038300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2164.2
038400*PND-E-1.                                                         IX2164.2
038500*P   CLOSE RAW-DATA.                                              IX2164.2
...
039900*P   OPEN I-O RAW-DATA.                                           IX2164.2
040000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2164.2
040100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2164.2
040200*P   MOVE "OK.     " TO C-ABORT.                                  IX2164.2
040300*P   MOVE PASS-COUNTER TO C-OK.                                   IX2164.2
040400*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2164.2
040500*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2164.2
040600*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2164.2
040700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2164.2
040800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2164.2
040900*PND-E-2.                                                         IX2164.2
041000*P   CLOSE RAW-DATA.                                              IX2164.2
041100     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2164.2
041200 TERMINATE-CCVS.                                                  IX2164.2
041300*S   EXIT PROGRAM.                                                IX2164.2
041400*SERMINATE-CALL.                                                  IX2164.2
...
048000         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2164.2
