...
003700     Linux.                                                       SQ1414.2
003800 OBJECT-COMPUTER.                                                 SQ1414.2
003900     Linux.                                                       SQ1414.2
004000*                                                                 SQ1414.2
004100 INPUT-OUTPUT SECTION.                                            SQ1414.2
004200 FILE-CONTROL.                                                    SQ1414.2
004300     SELECT PRINT-FILE ASSIGN TO                                  SQ1414.2
004400     "report.log".                                                SQ1414.2
004500*                                                                 SQ1414.2
004600*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1414.2
004700*P   "XXXXX062"                                                   SQ1414.2
004800*P         ORGANIZATION IS INDEXED                                SQ1414.2
004900*P         ACCESS MODE  IS RANDOM                                 SQ1414.2
005000*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1414.2
005100*P                                                                SQ1414.2
...
006000*C   LABEL RECORDS                                                SQ1414.2
006100*C       OMITTED                                                  SQ1414.2
006200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1414.2
006300               .                                                  SQ1414.2
006400 01  PRINT-REC    PICTURE X(120).                                 SQ1414.2
006500 01  DUMMY-RECORD PICTURE X(120).                                 SQ1414.2
006600*P                                                                SQ1414.2
006700*PD  RAW-DATA.                                                    SQ1414.2
006800*P1  RAW-DATA-SATZ.                                               SQ1414.2
006900*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1414.2
007000*P   05  C-DATE              PIC 9(6).                            SQ1414.2
007100*P   05  C-TIME              PIC 9(8).                            SQ1414.2
007200*P   05  NO-OF-TESTS         PIC 99.                              SQ1414.2
007300*P   05  C-OK                PIC 999.                             SQ1414.2
007400*P   05  C-ALL               PIC 999.                             SQ1414.2
007500*P   05  C-FAIL              PIC 999.                             SQ1414.2
007600*P   05  C-DELETED           PIC 999.                             SQ1414.2
007700*P   05  C-INSPECT           PIC 999.                             SQ1414.2
007800*P   05  C-NOTE              PIC X(13).                           SQ1414.2
007900*P   05  C-INDENT            PIC X.                               SQ1414.2
008000*P   05  C-ABORT             PIC X(8).                            SQ1414.2
008100*                                                                 SQ1414.2
008200 FD  SQ-FS1                                                       SQ1414.2
008300*C   LABEL RECORD IS STANDARD                                     SQ1414.2
008400                .                                                 SQ1414.2
...
036100         WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES                SQ1414.2
...
041200*P   OPEN    I-O RAW-DATA.                                        SQ1414.2
041300*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1414.2
041400*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1414.2
041500*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1414.2
041600*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1414.2
041700*P   ACCEPT  C-DATE      FROM DATE.                               SQ1414.2
041800*P   ACCEPT  C-TIME      FROM TIME.                               SQ1414.2
041900*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1414.2
042000*PND-E-1.                                                         SQ1414.2
042100*P   CLOSE   RAW-DATA.                                            SQ1414.2
...
043900*P   OPEN    I-O RAW-DATA.                                        SQ1414.2
044000*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1414.2
044100*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1414.2
044200*P   MOVE   "OK.     " TO C-ABORT.                                SQ1414.2
044300*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1414.2
044400*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1414.2
044500*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1414.2
044600*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1414.2
044700*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1414.2
044800*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1414.2
044900*PND-E-2.                                                         SQ1414.2
045000*P   CLOSE   RAW-DATA.                                            SQ1414.2
045100 TERMINATE-CCVS.                                                  SQ1414.2
045200*S   EXIT    PROGRAM.                                             SQ1414.2
...
054700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1414.2
