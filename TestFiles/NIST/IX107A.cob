...
008500     Linux.                                                       IX1074.2
008600 OBJECT-COMPUTER.                                                 IX1074.2
008700     Linux.                                                       IX1074.2
008800 INPUT-OUTPUT SECTION.                                            IX1074.2
008900 FILE-CONTROL.                                                    IX1074.2
009000*P   SELECT RAW-DATA   ASSIGN TO                                  IX1074.2
009100*P   "XXXXX062"                                                   IX1074.2
009200*P          ORGANIZATION IS INDEXED                               IX1074.2
009300*P          ACCESS MODE IS RANDOM                                 IX1074.2
009400*P          RECORD KEY IS RAW-DATA-KEY.                           IX1074.2
009500     SELECT PRINT-FILE ASSIGN TO                                  IX1074.2
009600     "report.log".                                                IX1074.2
009700     SELECT IX-FS1 ASSIGN TO                                      IX1074.2
009800     "XXXXX024"                                                   IX1074.2
009900*J   **** X-CARD UNDEFINED ****                                   IX1074.2
...
010500*J   **** X-CARD UNDEFINED ****                                   IX1074.2
...
011300*P                                                                IX1074.2
011400*PD  RAW-DATA.                                                    IX1074.2
011500*P                                                                IX1074.2
011600*P1  RAW-DATA-SATZ.                                               IX1074.2
011700*P   05  RAW-DATA-KEY        PIC X(6).                            IX1074.2
011800*P   05  C-DATE              PIC 9(6).                            IX1074.2
011900*P   05  C-TIME              PIC 9(8).                            IX1074.2
012000*P   05  C-NO-OF-TESTS       PIC 99.                              IX1074.2
012100*P   05  C-OK                PIC 999.                             IX1074.2
012200*P   05  C-ALL               PIC 999.                             IX1074.2
012300*P   05  C-FAIL              PIC 999.                             IX1074.2
012400*P   05  C-DELETED           PIC 999.                             IX1074.2
012500*P   05  C-INSPECT           PIC 999.                             IX1074.2
012600*P   05  C-NOTE              PIC X(13).                           IX1074.2
012700*P   05  C-INDENT            PIC X.                               IX1074.2
012800*P   05  C-ABORT             PIC X(8).                            IX1074.2
...
013300*C   LABEL RECORD IS STANDARD                                     IX1074.2
013400*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX1074.2
...
014400*U   05 FILLER             PIC X(24).                             IX1074.2
014500     05 FILLER           PIC X(83).                               IX1074.2
014600 FD  IX-FD2                                                       IX1074.2
014700*C   LABEL RECORD IS STANDARD                                     IX1074.2
014800*C   DATA RECORD IS IX-FD2R1-F-G-240                              IX1074.2
...
015800*U   05 FILLER             PIC X(24).                             IX1074.2
...
037100*P   OPEN I-O RAW-DATA.                                           IX1074.2
037200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1074.2
037300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1074.2
037400*P   MOVE "ABORTED " TO C-ABORT.                                  IX1074.2
037500*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1074.2
037600*P   ACCEPT C-DATE  FROM DATE.                                    IX1074.2
037700*P   ACCEPT C-TIME  FROM TIME.                                    IX1074.2
037800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1074.2
037900*PND-E-1.                                                         IX1074.2
038000*P   CLOSE RAW-DATA.                                              IX1074.2
...
039400*P   OPEN I-O RAW-DATA.                                           IX1074.2
039500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1074.2
039600*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1074.2
039700*P   MOVE "OK.     " TO C-ABORT.                                  IX1074.2
039800*P   MOVE PASS-COUNTER TO C-OK.                                   IX1074.2
039900*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1074.2
040000*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1074.2
040100*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1074.2
040200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1074.2
040300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1074.2
040400*PND-E-2.                                                         IX1074.2
040500*P   CLOSE RAW-DATA.                                              IX1074.2
040600     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1074.2
040700 TERMINATE-CCVS.                                                  IX1074.2
040800*S   EXIT PROGRAM.                                                IX1074.2
040900*SERMINATE-CALL.                                                  IX1074.2
...
047500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1074.2
