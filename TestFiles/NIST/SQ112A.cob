...
004100     Linux.                                                       SQ1124.2
004200 OBJECT-COMPUTER.                                                 SQ1124.2
004300     Linux.                                                       SQ1124.2
004400 INPUT-OUTPUT SECTION.                                            SQ1124.2
004500 FILE-CONTROL.                                                    SQ1124.2
004600*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1124.2
004700*P   "XXXXX062"                                                   SQ1124.2
004800*P          ORGANIZATION IS INDEXED                               SQ1124.2
004900*P          ACCESS MODE IS RANDOM                                 SQ1124.2
005000*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1124.2
005100     SELECT PRINT-FILE ASSIGN TO                                  SQ1124.2
005200     "report.log".                                                SQ1124.2
...
005900*P                                                                SQ1124.2
006000*PD  RAW-DATA.                                                    SQ1124.2
006100*P                                                                SQ1124.2
006200*P1  RAW-DATA-SATZ.                                               SQ1124.2
006300*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1124.2
006400*P   05  C-DATE              PIC 9(6).                            SQ1124.2
006500*P   05  C-TIME              PIC 9(8).                            SQ1124.2
006600*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1124.2
006700*P   05  C-OK                PIC 999.                             SQ1124.2
006800*P   05  C-ALL               PIC 999.                             SQ1124.2
006900*P   05  C-FAIL              PIC 999.                             SQ1124.2
007000*P   05  C-DELETED           PIC 999.                             SQ1124.2
007100*P   05  C-INSPECT           PIC 999.                             SQ1124.2
007200*P   05  C-NOTE              PIC X(13).                           SQ1124.2
007300*P   05  C-INDENT            PIC X.                               SQ1124.2
007400*P   05  C-ABORT             PIC X(8).                            SQ1124.2
007500 FD  PRINT-FILE                                                   SQ1124.2
007600*C   LABEL RECORDS                                                SQ1124.2
007700*C       OMITTED                                                  SQ1124.2
007800*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1124.2
007900               .                                                  SQ1124.2
008000 01  PRINT-REC PICTURE X(120).                                    SQ1124.2
008100 01  DUMMY-RECORD PICTURE X(120).                                 SQ1124.2
008200 FD  SQ-FS1                                                       SQ1124.2
008300*C   LABEL RECORD STANDARD                                        SQ1124.2
008400                   .                                              SQ1124.2
...
026800*P   OPEN I-O RAW-DATA.                                           SQ1124.2
026900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1124.2
027000*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1124.2
027100*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1124.2
027200*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1124.2
027300*P   ACCEPT C-DATE  FROM DATE.                                    SQ1124.2
027400*P   ACCEPT C-TIME  FROM TIME.                                    SQ1124.2
027500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1124.2
027600*PND-E-1.                                                         SQ1124.2
027700*P   CLOSE RAW-DATA.                                              SQ1124.2
...
029200*P   OPEN I-O RAW-DATA.                                           SQ1124.2
029300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1124.2
029400*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1124.2
029500*P   MOVE "OK.     " TO C-ABORT.                                  SQ1124.2
029600*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1124.2
029700*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1124.2
029800*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1124.2
029900*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1124.2
030000*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1124.2
030100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1124.2
030200*PND-E-2.                                                         SQ1124.2
030300*P   CLOSE RAW-DATA.                                              SQ1124.2
030400 TERMINATE-CCVS.                                                  SQ1124.2
030500*S   EXIT PROGRAM.                                                SQ1124.2
030600*SERMINATE-CALL.                                                  SQ1124.2
...
037100         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1124.2
