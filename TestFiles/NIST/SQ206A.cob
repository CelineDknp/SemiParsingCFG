...
002100     Linux.                                                       SQ2064.2
002200 OBJECT-COMPUTER.                                                 SQ2064.2
002300     Linux.                                                       SQ2064.2
002400 INPUT-OUTPUT SECTION.                                            SQ2064.2
002500 FILE-CONTROL.                                                    SQ2064.2
002600*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2064.2
002700*P   "XXXXX062"                                                   SQ2064.2
002800*P          ORGANIZATION IS INDEXED                               SQ2064.2
002900*P          ACCESS MODE IS RANDOM                                 SQ2064.2
003000*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2064.2
003100     SELECT PRINT-FILE ASSIGN TO                                  SQ2064.2
003200     "report.log".                                                SQ2064.2
...
005200*P                                                                SQ2064.2
005300*PD  RAW-DATA.                                                    SQ2064.2
005400*P                                                                SQ2064.2
005500*P1  RAW-DATA-SATZ.                                               SQ2064.2
005600*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2064.2
005700*P   05  C-DATE              PIC 9(6).                            SQ2064.2
005800*P   05  C-TIME              PIC 9(8).                            SQ2064.2
005900*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2064.2
006000*P   05  C-OK                PIC 999.                             SQ2064.2
006100*P   05  C-ALL               PIC 999.                             SQ2064.2
006200*P   05  C-FAIL              PIC 999.                             SQ2064.2
006300*P   05  C-DELETED           PIC 999.                             SQ2064.2
006400*P   05  C-INSPECT           PIC 999.                             SQ2064.2
006500*P   05  C-NOTE              PIC X(13).                           SQ2064.2
006600*P   05  C-INDENT            PIC X.                               SQ2064.2
006700*P   05  C-ABORT             PIC X(8).                            SQ2064.2
006800 FD  PRINT-FILE                                                   SQ2064.2
006900*C   LABEL RECORDS                                                SQ2064.2
007000*C       OMITTED                                                  SQ2064.2
007100*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2064.2
007200               .                                                  SQ2064.2
007300 01  PRINT-REC PICTURE X(120).                                    SQ2064.2
007400 01  DUMMY-RECORD PICTURE X(120).                                 SQ2064.2
007500 FD  SQ-FS1                                                       SQ2064.2
007600*C   LABEL RECORDS ARE STANDARD                                   SQ2064.2
007700     BLOCK CONTAINS 120 CHARACTERS.                               SQ2064.2
007800 01  SQ-FS1R1-F-G-120   PIC X(120).                               SQ2064.2
007900 FD  SQ-FS2                                                       SQ2064.2
008000*C   LABEL RECORD IS STANDARD                                     SQ2064.2
008100                .                                                 SQ2064.2
008200 01  SQ-FS2R1-F-G-120 PIC X(120).                                 SQ2064.2
008300 FD  SQ-FS3                                                       SQ2064.2
008400*C   LABEL RECORD STANDARD                                        SQ2064.2
008500                .                                                 SQ2064.2
008600 01  SQ-FS3R1-F-G-120   PIC X(120).                               SQ2064.2
008700 FD  SQ-FS4                                                       SQ2064.2
008800*C   LABEL RECORDS STANDARD                                       SQ2064.2
008900                .                                                 SQ2064.2
...
027100*P   OPEN I-O RAW-DATA.                                           SQ2064.2
027200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2064.2
027300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2064.2
027400*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2064.2
027500*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2064.2
027600*P   ACCEPT C-DATE  FROM DATE.                                    SQ2064.2
027700*P   ACCEPT C-TIME  FROM TIME.                                    SQ2064.2
027800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2064.2
027900*PND-E-1.                                                         SQ2064.2
028000*P   CLOSE RAW-DATA.                                              SQ2064.2
...
029500*P   OPEN I-O RAW-DATA.                                           SQ2064.2
029600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2064.2
029700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2064.2
029800*P   MOVE "OK.     " TO C-ABORT.                                  SQ2064.2
029900*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2064.2
030000*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2064.2
030100*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2064.2
030200*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2064.2
030300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2064.2
030400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2064.2
030500*PND-E-2.                                                         SQ2064.2
030600*P   CLOSE RAW-DATA.                                              SQ2064.2
030700 TERMINATE-CCVS.                                                  SQ2064.2
030800*S   EXIT PROGRAM.                                                SQ2064.2
030900*SERMINATE-CALL.                                                  SQ2064.2
...
037400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2064.2
