...
011900*C   VALUE OF                                                     ST1374.2
012000*C   OCLABELID                                                    ST1374.2
012100*C   IS                                                           ST1374.2
012200*C   "OCDUMMY"                                                    ST1374.2
012300*G   SYSIN                                                        ST1374.2
...
014300*C   VALUE OF                                                     ST1374.2
014400*C   OCLABELID                                                    ST1374.2
014500*C   IS                                                           ST1374.2
014600*C   "OCDUMMY"                                                    ST1374.2
014700*G   SYSIN                                                        ST1374.2
...
019400     " $$()*+,-./0123456789;<=>ABCDEFGHIJKLMNOPQRSTUVWXYZ".       ST1374.2
...
042900*S   EXIT PROGRAM.                                                ST1374.2
043000*SERMINATE-CALL.                                                  ST1374.2
...
049600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  ST1374.2
...
055500*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
055600*X   WRITE   PRINT-REC.                                           ST1374.2
...
057800*X   WRITE PRINT-REC FROM SQ-FS1R1-F-G-132.                       ST1374.2
057900*X   WRITE PRINT-REC FROM REST-OF-1.                              ST1374.2
058000*X   MOVE SPACES TO PRINT-REC.                                    ST1374.2
...
059100*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
059200*X   WRITE   PRINT-REC.                                           ST1374.2
...
060400*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
060500*X   WRITE   PRINT-REC.                                           ST1374.2
...
062000*X   WRITE PRINT-REC FROM SQ-FS2R1-F-G-132.                       ST1374.2
062100*X   WRITE PRINT-REC FROM REST-OF-2.                              ST1374.2
062200*X   MOVE SPACES TO PRINT-REC.                                    ST1374.2
...
063100*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
063200*X   WRITE   PRINT-REC.                                           ST1374.2
...
064600*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
064700*X   WRITE   PRINT-REC.                                           ST1374.2
...
066300*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
066400*X   WRITE   PRINT-REC.                                           ST1374.2
...
067000*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
067100*X   WRITE   PRINT-REC.                                           ST1374.2
...
068700*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
068800*X   WRITE   PRINT-REC.                                           ST1374.2
...
069400*X   MOVE    SPACES TO PRINT-REC.                                 ST1374.2
069500*X   WRITE   PRINT-REC.                                           ST1374.2
...
073300*X   MOVE LENGTH-2 TO LENGTH-100.                                 ST1374.2
073400*X   WRITE PRINT-REC FROM SQ-FS2R1-F-G-132.                       ST1374.2
073500*X   WRITE PRINT-REC FROM REST-OF-2.                              ST1374.2
073600*X   MOVE 100 TO LENGTH-100.                                      ST1374.2
073700*X   MOVE SPACES TO PRINT-REC.                                    ST1374.2
