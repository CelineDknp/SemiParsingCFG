...
006200 01  SORTFILE-REC-CPY.
006300     02 SORTKEY-8-CPY       PICTURE S99 COMPUTATIONAL.                
006400     02 SORTKEY-1-CPY       PICTURE S9(6) COMPUTATIONAL.              
006500     02 SORTKEY-7-CPY       PICTURE 999.                              
006600     02 SORTKEY-3-CPY       PICTURE SV9(16).                          
006700     02 FILLER          PICTURE XX.                               
006800     02 SORTKEY-4-CPY       PICTURE X(10) JUSTIFIED RIGHT.            
006900     02 SORTKEY-6-CPY       PICTURE X(10).                            
007000     02 SORTKEY-2-CPY       PICTURE A(05) JUSTIFIED RIGHT.            
007100     02 SORTKEY-5-CPY       PICTURE A(20).                            
...
026900     MOVE     +99                 TO SORTKEY-8.                   ST1084.2
           MOVE SORTFILE-REC TO SORTFILE-REC-CPY.
      *    DISPLAY "BUILD " SORTFILE-REC-CPY.

027000 RELEASE-RECORD.                                                  ST1084.2
           MOVE SORTFILE-REC TO SORTFILE-REC-CPY.
      *    DISPLAY "RELEASE " SORTFILE-REC-CPY.
...
050800*S   EXIT PROGRAM.                                                ST1084.2
050900*SERMINATE-CALL.                                                  ST1084.2
...
057500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  ST1084.2
...
061900     PERFORM  CLOSE-FILES.                                        ST1084.2
       DSP-SORTKEY.
026000     DISPLAY SORTKEY-1 "|" SORTKEY-2 "|" SORTKEY-3 "|" SORTKEY-4
           "|" SORTKEY-5 "|" SORTKEY-6 "|" SORTKEY-7.
