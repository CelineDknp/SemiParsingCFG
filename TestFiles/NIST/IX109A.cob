...
005000     Linux.                                                       IX1094.2
005100 OBJECT-COMPUTER.                                                 IX1094.2
005200     Linux.                                                       IX1094.2
005300 INPUT-OUTPUT SECTION.                                            IX1094.2
005400 FILE-CONTROL.                                                    IX1094.2
005500*P   SELECT RAW-DATA   ASSIGN TO                                  IX1094.2
005600*P   "XXXXX062"                                                   IX1094.2
005700*P          ORGANIZATION IS INDEXED                               IX1094.2
005800*P          ACCESS MODE IS RANDOM                                 IX1094.2
005900*P          RECORD KEY IS RAW-DATA-KEY.                           IX1094.2
006000*                                                                 IX1094.2
006100     SELECT PRINT-FILE ASSIGN TO                                  IX1094.2
006200     "report.log".                                                IX1094.2
006300*                                                                 IX1094.2
...
007400*P                                                                IX1094.2
007500*PD  RAW-DATA.                                                    IX1094.2
007600*P                                                                IX1094.2
007700*P1  RAW-DATA-SATZ.                                               IX1094.2
007800*P   05  RAW-DATA-KEY        PIC X(6).                            IX1094.2
007900*P   05  C-DATE              PIC 9(6).                            IX1094.2
008000*P   05  C-TIME              PIC 9(8).                            IX1094.2
008100*P   05  C-NO-OF-TESTS       PIC 99.                              IX1094.2
008200*P   05  C-OK                PIC 999.                             IX1094.2
008300*P   05  C-ALL               PIC 999.                             IX1094.2
008400*P   05  C-FAIL              PIC 999.                             IX1094.2
008500*P   05  C-DELETED           PIC 999.                             IX1094.2
008600*P   05  C-INSPECT           PIC 999.                             IX1094.2
008700*P   05  C-NOTE              PIC X(13).                           IX1094.2
008800*P   05  C-INDENT            PIC X.                               IX1094.2
008900*P   05  C-ABORT             PIC X(8).                            IX1094.2
009000                                                                  IX1094.2
...
009800*C      DATA RECORDS IX-FS3R1-F-G-240                             IX1094.2
009900*C      LABEL RECORD STANDARD                                     IX1094.2
...
037400*P   OPEN I-O RAW-DATA.                                           IX1094.2
037500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1094.2
037600*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1094.2
037700*P   MOVE "OK.     " TO C-ABORT.                                  IX1094.2
037800*P   MOVE PASS-COUNTER TO C-OK.                                   IX1094.2
037900*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1094.2
038000*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1094.2
038100*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1094.2
038200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1094.2
038300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1094.2
038400*P-END-E-2.                                                       IX1094.2
038500*P   CLOSE RAW-DATA.                                              IX1094.2
...
038900*S   EXIT PROGRAM.                                                IX1094.2
039000*S-TERMINATE-CALL.                                                IX1094.2
...
044900        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1094.2
...
049300*P   OPEN I-O RAW-DATA.                                           IX1094.2
049400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1094.2
049500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1094.2
049600*P   MOVE "ABORTED " TO C-ABORT.                                  IX1094.2
049700*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1094.2
049800*P   ACCEPT C-DATE  FROM DATE.                                    IX1094.2
049900*P   ACCEPT C-TIME  FROM TIME.                                    IX1094.2
050000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1094.2
050100*PND-E-1.                                                         IX1094.2
050200*P   CLOSE RAW-DATA.                                              IX1094.2
...
051600*P   OPEN I-O RAW-DATA.                                           IX1094.2
051700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1094.2
051800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1094.2
051900*P   MOVE "OK.     " TO C-ABORT.                                  IX1094.2
052000*P   MOVE PASS-COUNTER TO C-OK.                                   IX1094.2
052100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1094.2
052200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1094.2
052300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1094.2
052400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1094.2
052500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1094.2
052600*PND-E-2.                                                         IX1094.2
052700*P   CLOSE RAW-DATA.                                              IX1094.2
052800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1094.2
052900 TERMINATE-CCVS.                                                  IX1094.2
053000*S   EXIT PROGRAM.                                                IX1094.2
053100*SERMINATE-CALL.                                                  IX1094.2
...
059700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1094.2
