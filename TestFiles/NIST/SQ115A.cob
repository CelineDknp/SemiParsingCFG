...
003900*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1154.2
004000*P   "XXXXX062"                                                   SQ1154.2
004100*P          ORGANIZATION IS INDEXED                               SQ1154.2
004200*P          ACCESS MODE IS RANDOM                                 SQ1154.2
004300*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1154.2
004400     SELECT PRINT-FILE ASSIGN TO                                  SQ1154.2
004500     "report.log".                                                SQ1154.2
...
005200*P                                                                SQ1154.2
005300*PD  RAW-DATA.                                                    SQ1154.2
005400*P                                                                SQ1154.2
005500*P1  RAW-DATA-SATZ.                                               SQ1154.2
005600*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1154.2
005700*P   05  C-DATE              PIC 9(6).                            SQ1154.2
005800*P   05  C-TIME              PIC 9(8).                            SQ1154.2
005900*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1154.2
006000*P   05  C-OK                PIC 999.                             SQ1154.2
006100*P   05  C-ALL               PIC 999.                             SQ1154.2
006200*P   05  C-FAIL              PIC 999.                             SQ1154.2
006300*P   05  C-DELETED           PIC 999.                             SQ1154.2
006400*P   05  C-INSPECT           PIC 999.                             SQ1154.2
006500*P   05  C-NOTE              PIC X(13).                           SQ1154.2
006600*P   05  C-INDENT            PIC X.                               SQ1154.2
006700*P   05  C-ABORT             PIC X(8).                            SQ1154.2
006800 FD  PRINT-FILE                                                   SQ1154.2
006900*C   LABEL RECORDS                                                SQ1154.2
007000*C       OMITTED                                                  SQ1154.2
007100*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1154.2
007200               .                                                  SQ1154.2
007300 01  PRINT-REC PICTURE X(120).                                    SQ1154.2
007400 01  DUMMY-RECORD PICTURE X(120).                                 SQ1154.2
007500 FD  SQ-FS5                                                       SQ1154.2
007600*C   LABEL RECORD STANDARD                                        SQ1154.2
007700                    .                                             SQ1154.2
...
026300*P   OPEN I-O RAW-DATA.                                           SQ1154.2
026400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1154.2
026500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1154.2
026600*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1154.2
026700*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1154.2
026800*P   ACCEPT C-DATE  FROM DATE.                                    SQ1154.2
026900*P   ACCEPT C-TIME  FROM TIME.                                    SQ1154.2
027000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1154.2
027100*PND-E-1.                                                         SQ1154.2
027200*P   CLOSE RAW-DATA.                                              SQ1154.2
...
028700*P   OPEN I-O RAW-DATA.                                           SQ1154.2
028800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1154.2
028900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1154.2
029000*P   MOVE "OK.     " TO C-ABORT.                                  SQ1154.2
029100*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1154.2
029200*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1154.2
029300*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1154.2
029400*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1154.2
029500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1154.2
029600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1154.2
029700*PND-E-2.                                                         SQ1154.2
029800*P   CLOSE RAW-DATA.                                              SQ1154.2
029900 TERMINATE-CCVS.                                                  SQ1154.2
030000*S   EXIT PROGRAM.                                                SQ1154.2
030100*SERMINATE-CALL.                                                  SQ1154.2
...
036600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1154.2
