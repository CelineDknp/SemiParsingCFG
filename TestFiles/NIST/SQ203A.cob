...
001900     Linux.                                                       SQ2034.2
002000 OBJECT-COMPUTER.                                                 SQ2034.2
002100     Linux.                                                       SQ2034.2
002200 INPUT-OUTPUT SECTION.                                            SQ2034.2
002300 FILE-CONTROL.                                                    SQ2034.2
002400*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2034.2
002500*P   "XXXXX062"                                                   SQ2034.2
002600*P          ORGANIZATION IS INDEXED                               SQ2034.2
002700*P          ACCESS MODE IS RANDOM                                 SQ2034.2
002800*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2034.2
002900     SELECT PRINT-FILE ASSIGN TO                                  SQ2034.2
003000     "report.log".                                                SQ2034.2
003100     SELECT OPTIONAL SQ-FS1                                       SQ2034.2
003200     ASSIGN TO                                                    SQ2034.2
003300     "XXXXX001"                                                   SQ2034.2
...
005300*P                                                                SQ2034.2
005400*PD  RAW-DATA.                                                    SQ2034.2
005500*P                                                                SQ2034.2
005600*P1  RAW-DATA-SATZ.                                               SQ2034.2
005700*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2034.2
005800*P   05  C-DATE              PIC 9(6).                            SQ2034.2
005900*P   05  C-TIME              PIC 9(8).                            SQ2034.2
006000*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2034.2
006100*P   05  C-OK                PIC 999.                             SQ2034.2
006200*P   05  C-ALL               PIC 999.                             SQ2034.2
006300*P   05  C-FAIL              PIC 999.                             SQ2034.2
006400*P   05  C-DELETED           PIC 999.                             SQ2034.2
006500*P   05  C-INSPECT           PIC 999.                             SQ2034.2
006600*P   05  C-NOTE              PIC X(13).                           SQ2034.2
006700*P   05  C-INDENT            PIC X.                               SQ2034.2
006800*P   05  C-ABORT             PIC X(8).                            SQ2034.2
006900 FD  PRINT-FILE                                                   SQ2034.2
007000*C   LABEL RECORDS                                                SQ2034.2
007100*C       OMITTED                                                  SQ2034.2
007200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2034.2
007300               .                                                  SQ2034.2
007400 01  PRINT-REC PICTURE X(120).                                    SQ2034.2
007500 01  DUMMY-RECORD PICTURE X(120).                                 SQ2034.2
007600 FD  SQ-FS1                                                       SQ2034.2
007700*C   LABEL RECORDS ARE STANDARD                                   SQ2034.2
007800     BLOCK CONTAINS 120 CHARACTERS.                               SQ2034.2
007900 01  SQ-FS1R1-F-G-120 PIC X(120).                                 SQ2034.2
008000 FD  SQ-FS2                                                       SQ2034.2
008100*C   LABEL RECORDS ARE STANDARD                                   SQ2034.2
008200     BLOCK CONTAINS 120 CHARACTERS.                               SQ2034.2
008300 01  SQ-FS2R1-F-G-120 PIC X(120).                                 SQ2034.2
008400 FD  SQ-FS3                                                       SQ2034.2
008500*C   LABEL RECORDS ARE STANDARD                                   SQ2034.2
008600     BLOCK CONTAINS 120 CHARACTERS.                               SQ2034.2
008700 01  SQ-FS3R1-F-G-120 PIC X(120).                                 SQ2034.2
008800 FD  SQ-FS4                                                       SQ2034.2
008900*C   LABEL RECORDS ARE STANDARD                                   SQ2034.2
...
028700*P   OPEN I-O RAW-DATA.                                           SQ2034.2
028800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2034.2
028900*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2034.2
029000*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2034.2
029100*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2034.2
029200*P   ACCEPT C-DATE  FROM DATE.                                    SQ2034.2
029300*P   ACCEPT C-TIME  FROM TIME.                                    SQ2034.2
029400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2034.2
029500*PND-E-1.                                                         SQ2034.2
029600*P   CLOSE RAW-DATA.                                              SQ2034.2
...
031100*P   OPEN I-O RAW-DATA.                                           SQ2034.2
031200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2034.2
031300*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2034.2
031400*P   MOVE "OK.     " TO C-ABORT.                                  SQ2034.2
031500*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2034.2
031600*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2034.2
031700*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2034.2
031800*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2034.2
031900*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2034.2
032000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2034.2
032100*PND-E-2.                                                         SQ2034.2
032200*P   CLOSE RAW-DATA.                                              SQ2034.2
032300 TERMINATE-CCVS.                                                  SQ2034.2
032400*S   EXIT PROGRAM.                                                SQ2034.2
032500*SERMINATE-CALL.                                                  SQ2034.2
...
039000         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2034.2
