...
004900     Linux.                                                       IX2014.2
005000 OBJECT-COMPUTER.                                                 IX2014.2
005100     Linux.                                                       IX2014.2
005200 INPUT-OUTPUT SECTION.                                            IX2014.2
005300 FILE-CONTROL.                                                    IX2014.2
005400*P   SELECT RAW-DATA   ASSIGN TO                                  IX2014.2
005500*P   "XXXXX062"                                                   IX2014.2
005600*P          ORGANIZATION IS INDEXED                               IX2014.2
005700*P          ACCESS MODE IS RANDOM                                 IX2014.2
005800*P          RECORD KEY IS RAW-DATA-KEY.                           IX2014.2
005900     SELECT PRINT-FILE ASSIGN TO                                  IX2014.2
006000     "report.log".                                                IX2014.2
006100     SELECT   IX-FS1 ASSIGN TO                                    IX2014.2
006200     "XXXXX024"                                                   IX2014.2
006300*J   **** X-CARD UNDEFINED ****                                   IX2014.2
...
006900*P                                                                IX2014.2
007000*PD  RAW-DATA.                                                    IX2014.2
007100*P                                                                IX2014.2
007200*P1  RAW-DATA-SATZ.                                               IX2014.2
007300*P   05  RAW-DATA-KEY        PIC X(6).                            IX2014.2
007400*P   05  C-DATE              PIC 9(6).                            IX2014.2
007500*P   05  C-TIME              PIC 9(8).                            IX2014.2
007600*P   05  C-NO-OF-TESTS       PIC 99.                              IX2014.2
007700*P   05  C-OK                PIC 999.                             IX2014.2
007800*P   05  C-ALL               PIC 999.                             IX2014.2
007900*P   05  C-FAIL              PIC 999.                             IX2014.2
008000*P   05  C-DELETED           PIC 999.                             IX2014.2
008100*P   05  C-INSPECT           PIC 999.                             IX2014.2
008200*P   05  C-NOTE              PIC X(13).                           IX2014.2
008300*P   05  C-INDENT            PIC X.                               IX2014.2
008400*P   05  C-ABORT             PIC X(8).                            IX2014.2
...
008900*C   LABEL RECORD IS STANDARD                                     IX2014.2
009000*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX2014.2
...
029900*P   OPEN I-O RAW-DATA.                                           IX2014.2
030000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2014.2
030100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2014.2
030200*P   MOVE "ABORTED " TO C-ABORT.                                  IX2014.2
030300*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2014.2
030400*P   ACCEPT C-DATE  FROM DATE.                                    IX2014.2
030500*P   ACCEPT C-TIME  FROM TIME.                                    IX2014.2
030600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2014.2
030700*PND-E-1.                                                         IX2014.2
030800*P   CLOSE RAW-DATA.                                              IX2014.2
...
032200*P   OPEN I-O RAW-DATA.                                           IX2014.2
032300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2014.2
032400*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2014.2
032500*P   MOVE "OK.     " TO C-ABORT.                                  IX2014.2
032600*P   MOVE PASS-COUNTER TO C-OK.                                   IX2014.2
032700*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2014.2
032800*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2014.2
032900*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2014.2
033000*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2014.2
033100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2014.2
033200*PND-E-2.                                                         IX2014.2
033300*P   CLOSE RAW-DATA.                                              IX2014.2
033400     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2014.2
033500 TERMINATE-CCVS.                                                  IX2014.2
033600*S   EXIT PROGRAM.                                                IX2014.2
033700*SERMINATE-CALL.                                                  IX2014.2
...
040300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2014.2
