...
004200     Linux.                                                       SQ2124.2
004300 OBJECT-COMPUTER.                                                 SQ2124.2
004400     Linux.                                                       SQ2124.2
004500 INPUT-OUTPUT SECTION.                                            SQ2124.2
004600 FILE-CONTROL.                                                    SQ2124.2
004700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2124.2
004800*P   "XXXXX062"                                                   SQ2124.2
004900*P          ORGANIZATION IS INDEXED                               SQ2124.2
005000*P          ACCESS MODE IS RANDOM                                 SQ2124.2
005100*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2124.2
005200     SELECT PRINT-FILE ASSIGN TO                                  SQ2124.2
005300     "report.log".                                                SQ2124.2
...
006100*P                                                                SQ2124.2
006200*PD  RAW-DATA.                                                    SQ2124.2
006300*P                                                                SQ2124.2
006400*P1  RAW-DATA-SATZ.                                               SQ2124.2
006500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2124.2
006600*P   05  C-DATE              PIC 9(6).                            SQ2124.2
006700*P   05  C-TIME              PIC 9(8).                            SQ2124.2
006800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2124.2
006900*P   05  C-OK                PIC 999.                             SQ2124.2
007000*P   05  C-ALL               PIC 999.                             SQ2124.2
007100*P   05  C-FAIL              PIC 999.                             SQ2124.2
007200*P   05  C-DELETED           PIC 999.                             SQ2124.2
007300*P   05  C-INSPECT           PIC 999.                             SQ2124.2
007400*P   05  C-NOTE              PIC X(13).                           SQ2124.2
007500*P   05  C-INDENT            PIC X.                               SQ2124.2
007600*P   05  C-ABORT             PIC X(8).                            SQ2124.2
007700 FD  PRINT-FILE                                                   SQ2124.2
007800*C   LABEL RECORDS                                                SQ2124.2
007900*C       OMITTED                                                  SQ2124.2
008000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2124.2
008100               .                                                  SQ2124.2
008200 01  PRINT-REC PICTURE X(120).                                    SQ2124.2
008300 01  DUMMY-RECORD PICTURE X(120).                                 SQ2124.2
008400 FD  SQ-VS7                                                       SQ2124.2
008500*C   LABEL RECORDS ARE STANDARD                                   SQ2124.2
...
010300     02  FILLER     PICTURE X(21).                                SQ2124.2
010400     02  FILLER     PICTURE X(21).                                SQ2124.2
...
038500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2124.2
...
041600*P   OPEN I-O RAW-DATA.                                           SQ2124.2
041700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2124.2
041800*P   READ RAW-DATA INVALID KEY GO TO END1-E-2.                    SQ2124.2
041900*P   MOVE "OK.     " TO C-ABORT.                                  SQ2124.2
042000*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2124.2
042100*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2124.2
042200*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2124.2
042300*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2124.2
042400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2124.2
042500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END1-E-2.            SQ2124.2
042600*PND1-E-2.                                                        SQ2124.2
042700*P   CLOSE RAW-DATA.                                              SQ2124.2
042800 TERMINATE1-CCVS.                                                 SQ2124.2
042900*S   EXIT PROGRAM.                                                SQ2124.2
043000*SERMINATE1-CALL.                                                 SQ2124.2
043100     STOP     RUN.                                                SQ2124.2
043200 END DECLARATIVES.                                                SQ2124.2
043300 CCVS1 SECTION.                                                   SQ2124.2
043400 OPEN-FILES.                                                      SQ2124.2
043500*P   OPEN I-O RAW-DATA.                                           SQ2124.2
043600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2124.2
043700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2124.2
043800*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2124.2
043900*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2124.2
044000*P   ACCEPT C-DATE  FROM DATE.                                    SQ2124.2
044100*P   ACCEPT C-TIME  FROM TIME.                                    SQ2124.2
044200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2124.2
044300*PND-E-1.                                                         SQ2124.2
044400*P   CLOSE RAW-DATA.                                              SQ2124.2
...
045400*P   OPEN I-O RAW-DATA.                                           SQ2124.2
045500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2124.2
045600*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2124.2
045700*P   MOVE "OK.     " TO C-ABORT.                                  SQ2124.2
045800*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2124.2
045900*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2124.2
046000*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2124.2
046100*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2124.2
046200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2124.2
046300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2124.2
046400*PND-E-2.                                                         SQ2124.2
046500*P   CLOSE RAW-DATA.                                              SQ2124.2
046600 TERMINATE-CCVS.                                                  SQ2124.2
046700*S   EXIT PROGRAM.                                                SQ2124.2
046800*SERMINATE-CALL.                                                  SQ2124.2
...
053300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2124.2
