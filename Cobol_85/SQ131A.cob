...
004600     Linux.                                                       SQ1314.2
004700 OBJECT-COMPUTER.                                                 SQ1314.2
004800     Linux.                                                       SQ1314.2
004900*                                                                 SQ1314.2
005000 INPUT-OUTPUT SECTION.                                            SQ1314.2
005100 FILE-CONTROL.                                                    SQ1314.2
005200     SELECT PRINT-FILE ASSIGN TO                                  SQ1314.2
005300     "report.log".                                                SQ1314.2
005400*                                                                 SQ1314.2
005500*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1314.2
005600*P   "XXXXX062"                                                   SQ1314.2
005700*P         ORGANIZATION IS INDEXED                                SQ1314.2
005800*P         ACCESS MODE  IS RANDOM                                 SQ1314.2
005900*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1314.2
006000*P                                                                SQ1314.2
...
006900*C   LABEL RECORDS                                                SQ1314.2
007000*C       OMITTED                                                  SQ1314.2
007100*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1314.2
007200               .                                                  SQ1314.2
007300 01  PRINT-REC    PICTURE X(120).                                 SQ1314.2
007400 01  DUMMY-RECORD PICTURE X(120).                                 SQ1314.2
007500*P                                                                SQ1314.2
007600*PD  RAW-DATA.                                                    SQ1314.2
007700*P1  RAW-DATA-SATZ.                                               SQ1314.2
007800*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1314.2
007900*P   05  C-DATE              PIC 9(6).                            SQ1314.2
008000*P   05  C-TIME              PIC 9(8).                            SQ1314.2
008100*P   05  NO-OF-TESTS         PIC 99.                              SQ1314.2
008200*P   05  C-OK                PIC 999.                             SQ1314.2
008300*P   05  C-ALL               PIC 999.                             SQ1314.2
008400*P   05  C-FAIL              PIC 999.                             SQ1314.2
008500*P   05  C-DELETED           PIC 999.                             SQ1314.2
008600*P   05  C-INSPECT           PIC 999.                             SQ1314.2
008700*P   05  C-NOTE              PIC X(13).                           SQ1314.2
008800*P   05  C-INDENT            PIC X.                               SQ1314.2
008900*P   05  C-ABORT             PIC X(8).                            SQ1314.2
009000*                                                                 SQ1314.2
009100 FD  SQ-FS1                                                       SQ1314.2
009200*C   LABEL RECORD IS STANDARD                                     SQ1314.2
009300                .                                                 SQ1314.2
...
031600*P   OPEN    I-O RAW-DATA.                                        SQ1314.2
031700*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1314.2
031800*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1314.2
031900*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1314.2
032000*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1314.2
032100*P   ACCEPT  C-DATE      FROM DATE.                               SQ1314.2
032200*P   ACCEPT  C-TIME      FROM TIME.                               SQ1314.2
032300*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1314.2
032400*PND-E-1.                                                         SQ1314.2
032500*P   CLOSE   RAW-DATA.                                            SQ1314.2
...
034300*P   OPEN    I-O RAW-DATA.                                        SQ1314.2
034400*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1314.2
034500*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1314.2
034600*P   MOVE   "OK.     " TO C-ABORT.                                SQ1314.2
034700*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1314.2
034800*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1314.2
034900*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1314.2
035000*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1314.2
035100*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1314.2
035200*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1314.2
035300*PND-E-2.                                                         SQ1314.2
035400*P   CLOSE   RAW-DATA.                                            SQ1314.2
035500 TERMINATE-CCVS.                                                  SQ1314.2
035600*S   EXIT    PROGRAM.                                             SQ1314.2
...
045100         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1314.2
