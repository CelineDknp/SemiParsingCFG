...
003700     Linux.                                                       SQ1404.2
003800 OBJECT-COMPUTER.                                                 SQ1404.2
003900     Linux.                                                       SQ1404.2
004000*                                                                 SQ1404.2
004100 INPUT-OUTPUT SECTION.                                            SQ1404.2
004200 FILE-CONTROL.                                                    SQ1404.2
004300     SELECT PRINT-FILE ASSIGN TO                                  SQ1404.2
004400     "report.log".                                                SQ1404.2
004500*                                                                 SQ1404.2
004600*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1404.2
004700*P   "XXXXX062"                                                   SQ1404.2
004800*P         ORGANIZATION IS INDEXED                                SQ1404.2
004900*P         ACCESS MODE  IS RANDOM                                 SQ1404.2
005000*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1404.2
005100*P                                                                SQ1404.2
...
006000*C   LABEL RECORDS                                                SQ1404.2
006100*C       OMITTED                                                  SQ1404.2
006200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1404.2
006300               .                                                  SQ1404.2
006400 01  PRINT-REC    PICTURE X(120).                                 SQ1404.2
006500 01  DUMMY-RECORD PICTURE X(120).                                 SQ1404.2
006600*P                                                                SQ1404.2
006700*PD  RAW-DATA.                                                    SQ1404.2
006800*P1  RAW-DATA-SATZ.                                               SQ1404.2
006900*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1404.2
007000*P   05  C-DATE              PIC 9(6).                            SQ1404.2
007100*P   05  C-TIME              PIC 9(8).                            SQ1404.2
007200*P   05  NO-OF-TESTS         PIC 99.                              SQ1404.2
007300*P   05  C-OK                PIC 999.                             SQ1404.2
007400*P   05  C-ALL               PIC 999.                             SQ1404.2
007500*P   05  C-FAIL              PIC 999.                             SQ1404.2
007600*P   05  C-DELETED           PIC 999.                             SQ1404.2
007700*P   05  C-INSPECT           PIC 999.                             SQ1404.2
007800*P   05  C-NOTE              PIC X(13).                           SQ1404.2
007900*P   05  C-INDENT            PIC X.                               SQ1404.2
008000*P   05  C-ABORT             PIC X(8).                            SQ1404.2
008100*                                                                 SQ1404.2
008200 FD  SQ-FS1                                                       SQ1404.2
008300*C   LABEL RECORD IS STANDARD                                     SQ1404.2
008400                .                                                 SQ1404.2
...
036500     IF RECORD-COUNT GREATER 50                                   SQ1404.2
036600         MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1404.2
036700         MOVE    SPACE TO DUMMY-RECORD                            SQ1404.2
036800         WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES                SQ1404.2
036900         MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1404.2
037000         MOVE    CCVS-C-2 TO DUMMY-RECORD                         SQ1404.2
037100         PERFORM DECL-WRT-LN 2 TIMES                              SQ1404.2
037200         MOVE    HYPHEN-LINE TO DUMMY-RECORD                      SQ1404.2
037300         PERFORM DECL-WRT-LN                                      SQ1404.2
037400         MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1404.2
037500         MOVE    ZERO TO RECORD-COUNT.                            SQ1404.2
...
041900*P   OPEN    I-O RAW-DATA.                                        SQ1404.2
042000*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1404.2
042100*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1404.2
042200*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1404.2
042300*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1404.2
042400*P   ACCEPT  C-DATE      FROM DATE.                               SQ1404.2
042500*P   ACCEPT  C-TIME      FROM TIME.                               SQ1404.2
042600*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1404.2
042700*PND-E-1.                                                         SQ1404.2
042800*P   CLOSE   RAW-DATA.                                            SQ1404.2
...
044600*P   OPEN    I-O RAW-DATA.                                        SQ1404.2
044700*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1404.2
044800*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1404.2
044900*P   MOVE   "OK.     " TO C-ABORT.                                SQ1404.2
045000*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1404.2
045100*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1404.2
045200*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1404.2
045300*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1404.2
045400*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1404.2
045500*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1404.2
045600*PND-E-2.                                                         SQ1404.2
045700*P   CLOSE   RAW-DATA.                                            SQ1404.2
045800 TERMINATE-CCVS.                                                  SQ1404.2
045900*S   EXIT    PROGRAM.                                             SQ1404.2
...
055200         MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1404.2
055300         MOVE  SPACE TO DUMMY-RECORD                              SQ1404.2
055400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1404.2
055500         MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1404.2
055600         MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1404.2
055700         MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1404.2
055800         MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1404.2
055900         MOVE  ZERO TO RECORD-COUNT.                              SQ1404.2
