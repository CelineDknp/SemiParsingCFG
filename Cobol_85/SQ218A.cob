...
003300     Linux.                                                       SQ2184.2
003400 OBJECT-COMPUTER.                                                 SQ2184.2
003500     Linux.                                                       SQ2184.2
003600 INPUT-OUTPUT SECTION.                                            SQ2184.2
003700 FILE-CONTROL.                                                    SQ2184.2
003800*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2184.2
003900*P   "XXXXX062"                                                   SQ2184.2
004000*P          ORGANIZATION IS INDEXED                               SQ2184.2
004100*P          ACCESS MODE IS RANDOM                                 SQ2184.2
004200*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2184.2
004300     SELECT PRINT-FILE ASSIGN TO                                  SQ2184.2
004400     "report.log".                                                SQ2184.2
...
005100*P                                                                SQ2184.2
005200*PD  RAW-DATA.                                                    SQ2184.2
005300*P                                                                SQ2184.2
005400*P1  RAW-DATA-SATZ.                                               SQ2184.2
005500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2184.2
005600*P   05  C-DATE              PIC 9(6).                            SQ2184.2
005700*P   05  C-TIME              PIC 9(8).                            SQ2184.2
005800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2184.2
005900*P   05  C-OK                PIC 999.                             SQ2184.2
006000*P   05  C-ALL               PIC 999.                             SQ2184.2
006100*P   05  C-FAIL              PIC 999.                             SQ2184.2
006200*P   05  C-DELETED           PIC 999.                             SQ2184.2
006300*P   05  C-INSPECT           PIC 999.                             SQ2184.2
006400*P   05  C-NOTE              PIC X(13).                           SQ2184.2
006500*P   05  C-INDENT            PIC X.                               SQ2184.2
006600*P   05  C-ABORT             PIC X(8).                            SQ2184.2
006700 FD  PRINT-FILE                                                   SQ2184.2
006800*C   LABEL RECORDS                                                SQ2184.2
006900*C       OMITTED                                                  SQ2184.2
007000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2184.2
007100               .                                                  SQ2184.2
...
007600*C   LABEL RECORDS ARE STANDARD                                   SQ2184.2
007700*C   DATA RECORDS ARE SQ-VS6R1-M-G-120  SQ-VS6R2-M-G-151          SQ2184.2
007800     .                                                            SQ2184.2
...
009500     02  FILLER      PIC X(21).                                   SQ2184.2
...
027200*P   OPEN I-O RAW-DATA.                                           SQ2184.2
027300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2184.2
027400*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2184.2
027500*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2184.2
027600*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2184.2
027700*P   ACCEPT C-DATE  FROM DATE.                                    SQ2184.2
027800*P   ACCEPT C-TIME  FROM TIME.                                    SQ2184.2
027900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2184.2
028000*PND-E-1.                                                         SQ2184.2
028100*P   CLOSE RAW-DATA.                                              SQ2184.2
...
029600*P   OPEN I-O RAW-DATA.                                           SQ2184.2
029700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2184.2
029800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2184.2
029900*P   MOVE "OK.     " TO C-ABORT.                                  SQ2184.2
030000*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2184.2
030100*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2184.2
030200*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2184.2
030300*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2184.2
030400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2184.2
030500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2184.2
030600*PND-E-2.                                                         SQ2184.2
030700*P   CLOSE RAW-DATA.                                              SQ2184.2
030800 TERMINATE-CCVS.                                                  SQ2184.2
030900*S   EXIT PROGRAM.                                                SQ2184.2
031000*SERMINATE-CALL.                                                  SQ2184.2
...
037500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2184.2
