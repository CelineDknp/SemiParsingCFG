...
006400     Linux.                                                       IX2184.2
006500 OBJECT-COMPUTER.                                                 IX2184.2
006600     Linux.                                                       IX2184.2
006700 INPUT-OUTPUT SECTION.                                            IX2184.2
006800 FILE-CONTROL.                                                    IX2184.2
006900*P   SELECT RAW-DATA   ASSIGN TO                                  IX2184.2
007000*P   "XXXXX062"                                                   IX2184.2
007100*P          ORGANIZATION IS INDEXED                               IX2184.2
007200*P          ACCESS MODE IS RANDOM                                 IX2184.2
007300*P          RECORD KEY IS RAW-DATA-KEY.                           IX2184.2
007400     SELECT PRINT-FILE ASSIGN TO                                  IX2184.2
007500     "report.log".                                                IX2184.2
007600                                                                  IX2184.2
007700     SELECT OPTIONAL   IX-FS1 ASSIGN TO                           IX2184.2
007800*    SELECT            IX-FS1 ASSIGN TO                           IX2184.2
007900     "XXXXX024"                                                   IX2184.2
008000*J   **** X-CARD UNDEFINED ****                                   IX2184.2
...
008800     "XXXXX025"                                                   IX2184.2
008900*J   **** X-CARD UNDEFINED ****                                   IX2184.2
...
009700*P                                                                IX2184.2
009800*PD  RAW-DATA.                                                    IX2184.2
009900*P                                                                IX2184.2
010000*P1  RAW-DATA-SATZ.                                               IX2184.2
010100*P   05  RAW-DATA-KEY        PIC X(6).                            IX2184.2
010200*P   05  C-DATE              PIC 9(6).                            IX2184.2
010300*P   05  C-TIME              PIC 9(8).                            IX2184.2
010400*P   05  C-NO-OF-TESTS       PIC 99.                              IX2184.2
010500*P   05  C-OK                PIC 999.                             IX2184.2
010600*P   05  C-ALL               PIC 999.                             IX2184.2
010700*P   05  C-FAIL              PIC 999.                             IX2184.2
010800*P   05  C-DELETED           PIC 999.                             IX2184.2
010900*P   05  C-INSPECT           PIC 999.                             IX2184.2
011000*P   05  C-NOTE              PIC X(13).                           IX2184.2
011100*P   05  C-INDENT            PIC X.                               IX2184.2
011200*P   05  C-ABORT             PIC X(8).                            IX2184.2
...
011800*C   LABEL RECORD IS STANDARD                                     IX2184.2
011900*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX2184.2
...
013000*C   LABEL RECORD IS STANDARD                                     IX2184.2
013100*C   DATA RECORD IS IX-FS2R1-F-G-240                              IX2184.2
...
031000*P   OPEN I-O RAW-DATA.                                           IX2184.2
031100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2184.2
031200*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2184.2
031300*P   MOVE "ABORTED " TO C-ABORT.                                  IX2184.2
031400*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2184.2
031500*P   ACCEPT C-DATE  FROM DATE.                                    IX2184.2
031600*P   ACCEPT C-TIME  FROM TIME.                                    IX2184.2
031700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2184.2
031800*PND-E-1.                                                         IX2184.2
031900*P   CLOSE RAW-DATA.                                              IX2184.2
...
032600*P   OPEN I-O RAW-DATA.                                           IX2184.2
032700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2184.2
032800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2184.2
032900*P   MOVE "OK.     " TO C-ABORT.                                  IX2184.2
033000*P   MOVE PASS-COUNTER TO C-OK.                                   IX2184.2
033100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2184.2
033200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2184.2
033300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2184.2
033400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2184.2
033500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2184.2
033600*PND-E-2.                                                         IX2184.2
033700*P   CLOSE RAW-DATA IX-FS1 IX-FS2.                                IX2184.2
033800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2184.2
033900 TERMINATE-CCVS.                                                  IX2184.2
034000*S   EXIT PROGRAM.                                                IX2184.2
034100*SERMINATE-CALL.                                                  IX2184.2
...
040700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2184.2
