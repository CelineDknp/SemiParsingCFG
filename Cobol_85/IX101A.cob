...
004800     Linux.                                                       IX1014.2
004900 OBJECT-COMPUTER.                                                 IX1014.2
005000     Linux.                                                       IX1014.2
005100 INPUT-OUTPUT SECTION.                                            IX1014.2
005200 FILE-CONTROL.                                                    IX1014.2
005300*P   SELECT RAW-DATA   ASSIGN TO                                  IX1014.2
005400*P   "XXXXX062"                                                   IX1014.2
005500*P          ORGANIZATION IS INDEXED                               IX1014.2
005600*P          ACCESS MODE IS RANDOM                                 IX1014.2
005700*P          RECORD KEY IS RAW-DATA-KEY.                           IX1014.2
005800     SELECT PRINT-FILE ASSIGN TO                                  IX1014.2
005900     "report.log".                                                IX1014.2
006000     SELECT   IX-FS1 ASSIGN TO                                    IX1014.2
006100     "XXXXX024"                                                   IX1014.2
006200*J   **** X-CARD UNDEFINED ****                                   IX1014.2
...
006800*P                                                                IX1014.2
006900*PD  RAW-DATA.                                                    IX1014.2
007000*P                                                                IX1014.2
007100*P1  RAW-DATA-SATZ.                                               IX1014.2
007200*P   05  RAW-DATA-KEY        PIC X(6).                            IX1014.2
007300*P   05  C-DATE              PIC 9(6).                            IX1014.2
007400*P   05  C-TIME              PIC 9(8).                            IX1014.2
007500*P   05  C-NO-OF-TESTS       PIC 99.                              IX1014.2
007600*P   05  C-OK                PIC 999.                             IX1014.2
007700*P   05  C-ALL               PIC 999.                             IX1014.2
007800*P   05  C-FAIL              PIC 999.                             IX1014.2
007900*P   05  C-DELETED           PIC 999.                             IX1014.2
008000*P   05  C-INSPECT           PIC 999.                             IX1014.2
008100*P   05  C-NOTE              PIC X(13).                           IX1014.2
008200*P   05  C-INDENT            PIC X.                               IX1014.2
008300*P   05  C-ABORT             PIC X(8).                            IX1014.2
...
008800*C   LABEL RECORD IS STANDARD                                     IX1014.2
008900*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX1014.2
...
029800*P   OPEN I-O RAW-DATA.                                           IX1014.2
029900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1014.2
030000*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1014.2
030100*P   MOVE "ABORTED " TO C-ABORT.                                  IX1014.2
030200*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1014.2
030300*P   ACCEPT C-DATE  FROM DATE.                                    IX1014.2
030400*P   ACCEPT C-TIME  FROM TIME.                                    IX1014.2
030500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1014.2
030600*PND-E-1.                                                         IX1014.2
030700*P   CLOSE RAW-DATA.                                              IX1014.2
...
032100*P   OPEN I-O RAW-DATA.                                           IX1014.2
032200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1014.2
032300*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1014.2
032400*P   MOVE "OK.     " TO C-ABORT.                                  IX1014.2
032500*P   MOVE PASS-COUNTER TO C-OK.                                   IX1014.2
032600*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1014.2
032700*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1014.2
032800*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1014.2
032900*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1014.2
033000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1014.2
033100*PND-E-2.                                                         IX1014.2
033200*P   CLOSE RAW-DATA.                                              IX1014.2
033300     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1014.2
033400 TERMINATE-CCVS.                                                  IX1014.2
033500*S   EXIT PROGRAM.                                                IX1014.2
033600*SERMINATE-CALL.                                                  IX1014.2
...
040200         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1014.2
