...
022600*S   EXIT PROGRAM.                                                IC1144.2
022700*SERMINATE-CALL.                                                  IC1144.2
...
029300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IC1144.2
...
044400*XILE-DUMP SECTION.                                               IC1144.2
044500*XILE-DUMP-INIT.                                                  IC1144.2
044600*X   MOVE 3 TO CALL-FLAG.                                         IC1144.2
044700*X   MOVE ZERO TO EOF-FLAG COUNT-OF-RECORDS.                      IC1144.2
044800*X   CALL "IC115A" USING GROUP-LINKAGE-VARIABLES                  IC1144.2
044900*X                      FILE-REC-SQ-FS3.                          IC1144.2
045000*X   MOVE 4 TO CALL-FLAG.                                         IC1144.2
045100*XILE-3-DUMP.                                                     IC1144.2
045200*X   CALL "IC115A" USING GROUP-LINKAGE-VARIABLES                  IC1144.2
045300*X                      FILE-REC-SQ-FS3.                          IC1144.2
045400*X   IF EOF-FLAG EQUAL TO 1                                       IC1144.2
045500*X            GO TO FILE-3-DUMP-END.                              IC1144.2
045600*X   ADD 1 TO COUNT-OF-RECORDS.                                   IC1144.2
045700*X   IF COUNT-OF-RECORDS EQUAL TO 650                             IC1144.2
045800*X            PERFORM BLANK-LINE-PRINT 5 TIMES.                   IC1144.2
045900*X   MOVE FILE-REC-SQ-FS3 TO DUMMY-RECORD.                        IC1144.2
046000*X   PERFORM WRITE-LINE.                                          IC1144.2
046100*X   IF COUNT-OF-RECORDS LESS THAN 669                            IC1144.2
046200*X            GO TO FILE-3-DUMP.                                  IC1144.2
046300*XILE-3-DUMP-END.                                                 IC1144.2
046400*X   MOVE 5 TO CALL-FLAG.                                         IC1144.2
046500*X   CALL "IC115A" USING GROUP-LINKAGE-VARIABLES                  IC1144.2
046600*X                      FILE-REC-SQ-FS3.                          IC1144.2
046700*XILE-3-DUMP-EXIT.                                                IC1144.2
046800*X   EXIT.                                                        IC1144.2
