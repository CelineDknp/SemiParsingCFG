...
003200     Linux.                                                       SQ2144.2
003300 OBJECT-COMPUTER.                                                 SQ2144.2
003400     Linux.                                                       SQ2144.2
003500 INPUT-OUTPUT SECTION.                                            SQ2144.2
003600 FILE-CONTROL.                                                    SQ2144.2
003700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2144.2
003800*P   "XXXXX062"                                                   SQ2144.2
003900*P          ORGANIZATION IS INDEXED                               SQ2144.2
004000*P          ACCESS MODE IS RANDOM                                 SQ2144.2
004100*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2144.2
004200     SELECT PRINT-FILE ASSIGN TO                                  SQ2144.2
004300     "report.log".                                                SQ2144.2
004400     SELECT  SQ-FS1  ASSIGN TO                                    SQ2144.2
004500     "XXXXX014".                                                  SQ2144.2
004600 DATA DIVISION.                                                   SQ2144.2
004700 FILE SECTION.                                                    SQ2144.2
004800*P                                                                SQ2144.2
004900*PD  RAW-DATA.                                                    SQ2144.2
005000*P                                                                SQ2144.2
005100*P1  RAW-DATA-SATZ.                                               SQ2144.2
005200*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2144.2
005300*P   05  C-DATE              PIC 9(6).                            SQ2144.2
005400*P   05  C-TIME              PIC 9(8).                            SQ2144.2
005500*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2144.2
005600*P   05  C-OK                PIC 999.                             SQ2144.2
005700*P   05  C-ALL               PIC 999.                             SQ2144.2
005800*P   05  C-FAIL              PIC 999.                             SQ2144.2
005900*P   05  C-DELETED           PIC 999.                             SQ2144.2
006000*P   05  C-INSPECT           PIC 999.                             SQ2144.2
006100*P   05  C-NOTE              PIC X(13).                           SQ2144.2
006200*P   05  C-INDENT            PIC X.                               SQ2144.2
006300*P   05  C-ABORT             PIC X(8).                            SQ2144.2
006400 FD  PRINT-FILE                                                   SQ2144.2
006500*C   LABEL RECORDS                                                SQ2144.2
006600*C       OMITTED                                                  SQ2144.2
006700*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2144.2
006800               .                                                  SQ2144.2
006900 01  PRINT-REC PICTURE X(120).                                    SQ2144.2
007000 01  DUMMY-RECORD PICTURE X(120).                                 SQ2144.2
007100 FD  SQ-FS1                                                       SQ2144.2
007200*C   LABEL RECORD IS STANDARD                                     SQ2144.2
007300                .                                                 SQ2144.2
...
028200*P   OPEN I-O RAW-DATA.                                           SQ2144.2
028300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2144.2
028400*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2144.2
028500*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2144.2
028600*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2144.2
028700*P   ACCEPT C-DATE  FROM DATE.                                    SQ2144.2
028800*P   ACCEPT C-TIME  FROM TIME.                                    SQ2144.2
028900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2144.2
029000*PND-E-1.                                                         SQ2144.2
029100*P   CLOSE RAW-DATA.                                              SQ2144.2
...
030600*P   OPEN I-O RAW-DATA.                                           SQ2144.2
030700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2144.2
030800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2144.2
030900*P   MOVE "OK.     " TO C-ABORT.                                  SQ2144.2
031000*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2144.2
031100*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2144.2
031200*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2144.2
031300*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2144.2
031400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2144.2
031500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2144.2
031600*PND-E-2.                                                         SQ2144.2
031700*P   CLOSE RAW-DATA.                                              SQ2144.2
031800 TERMINATE-CCVS.                                                  SQ2144.2
031900*S   EXIT PROGRAM.                                                SQ2144.2
032000*SERMINATE-CALL.                                                  SQ2144.2
...
038500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2144.2
