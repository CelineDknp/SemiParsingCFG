...
003600     Linux.                                                       IX2124.2
003700 OBJECT-COMPUTER.                                                 IX2124.2
003800     Linux.                                                       IX2124.2
003900 INPUT-OUTPUT SECTION.                                            IX2124.2
004000 FILE-CONTROL.                                                    IX2124.2
004100*P   SELECT RAW-DATA   ASSIGN TO                                  IX2124.2
004200*P   "XXXXX062"                                                   IX2124.2
004300*P          ORGANIZATION IS INDEXED                               IX2124.2
004400*P          ACCESS MODE IS RANDOM                                 IX2124.2
004500*P          RECORD KEY IS RAW-DATA-KEY.                           IX2124.2
004600     SELECT PRINT-FILE ASSIGN TO                                  IX2124.2
004700     "report.log".                                                IX2124.2
004800     SELECT IX-FS1                                                IX2124.2
004900     ASSIGN TO                                                    IX2124.2
005000     "XXXXX024"                                                   IX2124.2
005100*J   **** X-CARD UNDEFINED ****                                   IX2124.2
...
006700*P                                                                IX2124.2
006800*PD  RAW-DATA.                                                    IX2124.2
006900*P                                                                IX2124.2
007000*P1  RAW-DATA-SATZ.                                               IX2124.2
007100*P   05  RAW-DATA-KEY        PIC X(6).                            IX2124.2
007200*P   05  C-DATE              PIC 9(6).                            IX2124.2
007300*P   05  C-TIME              PIC 9(8).                            IX2124.2
007400*P   05  C-NO-OF-TESTS       PIC 99.                              IX2124.2
007500*P   05  C-OK                PIC 999.                             IX2124.2
007600*P   05  C-ALL               PIC 999.                             IX2124.2
007700*P   05  C-FAIL              PIC 999.                             IX2124.2
007800*P   05  C-DELETED           PIC 999.                             IX2124.2
007900*P   05  C-INSPECT           PIC 999.                             IX2124.2
008000*P   05  C-NOTE              PIC X(13).                           IX2124.2
008100*P   05  C-INDENT            PIC X.                               IX2124.2
008200*P   05  C-ABORT             PIC X(8).                            IX2124.2
...
008700*C   LABEL RECORDS ARE STANDARD                                   IX2124.2
008800*C   DATA RECORD IS IX-FS1-RECORD                                 IX2124.2
...
028200*P   OPEN I-O RAW-DATA.                                           IX2124.2
028300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2124.2
028400*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2124.2
028500*P   MOVE "ABORTED " TO C-ABORT.                                  IX2124.2
028600*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2124.2
028700*P   ACCEPT C-DATE  FROM DATE.                                    IX2124.2
028800*P   ACCEPT C-TIME  FROM TIME.                                    IX2124.2
028900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2124.2
029000*PND-E-1.                                                         IX2124.2
029100*P   CLOSE RAW-DATA.                                              IX2124.2
...
029800*P   OPEN I-O RAW-DATA.                                           IX2124.2
029900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2124.2
030000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2124.2
030100*P   MOVE "OK.     " TO C-ABORT.                                  IX2124.2
030200*P   MOVE PASS-COUNTER TO C-OK.                                   IX2124.2
030300*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2124.2
030400*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2124.2
030500*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2124.2
030600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2124.2
030700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2124.2
030800*PND-E-2.                                                         IX2124.2
030900*P   CLOSE RAW-DATA.                                              IX2124.2
031000     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2124.2
031100 TERMINATE-CCVS.                                                  IX2124.2
031200*S   EXIT PROGRAM.                                                IX2124.2
031300*SERMINATE-CALL.                                                  IX2124.2
...
037900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2124.2
