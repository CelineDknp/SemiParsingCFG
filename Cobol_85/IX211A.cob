...
012800     Linux.                                                       IX2114.2
012900 OBJECT-COMPUTER.                                                 IX2114.2
013000     Linux.                                                       IX2114.2
013100 INPUT-OUTPUT SECTION.                                            IX2114.2
013200 FILE-CONTROL.                                                    IX2114.2
013300*P   SELECT RAW-DATA   ASSIGN TO                                  IX2114.2
013400*P   "XXXXX062"                                                   IX2114.2
013500*P          ORGANIZATION IS INDEXED                               IX2114.2
013600*P          ACCESS MODE IS RANDOM                                 IX2114.2
013700*P          RECORD KEY IS RAW-DATA-KEY.                           IX2114.2
013800     SELECT PRINT-FILE ASSIGN TO                                  IX2114.2
013900     "report.log".                                                IX2114.2
014000     SELECT  IX-FD1                                               IX2114.2
014100     ASSIGN TO                                                    IX2114.2
014200     "XXXXX024"                                                   IX2114.2
014300*J   **** X-CARD UNDEFINED ****                                   IX2114.2
...
015200*P                                                                IX2114.2
015300*PD  RAW-DATA.                                                    IX2114.2
015400*P                                                                IX2114.2
015500*P1  RAW-DATA-SATZ.                                               IX2114.2
015600*P   05  RAW-DATA-KEY        PIC X(6).                            IX2114.2
015700*P   05  C-DATE              PIC 9(6).                            IX2114.2
015800*P   05  C-TIME              PIC 9(8).                            IX2114.2
015900*P   05  C-NO-OF-TESTS       PIC 99.                              IX2114.2
016000*P   05  C-OK                PIC 999.                             IX2114.2
016100*P   05  C-ALL               PIC 999.                             IX2114.2
016200*P   05  C-FAIL              PIC 999.                             IX2114.2
016300*P   05  C-DELETED           PIC 999.                             IX2114.2
016400*P   05  C-INSPECT           PIC 999.                             IX2114.2
016500*P   05  C-NOTE              PIC X(13).                           IX2114.2
016600*P   05  C-INDENT            PIC X.                               IX2114.2
016700*P   05  C-ABORT             PIC X(8).                            IX2114.2
...
017200*C   LABEL RECORDS ARE STANDARD                                   IX2114.2
017300*C   DATA RECORD IS IX-FD1R1-F-G-240                              IX2114.2
...
059100*P   OPEN I-O RAW-DATA.                                           IX2114.2
059200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2114.2
059300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2114.2
059400*P   MOVE "ABORTED " TO C-ABORT.                                  IX2114.2
059500*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2114.2
059600*P   ACCEPT C-DATE  FROM DATE.                                    IX2114.2
059700*P   ACCEPT C-TIME  FROM TIME.                                    IX2114.2
059800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2114.2
059900*PND-E-1.                                                         IX2114.2
060000*P   CLOSE RAW-DATA.                                              IX2114.2
...
061400*P   OPEN I-O RAW-DATA.                                           IX2114.2
061500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2114.2
061600*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2114.2
061700*P   MOVE "OK.     " TO C-ABORT.                                  IX2114.2
061800*P   MOVE PASS-COUNTER TO C-OK.                                   IX2114.2
061900*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2114.2
062000*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2114.2
062100*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2114.2
062200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2114.2
062300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2114.2
062400*PND-E-2.                                                         IX2114.2
062500*P   CLOSE RAW-DATA.                                              IX2114.2
062600     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2114.2
062700 TERMINATE-CCVS.                                                  IX2114.2
062800*S   EXIT PROGRAM.                                                IX2114.2
062900*SERMINATE-CALL.                                                  IX2114.2
...
069500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2114.2
