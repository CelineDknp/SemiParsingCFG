...
003900     Linux.                                                       SQ1234.2
004000 OBJECT-COMPUTER.                                                 SQ1234.2
004100     Linux.                                                       SQ1234.2
004200*                                                                 SQ1234.2
004300 INPUT-OUTPUT SECTION.                                            SQ1234.2
004400 FILE-CONTROL.                                                    SQ1234.2
004500     SELECT PRINT-FILE ASSIGN TO                                  SQ1234.2
004600     "report.log".                                                SQ1234.2
004700*                                                                 SQ1234.2
004800*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1234.2
004900*P   "XXXXX062"                                                   SQ1234.2
005000*P         ORGANIZATION IS INDEXED                                SQ1234.2
005100*P         ACCESS MODE  IS RANDOM                                 SQ1234.2
005200*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1234.2
005300*P                                                                SQ1234.2
...
006400*C   LABEL RECORDS                                                SQ1234.2
006500*C       OMITTED                                                  SQ1234.2
006600*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1234.2
006700               .                                                  SQ1234.2
006800 01  PRINT-REC    PICTURE X(120).                                 SQ1234.2
006900 01  DUMMY-RECORD PICTURE X(120).                                 SQ1234.2
007000*P                                                                SQ1234.2
007100*PD  RAW-DATA.                                                    SQ1234.2
007200*P1  RAW-DATA-SATZ.                                               SQ1234.2
007300*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1234.2
007400*P   05  C-DATE              PIC 9(6).                            SQ1234.2
007500*P   05  C-TIME              PIC 9(8).                            SQ1234.2
007600*P   05  NO-OF-TESTS         PIC 99.                              SQ1234.2
007700*P   05  C-OK                PIC 999.                             SQ1234.2
007800*P   05  C-ALL               PIC 999.                             SQ1234.2
007900*P   05  C-FAIL              PIC 999.                             SQ1234.2
008000*P   05  C-DELETED           PIC 999.                             SQ1234.2
008100*P   05  C-INSPECT           PIC 999.                             SQ1234.2
008200*P   05  C-NOTE              PIC X(13).                           SQ1234.2
008300*P   05  C-INDENT            PIC X.                               SQ1234.2
008400*P   05  C-ABORT             PIC X(8).                            SQ1234.2
008500*                                                                 SQ1234.2
008600 FD  SQ-FS4                                                       SQ1234.2
008700*C   LABEL RECORD IS STANDARD                                     SQ1234.2
008800                .                                                 SQ1234.2
...
039700     IF RECORD-COUNT GREATER 50                                   SQ1234.2
039800         MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1234.2
039900         MOVE    SPACE TO DUMMY-RECORD                            SQ1234.2
040000         WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES                SQ1234.2
040100         MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1234.2
040200         MOVE    CCVS-C-2 TO DUMMY-RECORD                         SQ1234.2
040300         PERFORM DECL-WRT-LN 2 TIMES                              SQ1234.2
040400         MOVE    HYPHEN-LINE TO DUMMY-RECORD                      SQ1234.2
040500         PERFORM DECL-WRT-LN                                      SQ1234.2
040600         MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1234.2
040700         MOVE    ZERO TO RECORD-COUNT.                            SQ1234.2
...
045000*P   OPEN    I-O RAW-DATA.                                        SQ1234.2
045100*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1234.2
045200*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1234.2
045300*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1234.2
045400*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1234.2
045500*P   ACCEPT  C-DATE      FROM DATE.                               SQ1234.2
045600*P   ACCEPT  C-TIME      FROM TIME.                               SQ1234.2
045700*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1234.2
045800*PND-E-1.                                                         SQ1234.2
045900*P   CLOSE   RAW-DATA.                                            SQ1234.2
...
047700*P   OPEN    I-O RAW-DATA.                                        SQ1234.2
047800*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1234.2
047900*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1234.2
048000*P   MOVE   "OK.     " TO C-ABORT.                                SQ1234.2
048100*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1234.2
048200*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1234.2
048300*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1234.2
048400*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1234.2
048500*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1234.2
048600*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1234.2
048700*PND-E-2.                                                         SQ1234.2
048800*P   CLOSE   RAW-DATA.                                            SQ1234.2
048900 TERMINATE-CCVS.                                                  SQ1234.2
049000*S   EXIT    PROGRAM.                                             SQ1234.2
...
058200     IF RECORD-COUNT GREATER 50                                   SQ1234.2
058300         MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1234.2
058400         MOVE  SPACE TO DUMMY-RECORD                              SQ1234.2
058500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1234.2
058600         MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1234.2
058700         MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1234.2
058800         MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1234.2
058900         MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1234.2
059000         MOVE  ZERO TO RECORD-COUNT.                              SQ1234.2
