...
003600     Linux.                                                       SQ1114.2
003700 OBJECT-COMPUTER.                                                 SQ1114.2
003800     Linux.                                                       SQ1114.2
...
004300*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1114.2
004400*P   "XXXXX062"                                                   SQ1114.2
004500*P          ORGANIZATION IS INDEXED                               SQ1114.2
004600*P          ACCESS MODE IS RANDOM                                 SQ1114.2
004700*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1114.2
004800     SELECT PRINT-FILE ASSIGN TO                                  SQ1114.2
004900     "report.log".                                                SQ1114.2
...
005500*P                                                                SQ1114.2
005600*PD  RAW-DATA.                                                    SQ1114.2
005700*P                                                                SQ1114.2
005800*P1  RAW-DATA-SATZ.                                               SQ1114.2
005900*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1114.2
006000*P   05  C-DATE              PIC 9(6).                            SQ1114.2
006100*P   05  C-TIME              PIC 9(8).                            SQ1114.2
006200*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1114.2
006300*P   05  C-OK                PIC 999.                             SQ1114.2
006400*P   05  C-ALL               PIC 999.                             SQ1114.2
006500*P   05  C-FAIL              PIC 999.                             SQ1114.2
006600*P   05  C-DELETED           PIC 999.                             SQ1114.2
006700*P   05  C-INSPECT           PIC 999.                             SQ1114.2
006800*P   05  C-NOTE              PIC X(13).                           SQ1114.2
006900*P   05  C-INDENT            PIC X.                               SQ1114.2
007000*P   05  C-ABORT             PIC X(8).                            SQ1114.2
007100 FD  PRINT-FILE                                                   SQ1114.2
007200*C   LABEL RECORDS                                                SQ1114.2
007300*C       OMITTED                                                  SQ1114.2
007400*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1114.2
007500               .                                                  SQ1114.2
007600 01  PRINT-REC PICTURE X(120).                                    SQ1114.2
007700 01  DUMMY-RECORD PICTURE X(120).                                 SQ1114.2
007800 FD  SQ-FS1                                                       SQ1114.2
007900*C   LABEL RECORD STANDARD                                        SQ1114.2
...
027500*P   OPEN I-O RAW-DATA.                                           SQ1114.2
027600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1114.2
027700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1114.2
027800*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1114.2
027900*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1114.2
028000*P   ACCEPT C-DATE  FROM DATE.                                    SQ1114.2
028100*P   ACCEPT C-TIME  FROM TIME.                                    SQ1114.2
028200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1114.2
028300*PND-E-1.                                                         SQ1114.2
028400*P   CLOSE RAW-DATA.                                              SQ1114.2
...
029900*P   OPEN I-O RAW-DATA.                                           SQ1114.2
030000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1114.2
030100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1114.2
030200*P   MOVE "OK.     " TO C-ABORT.                                  SQ1114.2
030300*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1114.2
030400*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1114.2
030500*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1114.2
030600*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1114.2
030700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1114.2
030800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1114.2
030900*PND-E-2.                                                         SQ1114.2
031000*P   CLOSE RAW-DATA.                                              SQ1114.2
031100 TERMINATE-CCVS.                                                  SQ1114.2
031200*S   EXIT PROGRAM.                                                SQ1114.2
031300*SERMINATE-CALL.                                                  SQ1114.2
...
037800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1114.2
