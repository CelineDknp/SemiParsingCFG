...
004200     Linux.                                                       SQ1214.2
004300 OBJECT-COMPUTER.                                                 SQ1214.2
004400     Linux.                                                       SQ1214.2
004500 INPUT-OUTPUT SECTION.                                            SQ1214.2
004600 FILE-CONTROL.                                                    SQ1214.2
004700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1214.2
004800*P   "XXXXX062"                                                   SQ1214.2
004900*P          ORGANIZATION IS INDEXED                               SQ1214.2
005000*P          ACCESS MODE IS RANDOM                                 SQ1214.2
005100*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1214.2
005200     SELECT PRINT-FILE ASSIGN TO                                  SQ1214.2
005300     "report.log".                                                SQ1214.2
...
006100*P                                                                SQ1214.2
006200*PD  RAW-DATA.                                                    SQ1214.2
006300*P                                                                SQ1214.2
006400*P1  RAW-DATA-SATZ.                                               SQ1214.2
006500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1214.2
006600*P   05  C-DATE              PIC 9(6).                            SQ1214.2
006700*P   05  C-TIME              PIC 9(8).                            SQ1214.2
006800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1214.2
006900*P   05  C-OK                PIC 999.                             SQ1214.2
007000*P   05  C-ALL               PIC 999.                             SQ1214.2
007100*P   05  C-FAIL              PIC 999.                             SQ1214.2
007200*P   05  C-DELETED           PIC 999.                             SQ1214.2
007300*P   05  C-INSPECT           PIC 999.                             SQ1214.2
007400*P   05  C-NOTE              PIC X(13).                           SQ1214.2
007500*P   05  C-INDENT            PIC X.                               SQ1214.2
007600*P   05  C-ABORT             PIC X(8).                            SQ1214.2
007700 FD  PRINT-FILE                                                   SQ1214.2
007800*C   LABEL RECORDS                                                SQ1214.2
007900*C       OMITTED                                                  SQ1214.2
008000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1214.2
008100               .                                                  SQ1214.2
008200 01  PRINT-REC PICTURE X(120).                                    SQ1214.2
008300 01  DUMMY-RECORD PICTURE X(120).                                 SQ1214.2
008400 FD  SQ-FS5                                                       SQ1214.2
008500*C   LABEL RECORD STANDARD                                        SQ1214.2
008600               .                                                  SQ1214.2
...
028500*P   OPEN I-O RAW-DATA.                                           SQ1214.2
028600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1214.2
028700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1214.2
028800*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1214.2
028900*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1214.2
029000*P   ACCEPT C-DATE  FROM DATE.                                    SQ1214.2
029100*P   ACCEPT C-TIME  FROM TIME.                                    SQ1214.2
029200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1214.2
029300*PND-E-1.                                                         SQ1214.2
029400*P   CLOSE RAW-DATA.                                              SQ1214.2
...
030900*P   OPEN I-O RAW-DATA.                                           SQ1214.2
031000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1214.2
031100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1214.2
031200*P   MOVE "OK.     " TO C-ABORT.                                  SQ1214.2
031300*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1214.2
031400*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1214.2
031500*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1214.2
031600*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1214.2
031700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1214.2
031800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1214.2
031900*PND-E-2.                                                         SQ1214.2
032000*P   CLOSE RAW-DATA.                                              SQ1214.2
032100 TERMINATE-CCVS.                                                  SQ1214.2
032200*S   EXIT PROGRAM.                                                SQ1214.2
032300*SERMINATE-CALL.                                                  SQ1214.2
...
038800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1214.2
