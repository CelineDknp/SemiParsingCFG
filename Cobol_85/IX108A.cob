...
006400     Linux.                                                       IX1084.2
006500 OBJECT-COMPUTER.                                                 IX1084.2
006600     Linux.                                                       IX1084.2
006700 INPUT-OUTPUT SECTION.                                            IX1084.2
006800 FILE-CONTROL.                                                    IX1084.2
006900*P   SELECT RAW-DATA   ASSIGN TO                                  IX1084.2
007000*P   "XXXXX062"                                                   IX1084.2
007100*P          ORGANIZATION IS INDEXED                               IX1084.2
007200*P          ACCESS MODE IS RANDOM                                 IX1084.2
007300*P          RECORD KEY IS RAW-DATA-KEY.                           IX1084.2
007400     SELECT PRINT-FILE ASSIGN TO                                  IX1084.2
007500     "report.log".                                                IX1084.2
007600     SELECT   IX-FS1 ASSIGN                                       IX1084.2
007700     "XXXXX024"                                                   IX1084.2
007800*J   **** X-CARD UNDEFINED ****                                   IX1084.2
...
008500*J   **** X-CARD UNDEFINED ****                                   IX1084.2
...
009200*P                                                                IX1084.2
009300*PD  RAW-DATA.                                                    IX1084.2
009400*P                                                                IX1084.2
009500*P1  RAW-DATA-SATZ.                                               IX1084.2
009600*P   05  RAW-DATA-KEY        PIC X(6).                            IX1084.2
009700*P   05  C-DATE              PIC 9(6).                            IX1084.2
009800*P   05  C-TIME              PIC 9(8).                            IX1084.2
009900*P   05  C-NO-OF-TESTS       PIC 99.                              IX1084.2
010000*P   05  C-OK                PIC 999.                             IX1084.2
010100*P   05  C-ALL               PIC 999.                             IX1084.2
010200*P   05  C-FAIL              PIC 999.                             IX1084.2
010300*P   05  C-DELETED           PIC 999.                             IX1084.2
010400*P   05  C-INSPECT           PIC 999.                             IX1084.2
010500*P   05  C-NOTE              PIC X(13).                           IX1084.2
010600*P   05  C-INDENT            PIC X.                               IX1084.2
010700*P   05  C-ABORT             PIC X(8).                            IX1084.2
...
011200*C   LABEL RECORDS ARE STANDARD                                   IX1084.2
011300*C   DATA RECORDS IX-FS1R1-F-G-240                                IX1084.2
...
012400*C   LABEL RECORDS ARE STANDARD                                   IX1084.2
012500*C   DATA RECORDS IX-FS2R1-F-G-240                                IX1084.2
...
038400*P   OPEN I-O RAW-DATA.                                           IX1084.2
038500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1084.2
038600*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1084.2
038700*P   MOVE "ABORTED " TO C-ABORT.                                  IX1084.2
038800*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1084.2
038900*P   ACCEPT C-DATE  FROM DATE.                                    IX1084.2
039000*P   ACCEPT C-TIME  FROM TIME.                                    IX1084.2
039100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1084.2
039200*PND-E-1.                                                         IX1084.2
039300*P   CLOSE RAW-DATA.                                              IX1084.2
...
040700*P   OPEN I-O RAW-DATA.                                           IX1084.2
040800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1084.2
040900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1084.2
041000*P   MOVE "OK.     " TO C-ABORT.                                  IX1084.2
041100*P   MOVE PASS-COUNTER TO C-OK.                                   IX1084.2
041200*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1084.2
041300*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1084.2
041400*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1084.2
041500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1084.2
041600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1084.2
041700*PND-E-2.                                                         IX1084.2
041800*P   CLOSE RAW-DATA.                                              IX1084.2
041900     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1084.2
042000 TERMINATE-CCVS.                                                  IX1084.2
042100*S   EXIT PROGRAM.                                                IX1084.2
042200*SERMINATE-CALL.                                                  IX1084.2
...
048800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1084.2
