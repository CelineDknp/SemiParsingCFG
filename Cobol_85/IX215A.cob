...
011500     Linux.                                                       IX2154.2
011600 OBJECT-COMPUTER.                                                 IX2154.2
011700     Linux                                                        IX2154.2
...
012400*P   SELECT RAW-DATA   ASSIGN TO                                  IX2154.2
012500*P   "XXXXX062"                                                   IX2154.2
012600*P          ORGANIZATION IS INDEXED                               IX2154.2
012700*P          ACCESS MODE IS RANDOM                                 IX2154.2
012800*P          RECORD KEY IS RAW-DATA-KEY.                           IX2154.2
012900     SELECT PRINT-FILE ASSIGN TO                                  IX2154.2
013000     "report.log".                                                IX2154.2
013100     SELECT  IX-FD1                                               IX2154.2
013200     ASSIGN TO                                                    IX2154.2
013300     "XXXXX024"                                                   IX2154.2
013400*J   **** X-CARD UNDEFINED ****                                   IX2154.2
...
014300*J   **** X-CARD UNDEFINED ****                                   IX2154.2
...
015300*J   **** X-CARD UNDEFINED ****                                   IX2154.2
...
016500*P                                                                IX2154.2
016600*PD  RAW-DATA.                                                    IX2154.2
016700*P                                                                IX2154.2
016800*P1  RAW-DATA-SATZ.                                               IX2154.2
016900*P   05  RAW-DATA-KEY        PIC X(6).                            IX2154.2
017000*P   05  C-DATE              PIC 9(6).                            IX2154.2
017100*P   05  C-TIME              PIC 9(8).                            IX2154.2
017200*P   05  C-NO-OF-TESTS       PIC 99.                              IX2154.2
017300*P   05  C-OK                PIC 999.                             IX2154.2
017400*P   05  C-ALL               PIC 999.                             IX2154.2
017500*P   05  C-FAIL              PIC 999.                             IX2154.2
017600*P   05  C-DELETED           PIC 999.                             IX2154.2
017700*P   05  C-INSPECT           PIC 999.                             IX2154.2
017800*P   05  C-NOTE              PIC X(13).                           IX2154.2
017900*P   05  C-INDENT            PIC X.                               IX2154.2
018000*P   05  C-ABORT             PIC X(8).                            IX2154.2
...
018500*C   LABEL RECORDS ARE STANDARD                                   IX2154.2
018600*C   DATA RECORD IS IX-FD1R1-F-G-240                              IX2154.2
...
023800*C   LABEL RECORDS ARE STANDARD                                   IX2154.2
023900*C   DATA RECORD IS IX-FD2R1-F-G-241                              IX2154.2
...
029300*C   LABEL RECORDS ARE STANDARD                                   IX2154.2
029400*C   DATA RECORD IS IX-FD3R1-F-G-242                              IX2154.2
...
069900*P   OPEN I-O RAW-DATA.                                           IX2154.2
070000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2154.2
070100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2154.2
070200*P   MOVE "ABORTED " TO C-ABORT.                                  IX2154.2
070300*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2154.2
070400*P   ACCEPT C-DATE  FROM DATE.                                    IX2154.2
070500*P   ACCEPT C-TIME  FROM TIME.                                    IX2154.2
070600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2154.2
070700*PND-E-1.                                                         IX2154.2
070800*P   CLOSE RAW-DATA.                                              IX2154.2
...
072200*P   OPEN I-O RAW-DATA.                                           IX2154.2
072300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2154.2
072400*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2154.2
072500*P   MOVE "OK.     " TO C-ABORT.                                  IX2154.2
072600*P   MOVE PASS-COUNTER TO C-OK.                                   IX2154.2
072700*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2154.2
072800*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2154.2
072900*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2154.2
073000*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2154.2
073100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2154.2
073200*PND-E-2.                                                         IX2154.2
073300*P   CLOSE RAW-DATA.                                              IX2154.2
073400     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2154.2
073500 TERMINATE-CCVS.                                                  IX2154.2
073600*S   EXIT PROGRAM.                                                IX2154.2
073700*SERMINATE-CALL.                                                  IX2154.2
...
080300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2154.2
