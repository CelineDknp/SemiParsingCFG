...
003700     Linux.                                                       SQ1104.2
003800 OBJECT-COMPUTER.                                                 SQ1104.2
003900     Linux.                                                       SQ1104.2
004000 INPUT-OUTPUT SECTION.                                            SQ1104.2
004100 FILE-CONTROL.                                                    SQ1104.2
004200*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1104.2
004300*P   "XXXXX062"                                                   SQ1104.2
004400*P          ORGANIZATION IS INDEXED                               SQ1104.2
004500*P          ACCESS MODE IS RANDOM                                 SQ1104.2
004600*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1104.2
004700     SELECT PRINT-FILE ASSIGN TO                                  SQ1104.2
004800     "report.log".                                                SQ1104.2
...
005500*P                                                                SQ1104.2
005600*PD  RAW-DATA.                                                    SQ1104.2
005700*P                                                                SQ1104.2
005800*P1  RAW-DATA-SATZ.                                               SQ1104.2
005900*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1104.2
006000*P   05  C-DATE              PIC 9(6).                            SQ1104.2
006100*P   05  C-TIME              PIC 9(8).                            SQ1104.2
006200*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1104.2
006300*P   05  C-OK                PIC 999.                             SQ1104.2
006400*P   05  C-ALL               PIC 999.                             SQ1104.2
006500*P   05  C-FAIL              PIC 999.                             SQ1104.2
006600*P   05  C-DELETED           PIC 999.                             SQ1104.2
006700*P   05  C-INSPECT           PIC 999.                             SQ1104.2
006800*P   05  C-NOTE              PIC X(13).                           SQ1104.2
006900*P   05  C-INDENT            PIC X.                               SQ1104.2
007000*P   05  C-ABORT             PIC X(8).                            SQ1104.2
007100 FD  PRINT-FILE                                                   SQ1104.2
007200*C   LABEL RECORDS                                                SQ1104.2
007300*C       OMITTED                                                  SQ1104.2
007400*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1104.2
007500               .                                                  SQ1104.2
007600 01  PRINT-REC PICTURE X(120).                                    SQ1104.2
007700 01  DUMMY-RECORD PICTURE X(120).                                 SQ1104.2
007800 FD  SQ-FS3                                                       SQ1104.2
007900*C   LABEL RECORDS ARE STANDARD                                   SQ1104.2
008000*C   DATA RECORD SQ-FS3R1-F-G-120                                 SQ1104.2
...
026600*P   OPEN I-O RAW-DATA.                                           SQ1104.2
026700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1104.2
026800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1104.2
026900*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1104.2
027000*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1104.2
027100*P   ACCEPT C-DATE  FROM DATE.                                    SQ1104.2
027200*P   ACCEPT C-TIME  FROM TIME.                                    SQ1104.2
027300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1104.2
027400*PND-E-1.                                                         SQ1104.2
027500*P   CLOSE RAW-DATA.                                              SQ1104.2
...
029000*P   OPEN I-O RAW-DATA.                                           SQ1104.2
029100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1104.2
029200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1104.2
029300*P   MOVE "OK.     " TO C-ABORT.                                  SQ1104.2
029400*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1104.2
029500*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1104.2
029600*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1104.2
029700*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1104.2
029800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1104.2
029900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1104.2
030000*PND-E-2.                                                         SQ1104.2
030100*P   CLOSE RAW-DATA.                                              SQ1104.2
030200 TERMINATE-CCVS.                                                  SQ1104.2
030300*S   EXIT PROGRAM.                                                SQ1104.2
030400*SERMINATE-CALL.                                                  SQ1104.2
...
036900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1104.2
...
041900*F   MOVE "CLOSE UNIT DELETED" TO RE-MARK.                        SQ1104.2
