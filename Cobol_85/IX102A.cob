...
006000     Linux.                                                       IX1024.2
006100 OBJECT-COMPUTER.                                                 IX1024.2
006200     Linux.                                                       IX1024.2
006300 INPUT-OUTPUT SECTION.                                            IX1024.2
006400 FILE-CONTROL.                                                    IX1024.2
006500*P   SELECT RAW-DATA   ASSIGN TO                                  IX1024.2
006600*P   "XXXXX062"                                                   IX1024.2
006700*P          ORGANIZATION IS INDEXED                               IX1024.2
006800*P          ACCESS MODE IS RANDOM                                 IX1024.2
006900*P          RECORD KEY IS RAW-DATA-KEY.                           IX1024.2
007000     SELECT PRINT-FILE ASSIGN TO                                  IX1024.2
007100     "report.log".                                                IX1024.2
007200     SELECT   IX-FS1 ASSIGN                                       IX1024.2
007300     "XXXXX024"                                                   IX1024.2
007400*J   **** X-CARD UNDEFINED ****                                   IX1024.2
...
008000*P                                                                IX1024.2
008100*PD  RAW-DATA.                                                    IX1024.2
008200*P                                                                IX1024.2
008300*P1  RAW-DATA-SATZ.                                               IX1024.2
008400*P   05  RAW-DATA-KEY        PIC X(6).                            IX1024.2
008500*P   05  C-DATE              PIC 9(6).                            IX1024.2
008600*P   05  C-TIME              PIC 9(8).                            IX1024.2
008700*P   05  C-NO-OF-TESTS       PIC 99.                              IX1024.2
008800*P   05  C-OK                PIC 999.                             IX1024.2
008900*P   05  C-ALL               PIC 999.                             IX1024.2
009000*P   05  C-FAIL              PIC 999.                             IX1024.2
009100*P   05  C-DELETED           PIC 999.                             IX1024.2
009200*P   05  C-INSPECT           PIC 999.                             IX1024.2
009300*P   05  C-NOTE              PIC X(13).                           IX1024.2
009400*P   05  C-INDENT            PIC X.                               IX1024.2
009500*P   05  C-ABORT             PIC X(8).                            IX1024.2
...
010000*C   LABEL RECORDS STANDARD                                       IX1024.2
010100*C   ; DATA RECORD IX-FS1R1-F-G-240                               IX1024.2
...
032200*P   OPEN I-O RAW-DATA.                                           IX1024.2
032300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1024.2
032400*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1024.2
032500*P   MOVE "ABORTED " TO C-ABORT.                                  IX1024.2
032600*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1024.2
032700*P   ACCEPT C-DATE  FROM DATE.                                    IX1024.2
032800*P   ACCEPT C-TIME  FROM TIME.                                    IX1024.2
032900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1024.2
033000*PND-E-1.                                                         IX1024.2
033100*P   CLOSE RAW-DATA.                                              IX1024.2
...
034500*P   OPEN I-O RAW-DATA.                                           IX1024.2
034600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1024.2
034700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1024.2
034800*P   MOVE "OK.     " TO C-ABORT.                                  IX1024.2
034900*P   MOVE PASS-COUNTER TO C-OK.                                   IX1024.2
035000*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1024.2
035100*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1024.2
035200*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1024.2
035300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1024.2
035400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1024.2
035500*PND-E-2.                                                         IX1024.2
035600*P   CLOSE RAW-DATA.                                              IX1024.2
035700     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1024.2
035800 TERMINATE-CCVS.                                                  IX1024.2
035900*S   EXIT PROGRAM.                                                IX1024.2
036000*SERMINATE-CALL.                                                  IX1024.2
...
042600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1024.2
