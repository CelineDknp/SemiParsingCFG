...
003700     Linux.                                                       IX1204.2
003800 OBJECT-COMPUTER.                                                 IX1204.2
003900     Linux.                                                       IX1204.2
004000 INPUT-OUTPUT SECTION.                                            IX1204.2
004100 FILE-CONTROL.                                                    IX1204.2
004200*P   SELECT RAW-DATA   ASSIGN TO                                  IX1204.2
004300*P   "XXXXX062"                                                   IX1204.2
004400*P          ORGANIZATION IS INDEXED                               IX1204.2
004500*P          ACCESS MODE IS RANDOM                                 IX1204.2
004600*P          RECORD KEY IS RAW-DATA-KEY.                           IX1204.2
004700*                                                                 IX1204.2
004800     SELECT PRINT-FILE ASSIGN TO                                  IX1204.2
004900     "report.log".                                                IX1204.2
005000*                                                                 IX1204.2
...
006100*P                                                                IX1204.2
006200*PD  RAW-DATA.                                                    IX1204.2
006300*P                                                                IX1204.2
006400*P1  RAW-DATA-SATZ.                                               IX1204.2
006500*P   05  RAW-DATA-KEY        PIC X(6).                            IX1204.2
006600*P   05  C-DATE              PIC 9(6).                            IX1204.2
006700*P   05  C-TIME              PIC 9(8).                            IX1204.2
006800*P   05  C-NO-OF-TESTS       PIC 99.                              IX1204.2
006900*P   05  C-OK                PIC 999.                             IX1204.2
007000*P   05  C-ALL               PIC 999.                             IX1204.2
007100*P   05  C-FAIL              PIC 999.                             IX1204.2
007200*P   05  C-DELETED           PIC 999.                             IX1204.2
007300*P   05  C-INSPECT           PIC 999.                             IX1204.2
007400*P   05  C-NOTE              PIC X(13).                           IX1204.2
007500*P   05  C-INDENT            PIC X.                               IX1204.2
007600*P   05  C-ABORT             PIC X(8).                            IX1204.2
007700                                                                  IX1204.2
...
008500*C      DATA RECORDS IX-FS3R1-F-G-240                             IX1204.2
008600*C      LABEL RECORD STANDARD                                     IX1204.2
...
035900*P   OPEN I-O RAW-DATA.                                           IX1204.2
036000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1204.2
036100*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1204.2
036200*P   MOVE "OK.     " TO C-ABORT.                                  IX1204.2
036300*P   MOVE PASS-COUNTER TO C-OK.                                   IX1204.2
036400*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1204.2
036500*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1204.2
036600*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1204.2
036700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1204.2
036800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1204.2
036900*P-END-E-2.                                                       IX1204.2
037000*P   CLOSE RAW-DATA.                                              IX1204.2
...
037400*S   EXIT PROGRAM.                                                IX1204.2
037500*S-TERMINATE-CALL.                                                IX1204.2
...
043400        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1204.2
...
047800*P   OPEN I-O RAW-DATA.                                           IX1204.2
047900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1204.2
048000*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1204.2
048100*P   MOVE "ABORTED " TO C-ABORT.                                  IX1204.2
048200*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1204.2
048300*P   ACCEPT C-DATE  FROM DATE.                                    IX1204.2
048400*P   ACCEPT C-TIME  FROM TIME.                                    IX1204.2
048500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1204.2
048600*PND-E-1.                                                         IX1204.2
048700*P   CLOSE RAW-DATA.                                              IX1204.2
...
050100*P   OPEN I-O RAW-DATA.                                           IX1204.2
050200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1204.2
050300*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1204.2
050400*P   MOVE "OK.     " TO C-ABORT.                                  IX1204.2
050500*P   MOVE PASS-COUNTER TO C-OK.                                   IX1204.2
050600*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1204.2
050700*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1204.2
050800*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1204.2
050900*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1204.2
051000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1204.2
051100*PND-E-2.                                                         IX1204.2
051200*P   CLOSE RAW-DATA.                                              IX1204.2
051300     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1204.2
051400 TERMINATE-CCVS.                                                  IX1204.2
051500*S   EXIT PROGRAM.                                                IX1204.2
051600*SERMINATE-CALL.                                                  IX1204.2
...
058200         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1204.2
