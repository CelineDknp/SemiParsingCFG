...
006500*C   VALUE OF                                                     ST1464.2
006600*C   OCLABELID                                                    ST1464.2
006700*C   IS                                                           ST1464.2
006800*C   "OCDUMMY"                                                    ST1464.2
006900*G   SYSIN                                                        ST1464.2
...
007500*C   VALUE OF                                                     ST1464.2
007600*C   OCLABELID                                                    ST1464.2
007700*C   IS                                                           ST1464.2
007800*C   "OCDUMMY"                                                    ST1464.2
007900*G   SYSIN                                                        ST1464.2
...
032900*S   EXIT PROGRAM.                                                ST1464.2
033000*SERMINATE-CALL.                                                  ST1464.2
...
039300     IF RECORD-COUNT GREATER 42                                   ST1464.2
039400         MOVE DUMMY-RECORD TO DUMMY-HOLD                          ST1464.2
039500         MOVE SPACE TO DUMMY-RECORD                               ST1464.2
039600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  ST1464.2
039700         MOVE CCVS-H-1  TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    ST1464.2
039800         MOVE CCVS-H-2A TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    ST1464.2
039900         MOVE CCVS-H-2B TO DUMMY-RECORD PERFORM WRT-LN 3 TIMES    ST1464.2
040000         MOVE CCVS-H-3  TO DUMMY-RECORD PERFORM WRT-LN 3 TIMES    ST1464.2
040100         MOVE CCVS-C-1  TO DUMMY-RECORD PERFORM WRT-LN            ST1464.2
040200         MOVE CCVS-C-2  TO DUMMY-RECORD PERFORM WRT-LN            ST1464.2
040300         MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          ST1464.2
040400         MOVE DUMMY-HOLD TO DUMMY-RECORD                          ST1464.2
040500         MOVE ZERO TO RECORD-COUNT.                               ST1464.2
...
047900*XILE-DUMP SECTION.                                               ST1464.2
048000*X-D-1.                                                           ST1464.2
048100*X   PERFORM END-ROUTINE.                                         ST1464.2
048200*X   MOVE " DUMP OF FIRST 10 (OF 1000) RECORDS FROM SQ-FS1:"      ST1464.2
048300*X       TO PRINT-REC.                                            ST1464.2
048400*X   PERFORM WRITE-LINE.                                          ST1464.2
048500*X   PERFORM F-D-2 10 TIMES.                                      ST1464.2
048600*X   GO TO F-D-3.                                                 ST1464.2
048700*X-D-2.                                                           ST1464.2
048800*X   READ SQ-FS1 AT END GO TO F-D-3.                              ST1464.2
048900*X   MOVE FS1R1-XN-120 TO PRINT-REC.                              ST1464.2
049000*X   PERFORM WRITE-LINE.                                          ST1464.2
049100*X   MOVE FS1R1-XN-20 TO PRINT-REC.                               ST1464.2
049200*X   PERFORM WRITE-LINE.                                          ST1464.2
049300*X-D-3.                                                           ST1464.2
049400*X   CLOSE SQ-FS1.                                                ST1464.2
049500*X   OPEN INPUT SQ-FS2.                                           ST1464.2
049600*X   PERFORM END-ROUTINE.                                         ST1464.2
049700*X   MOVE " DUMP OF FIRST 10 (OF 1000) RECORDS FROM SQ-FS2:"      ST1464.2
049800*X       TO PRINT-REC.                                            ST1464.2
049900*X   PERFORM WRITE-LINE.                                          ST1464.2
050000*X   PERFORM F-D-4 10 TIMES.                                      ST1464.2
050100*X   GO TO F-D-5.                                                 ST1464.2
050200*X-D-4.                                                           ST1464.2
050300*X   READ SQ-FS2 AT END GO TO F-D-5.                              ST1464.2
050400*X   MOVE FS2R1-XN-120 TO PRINT-REC.                              ST1464.2
050500*X   PERFORM WRITE-LINE.                                          ST1464.2
050600*X   MOVE FS2R1-XN-20 TO PRINT-REC.                               ST1464.2
050700*X   PERFORM WRITE-LINE.                                          ST1464.2
050800*X-D-5.                                                           ST1464.2
050900*X   CLOSE SQ-FS2.                                                ST1464.2
...
065500     IF RECORD-COUNT GREATER 50                                   ST1464.2
065600         MOVE DUMMY-RECORD TO DUMMY-HOLD                          ST1464.2
065700         MOVE SPACE TO DUMMY-RECORD                               ST1464.2
065800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  ST1464.2
065900         MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN-1           ST1464.2
066000         MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN-1 2 TIMES   ST1464.2
066100         MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN-1        ST1464.2
066200         MOVE DUMMY-HOLD TO DUMMY-RECORD                          ST1464.2
066300         MOVE ZERO TO RECORD-COUNT.                               ST1464.2
