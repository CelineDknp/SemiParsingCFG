...
002500     Linux.                                                       SQ2104.2
002600 OBJECT-COMPUTER.                                                 SQ2104.2
002700     Linux.                                                       SQ2104.2
002800 INPUT-OUTPUT SECTION.                                            SQ2104.2
002900 FILE-CONTROL.                                                    SQ2104.2
003000*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2104.2
003100*P   "XXXXX062"                                                   SQ2104.2
003200*P          ORGANIZATION IS INDEXED                               SQ2104.2
003300*P          ACCESS MODE IS RANDOM                                 SQ2104.2
003400*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2104.2
003500     SELECT PRINT-FILE ASSIGN TO                                  SQ2104.2
003600     "report.log".                                                SQ2104.2
003700 DATA DIVISION.                                                   SQ2104.2
003800 FILE SECTION.                                                    SQ2104.2
003900*P                                                                SQ2104.2
004000*PD  RAW-DATA.                                                    SQ2104.2
004100*P                                                                SQ2104.2
004200*P1  RAW-DATA-SATZ.                                               SQ2104.2
004300*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2104.2
004400*P   05  C-DATE              PIC 9(6).                            SQ2104.2
004500*P   05  C-TIME              PIC 9(8).                            SQ2104.2
004600*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2104.2
004700*P   05  C-OK                PIC 999.                             SQ2104.2
004800*P   05  C-ALL               PIC 999.                             SQ2104.2
004900*P   05  C-FAIL              PIC 999.                             SQ2104.2
005000*P   05  C-DELETED           PIC 999.                             SQ2104.2
005100*P   05  C-INSPECT           PIC 999.                             SQ2104.2
005200*P   05  C-NOTE              PIC X(13).                           SQ2104.2
005300*P   05  C-INDENT            PIC X.                               SQ2104.2
005400*P   05  C-ABORT             PIC X(8).                            SQ2104.2
005500 FD  PRINT-FILE                                                   SQ2104.2
005600*C   LABEL RECORDS                                                SQ2104.2
005700*C       OMITTED                                                  SQ2104.2
005800*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2104.2
...
021200*P   OPEN I-O RAW-DATA.                                           SQ2104.2
021300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2104.2
021400*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2104.2
021500*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2104.2
021600*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2104.2
021700*P   ACCEPT C-DATE  FROM DATE.                                    SQ2104.2
021800*P   ACCEPT C-TIME  FROM TIME.                                    SQ2104.2
021900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2104.2
022000*PND-E-1.                                                         SQ2104.2
022100*P   CLOSE RAW-DATA.                                              SQ2104.2
...
022900*P   OPEN I-O RAW-DATA.                                           SQ2104.2
023000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2104.2
023100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2104.2
023200*P   MOVE "OK.     " TO C-ABORT.                                  SQ2104.2
023300*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2104.2
023400*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2104.2
023500*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2104.2
023600*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2104.2
023700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2104.2
023800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2104.2
023900*PND-E-2.                                                         SQ2104.2
024000*P   CLOSE RAW-DATA.                                              SQ2104.2
024100 TERMINATE-CCVS.                                                  SQ2104.2
024200*S   EXIT PROGRAM.                                                SQ2104.2
024300*SERMINATE-CALL.                                                  SQ2104.2
...
030700         MOVE SPACE TO DUMMY-RECORD                               SQ2104.2
030800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2104.2
...
031300         MOVE ZERO TO RECORD-COUNT.                               SQ2104.2
