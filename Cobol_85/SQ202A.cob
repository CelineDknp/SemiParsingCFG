...
001800     Linux.                                                       SQ2024.2
001900 OBJECT-COMPUTER.                                                 SQ2024.2
002000     Linux.                                                       SQ2024.2
002100 INPUT-OUTPUT SECTION.                                            SQ2024.2
002200 FILE-CONTROL.                                                    SQ2024.2
002300*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2024.2
002400*P   "XXXXX062"                                                   SQ2024.2
002500*P          ORGANIZATION IS INDEXED                               SQ2024.2
002600*P          ACCESS MODE IS RANDOM                                 SQ2024.2
002700*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2024.2
002800     SELECT PRINT-FILE ASSIGN TO                                  SQ2024.2
002900     "report.log".                                                SQ2024.2
003000     SELECT SQ-FS1 ASSIGN TO                                      SQ2024.2
003100     "XXXXX001".                                                  SQ2024.2
003200 DATA DIVISION.                                                   SQ2024.2
003300 FILE SECTION.                                                    SQ2024.2
003400*P                                                                SQ2024.2
003500*PD  RAW-DATA.                                                    SQ2024.2
003600*P                                                                SQ2024.2
003700*P1  RAW-DATA-SATZ.                                               SQ2024.2
003800*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2024.2
003900*P   05  C-DATE              PIC 9(6).                            SQ2024.2
004000*P   05  C-TIME              PIC 9(8).                            SQ2024.2
004100*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2024.2
004200*P   05  C-OK                PIC 999.                             SQ2024.2
004300*P   05  C-ALL               PIC 999.                             SQ2024.2
004400*P   05  C-FAIL              PIC 999.                             SQ2024.2
004500*P   05  C-DELETED           PIC 999.                             SQ2024.2
004600*P   05  C-INSPECT           PIC 999.                             SQ2024.2
004700*P   05  C-NOTE              PIC X(13).                           SQ2024.2
004800*P   05  C-INDENT            PIC X.                               SQ2024.2
004900*P   05  C-ABORT             PIC X(8).                            SQ2024.2
005000 FD  PRINT-FILE                                                   SQ2024.2
005100*C   LABEL RECORDS                                                SQ2024.2
005200*C       OMITTED                                                  SQ2024.2
005300*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2024.2
005400               .                                                  SQ2024.2
005500 01  PRINT-REC PICTURE X(120).                                    SQ2024.2
005600 01  DUMMY-RECORD PICTURE X(120).                                 SQ2024.2
005700 FD  SQ-FS1                                                       SQ2024.2
005800*C   LABEL RECORD STANDARD                                        SQ2024.2
...
024100*P   OPEN I-O RAW-DATA.                                           SQ2024.2
024200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2024.2
024300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2024.2
024400*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2024.2
024500*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2024.2
024600*P   ACCEPT C-DATE  FROM DATE.                                    SQ2024.2
024700*P   ACCEPT C-TIME  FROM TIME.                                    SQ2024.2
024800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2024.2
024900*PND-E-1.                                                         SQ2024.2
025000*P   CLOSE RAW-DATA.                                              SQ2024.2
...
026500*P   OPEN I-O RAW-DATA.                                           SQ2024.2
026600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2024.2
026700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2024.2
026800*P   MOVE "OK.     " TO C-ABORT.                                  SQ2024.2
026900*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2024.2
027000*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2024.2
027100*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2024.2
027200*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2024.2
027300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2024.2
027400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2024.2
027500*PND-E-2.                                                         SQ2024.2
027600*P   CLOSE RAW-DATA.                                              SQ2024.2
027700 TERMINATE-CCVS.                                                  SQ2024.2
027800*S   EXIT PROGRAM.                                                SQ2024.2
027900*SERMINATE-CALL.                                                  SQ2024.2
...
034400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2024.2
...
034700         MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ2024.2
