...
003400     Linux.                                                       SQ2194.2
003500 OBJECT-COMPUTER.                                                 SQ2194.2
003600     Linux.                                                       SQ2194.2
003700 INPUT-OUTPUT SECTION.                                            SQ2194.2
003800 FILE-CONTROL.                                                    SQ2194.2
003900*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2194.2
004000*P   "XXXXX062"                                                   SQ2194.2
004100*P          ORGANIZATION IS INDEXED                               SQ2194.2
004200*P          ACCESS MODE IS RANDOM                                 SQ2194.2
004300*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2194.2
004400     SELECT PRINT-FILE ASSIGN TO                                  SQ2194.2
004500     "report.log".                                                SQ2194.2
004600     SELECT SQ-VS6 ASSIGN                                         SQ2194.2
004700     "XXXXX001"                                                   SQ2194.2
004800     RECORD DELIMITER                                             SQ2194.2
004900     STANDARD-1                                                   SQ2194.2
005000     ORGANIZATION IS SEQUENTIAL.                                  SQ2194.2
005100 DATA DIVISION.                                                   SQ2194.2
005200 FILE SECTION.                                                    SQ2194.2
005300*P                                                                SQ2194.2
005400*PD  RAW-DATA.                                                    SQ2194.2
005500*P                                                                SQ2194.2
005600*P1  RAW-DATA-SATZ.                                               SQ2194.2
005700*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2194.2
005800*P   05  C-DATE              PIC 9(6).                            SQ2194.2
005900*P   05  C-TIME              PIC 9(8).                            SQ2194.2
006000*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2194.2
006100*P   05  C-OK                PIC 999.                             SQ2194.2
006200*P   05  C-ALL               PIC 999.                             SQ2194.2
006300*P   05  C-FAIL              PIC 999.                             SQ2194.2
006400*P   05  C-DELETED           PIC 999.                             SQ2194.2
006500*P   05  C-INSPECT           PIC 999.                             SQ2194.2
006600*P   05  C-NOTE              PIC X(13).                           SQ2194.2
006700*P   05  C-INDENT            PIC X.                               SQ2194.2
006800*P   05  C-ABORT             PIC X(8).                            SQ2194.2
006900 FD  PRINT-FILE                                                   SQ2194.2
007000*C   LABEL RECORDS                                                SQ2194.2
007100*C       OMITTED                                                  SQ2194.2
007200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2194.2
007300               .                                                  SQ2194.2
...
007900*C   LABEL RECORDS ARE STANDARD                                   SQ2194.2
008000*C   DATA RECORDS ARE SQ-VS6R1-M-G-120  SQ-VS6R2-M-G-151          SQ2194.2
008100               .                                                  SQ2194.2
...
009800     02  FILLER      PIC X(21).                                   SQ2194.2
...
027500*P   OPEN I-O RAW-DATA.                                           SQ2194.2
027600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2194.2
027700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2194.2
027800*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2194.2
027900*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2194.2
028000*P   ACCEPT C-DATE  FROM DATE.                                    SQ2194.2
028100*P   ACCEPT C-TIME  FROM TIME.                                    SQ2194.2
028200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2194.2
028300*PND-E-1.                                                         SQ2194.2
028400*P   CLOSE RAW-DATA.                                              SQ2194.2
...
029900*P   OPEN I-O RAW-DATA.                                           SQ2194.2
030000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2194.2
030100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2194.2
030200*P   MOVE "OK.     " TO C-ABORT.                                  SQ2194.2
030300*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2194.2
030400*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2194.2
030500*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2194.2
030600*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2194.2
030700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2194.2
030800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2194.2
030900*PND-E-2.                                                         SQ2194.2
031000*P   CLOSE RAW-DATA.                                              SQ2194.2
031100 TERMINATE-CCVS.                                                  SQ2194.2
031200*S   EXIT PROGRAM.                                                SQ2194.2
031300*SERMINATE-CALL.                                                  SQ2194.2
...
037800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2194.2
