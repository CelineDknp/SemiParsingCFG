...
002000*    FORMATS AFTER OVERFLOW OR WRITE ADVANCING 1 LINES OPERATIONS.   SQ2084.2
...
003000     Linux.                                                       SQ2084.2
003100 OBJECT-COMPUTER.                                                 SQ2084.2
003200     Linux.                                                       SQ2084.2
003300 INPUT-OUTPUT SECTION.                                            SQ2084.2
003400 FILE-CONTROL.                                                    SQ2084.2
003500*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2084.2
003600*P   "XXXXX062"                                                   SQ2084.2
003700*P          ORGANIZATION IS INDEXED                               SQ2084.2
003800*P          ACCESS MODE IS RANDOM                                 SQ2084.2
003900*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2084.2
004000     SELECT PRINT-FILE ASSIGN TO                                  SQ2084.2
004100     "report.log".                                                SQ2084.2
004200 DATA DIVISION.                                                   SQ2084.2
004300 FILE SECTION.                                                    SQ2084.2
004400*P                                                                SQ2084.2
004500*PD  RAW-DATA.                                                    SQ2084.2
004600*P                                                                SQ2084.2
004700*P1  RAW-DATA-SATZ.                                               SQ2084.2
004800*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2084.2
004900*P   05  C-DATE              PIC 9(6).                            SQ2084.2
005000*P   05  C-TIME              PIC 9(8).                            SQ2084.2
005100*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2084.2
005200*P   05  C-OK                PIC 999.                             SQ2084.2
005300*P   05  C-ALL               PIC 999.                             SQ2084.2
005400*P   05  C-FAIL              PIC 999.                             SQ2084.2
005500*P   05  C-DELETED           PIC 999.                             SQ2084.2
005600*P   05  C-INSPECT           PIC 999.                             SQ2084.2
005700*P   05  C-NOTE              PIC X(13).                           SQ2084.2
005800*P   05  C-INDENT            PIC X.                               SQ2084.2
005900*P   05  C-ABORT             PIC X(8).                            SQ2084.2
006000 FD  PRINT-FILE                                                   SQ2084.2
006100*C   LABEL RECORDS                                                SQ2084.2
006200*C       OMITTED                                                  SQ2084.2
006300*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2084.2
...
030000*P   OPEN I-O RAW-DATA.                                           SQ2084.2
030100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2084.2
030200*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2084.2
030300*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2084.2
030400*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2084.2
030500*P   ACCEPT C-DATE  FROM DATE.                                    SQ2084.2
030600*P   ACCEPT C-TIME  FROM TIME.                                    SQ2084.2
030700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2084.2
030800*PND-E-1.                                                         SQ2084.2
030900*P   CLOSE RAW-DATA.                                              SQ2084.2
...
031700*P   OPEN I-O RAW-DATA.                                           SQ2084.2
031800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2084.2
031900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2084.2
032000*P   MOVE "OK.     " TO C-ABORT.                                  SQ2084.2
032100*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2084.2
032200*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2084.2
032300*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2084.2
032400*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2084.2
032500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2084.2
032600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2084.2
032700*PND-E-2.                                                         SQ2084.2
032800*P   CLOSE RAW-DATA.                                              SQ2084.2
032900 TERMINATE-CCVS.                                                  SQ2084.2
033000*S   EXIT PROGRAM.                                                SQ2084.2
033100*SERMINATE-CALL.                                                  SQ2084.2
...
039600         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2084.2
...
049000*             WRITE ADVANCING 1 LINES OPERATION.                     SQ2084.2
