...
002300     Linux.                                                       OBSQ44.2
002400 OBJECT-COMPUTER.                                                 OBSQ44.2
002500     Linux.                                                       OBSQ44.2
002600 INPUT-OUTPUT SECTION.                                            OBSQ44.2
002700 FILE-CONTROL.                                                    OBSQ44.2
002800*P   SELECT RAW-DATA   ASSIGN TO                                  OBSQ44.2
002900*P   "XXXXX062"                                                   OBSQ44.2
003000*P          ORGANIZATION IS INDEXED                               OBSQ44.2
003100*P          ACCESS MODE IS RANDOM                                 OBSQ44.2
003200*P          RECORD KEY IS RAW-DATA-KEY.                           OBSQ44.2
003300     SELECT PRINT-FILE ASSIGN TO                                  OBSQ44.2
003400     "report.log".                                                OBSQ44.2
003500     SELECT SQ-FS1 ASSIGN TO                                      OBSQ44.2
003600     "XXXXX004".                                                  OBSQ44.2
003700     SELECT SQ-FS2 ASSIGN TO                                      OBSQ44.2
003800     "XXXXX008".                                                  OBSQ44.2
003900     SELECT SQ-FS3 ASSIGN TO                                      OBSQ44.2
004000     "XXXXX009".                                                  OBSQ44.2
004100     SELECT SQ-FS4 ASSIGN TO                                      OBSQ44.2
004200     "XXXXX010".                                                  OBSQ44.2
...
005000*P                                                                OBSQ44.2
005100*PD  RAW-DATA.                                                    OBSQ44.2
005200*P                                                                OBSQ44.2
005300*P1  RAW-DATA-SATZ.                                               OBSQ44.2
005400*P   05  RAW-DATA-KEY        PIC X(6).                            OBSQ44.2
005500*P   05  C-DATE              PIC 9(6).                            OBSQ44.2
005600*P   05  C-TIME              PIC 9(8).                            OBSQ44.2
005700*P   05  C-NO-OF-TESTS       PIC 99.                              OBSQ44.2
005800*P   05  C-OK                PIC 999.                             OBSQ44.2
005900*P   05  C-ALL               PIC 999.                             OBSQ44.2
006000*P   05  C-FAIL              PIC 999.                             OBSQ44.2
006100*P   05  C-DELETED           PIC 999.                             OBSQ44.2
006200*P   05  C-INSPECT           PIC 999.                             OBSQ44.2
006300*P   05  C-NOTE              PIC X(13).                           OBSQ44.2
006400*P   05  C-INDENT            PIC X.                               OBSQ44.2
006500*P   05  C-ABORT             PIC X(8).                            OBSQ44.2
...
026600*P   OPEN I-O RAW-DATA.                                           OBSQ44.2
026700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ44.2
026800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     OBSQ44.2
026900*P   MOVE "ABORTED " TO C-ABORT.                                  OBSQ44.2
027000*P   ADD 1 TO C-NO-OF-TESTS.                                      OBSQ44.2
027100*P   ACCEPT C-DATE  FROM DATE.                                    OBSQ44.2
027200*P   ACCEPT C-TIME  FROM TIME.                                    OBSQ44.2
027300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             OBSQ44.2
027400*PND-E-1.                                                         OBSQ44.2
027500*P   CLOSE RAW-DATA.                                              OBSQ44.2
...
029000*P   OPEN I-O RAW-DATA.                                           OBSQ44.2
029100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ44.2
029200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     OBSQ44.2
029300*P   MOVE "OK.     " TO C-ABORT.                                  OBSQ44.2
029400*P   MOVE PASS-COUNTER TO C-OK.                                   OBSQ44.2
029500*P   MOVE ERROR-HOLD   TO C-ALL.                                  OBSQ44.2
029600*P   MOVE ERROR-COUNTER TO C-FAIL.                                OBSQ44.2
029700*P   MOVE DELETE-CNT TO C-DELETED.                                OBSQ44.2
029800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           OBSQ44.2
029900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             OBSQ44.2
030000*PND-E-2.                                                         OBSQ44.2
030100*P   CLOSE RAW-DATA.                                              OBSQ44.2
030200 TERMINATE-CCVS.                                                  OBSQ44.2
030300*S   EXIT PROGRAM.                                                OBSQ44.2
030400*SERMINATE-CALL.                                                  OBSQ44.2
...
036900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  OBSQ44.2
