...
006500     Linux.                                                       IX2064.2
006600 OBJECT-COMPUTER.                                                 IX2064.2
006700     Linux.                                                       IX2064.2
006800 INPUT-OUTPUT SECTION.                                            IX2064.2
006900 FILE-CONTROL.                                                    IX2064.2
007000*P   SELECT RAW-DATA   ASSIGN TO                                  IX2064.2
007100*P   "XXXXX062"                                                   IX2064.2
007200*P          ORGANIZATION IS INDEXED                               IX2064.2
007300*P          ACCESS MODE IS RANDOM                                 IX2064.2
007400*P          RECORD KEY IS RAW-DATA-KEY.                           IX2064.2
007500     SELECT PRINT-FILE ASSIGN TO                                  IX2064.2
007600     "report.log".                                                IX2064.2
007700     SELECT   IX-FD1  ASSIGN TO                                   IX2064.2
007800     "XXXXX024"                                                   IX2064.2
007900*J   **** X-CARD UNDEFINED ****                                   IX2064.2
...
008700*J   **** X-CARD UNDEFINED ****                                   IX2064.2
...
009700*P                                                                IX2064.2
009800*PD  RAW-DATA.                                                    IX2064.2
009900*P                                                                IX2064.2
010000*P1  RAW-DATA-SATZ.                                               IX2064.2
010100*P   05  RAW-DATA-KEY        PIC X(6).                            IX2064.2
010200*P   05  C-DATE              PIC 9(6).                            IX2064.2
010300*P   05  C-TIME              PIC 9(8).                            IX2064.2
010400*P   05  C-NO-OF-TESTS       PIC 99.                              IX2064.2
010500*P   05  C-OK                PIC 999.                             IX2064.2
010600*P   05  C-ALL               PIC 999.                             IX2064.2
010700*P   05  C-FAIL              PIC 999.                             IX2064.2
010800*P   05  C-DELETED           PIC 999.                             IX2064.2
010900*P   05  C-INSPECT           PIC 999.                             IX2064.2
011000*P   05  C-NOTE              PIC X(13).                           IX2064.2
011100*P   05  C-INDENT            PIC X.                               IX2064.2
011200*P   05  C-ABORT             PIC X(8).                            IX2064.2
...
011700*C   LABEL  RECORDS ARE STANDARD                                  IX2064.2
...
013300*C   LABEL RECORDS ARE STANDARD                                   IX2064.2
...
016300*C1  IX-FD1-ID1                                                   IX2064.2
016400*C   **** X-CARD UNDEFINED ****.                                  IX2064.2
016500*C1  IX-FD1-ID2                                                   IX2064.2
016600*C   **** X-CARD UNDEFINED ****.                                  IX2064.2
016700*C1  IX-FS1-ID2                                                   IX2064.2
016800*C   **** X-CARD UNDEFINED ****.                                  IX2064.2
...
036400*P   OPEN I-O RAW-DATA.                                           IX2064.2
036500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2064.2
036600*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2064.2
036700*P   MOVE "ABORTED " TO C-ABORT.                                  IX2064.2
036800*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2064.2
036900*P   ACCEPT C-DATE  FROM DATE.                                    IX2064.2
037000*P   ACCEPT C-TIME  FROM TIME.                                    IX2064.2
037100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2064.2
037200*PND-E-1.                                                         IX2064.2
037300*P   CLOSE RAW-DATA.                                              IX2064.2
...
038700*P   OPEN I-O RAW-DATA.                                           IX2064.2
038800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2064.2
038900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2064.2
039000*P   MOVE "OK.     " TO C-ABORT.                                  IX2064.2
039100*P   MOVE PASS-COUNTER TO C-OK.                                   IX2064.2
039200*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2064.2
039300*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2064.2
039400*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2064.2
039500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2064.2
039600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2064.2
039700*PND-E-2.                                                         IX2064.2
039800*P   CLOSE RAW-DATA.                                              IX2064.2
039900     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2064.2
040000 TERMINATE-CCVS.                                                  IX2064.2
040100*S   EXIT PROGRAM.                                                IX2064.2
040200*SERMINATE-CALL.                                                  IX2064.2
...
046800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2064.2
