...
004600     Linux.                                                       IX1064.2
004700 OBJECT-COMPUTER.                                                 IX1064.2
004800     Linux.                                                       IX1064.2
004900 INPUT-OUTPUT SECTION.                                            IX1064.2
005000 FILE-CONTROL.                                                    IX1064.2
005100*P   SELECT RAW-DATA   ASSIGN TO                                  IX1064.2
005200*P   "XXXXX062"                                                   IX1064.2
005300*P          ORGANIZATION IS INDEXED                               IX1064.2
005400*P          ACCESS MODE IS RANDOM                                 IX1064.2
005500*P          RECORD KEY IS RAW-DATA-KEY.                           IX1064.2
005600     SELECT PRINT-FILE ASSIGN TO                                  IX1064.2
005700     "report.log".                                                IX1064.2
...
006800*J   **** X-CARD UNDEFINED ****                                   IX1064.2
...
008100*P                                                                IX1064.2
008200*PD  RAW-DATA.                                                    IX1064.2
008300*P                                                                IX1064.2
008400*P1  RAW-DATA-SATZ.                                               IX1064.2
008500*P   05  RAW-DATA-KEY        PIC X(6).                            IX1064.2
008600*P   05  C-DATE              PIC 9(6).                            IX1064.2
008700*P   05  C-TIME              PIC 9(8).                            IX1064.2
008800*P   05  C-NO-OF-TESTS       PIC 99.                              IX1064.2
008900*P   05  C-OK                PIC 999.                             IX1064.2
009000*P   05  C-ALL               PIC 999.                             IX1064.2
009100*P   05  C-FAIL              PIC 999.                             IX1064.2
009200*P   05  C-DELETED           PIC 999.                             IX1064.2
009300*P   05  C-INSPECT           PIC 999.                             IX1064.2
009400*P   05  C-NOTE              PIC X(13).                           IX1064.2
009500*P   05  C-INDENT            PIC X.                               IX1064.2
009600*P   05  C-ABORT             PIC X(8).                            IX1064.2
...
010100*C   LABEL RECORDS ARE STANDARD                                   IX1064.2
010200*C   DATA RECORD IS RL-FR1R1-F-G-241                              IX1064.2
...
014200*C   LABEL RECORDS ARE STANDARD                                   IX1064.2
014300*C   DATA RECORD IS IX-FS1R1-F-G-241                              IX1064.2
...
018300*C   LABEL RECORDS ARE STANDARD                                   IX1064.2
018400*C   DATA RECORD IS SQ-FS1R1-F-G-241                              IX1064.2
...
062000*P   OPEN I-O RAW-DATA.                                           IX1064.2
062100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1064.2
062200*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1064.2
062300*P   MOVE "ABORTED " TO C-ABORT.                                  IX1064.2
062400*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1064.2
062500*P   ACCEPT C-DATE  FROM DATE.                                    IX1064.2
062600*P   ACCEPT C-TIME  FROM TIME.                                    IX1064.2
062700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1064.2
062800*PND-E-1.                                                         IX1064.2
062900*P   CLOSE RAW-DATA.                                              IX1064.2
...
064300*P   OPEN I-O RAW-DATA.                                           IX1064.2
064400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1064.2
064500*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1064.2
064600*P   MOVE "OK.     " TO C-ABORT.                                  IX1064.2
064700*P   MOVE PASS-COUNTER TO C-OK.                                   IX1064.2
064800*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1064.2
064900*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1064.2
065000*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1064.2
065100*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1064.2
065200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1064.2
065300*PND-E-2.                                                         IX1064.2
065400*P   CLOSE RAW-DATA.                                              IX1064.2
065500     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1064.2
065600 TERMINATE-CCVS.                                                  IX1064.2
065700*S   EXIT PROGRAM.                                                IX1064.2
065800*SERMINATE-CALL.                                                  IX1064.2
...
072400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1064.2
