...
018000     Linux.                                                       IX2104.2
018100 OBJECT-COMPUTER.                                                 IX2104.2
018200     Linux                                                        IX2104.2
...
018900*P   SELECT RAW-DATA   ASSIGN TO                                  IX2104.2
019000*P   "XXXXX062"                                                   IX2104.2
019100*P          ORGANIZATION IS INDEXED                               IX2104.2
019200*P          ACCESS MODE IS RANDOM                                 IX2104.2
019300*P          RECORD KEY IS RAW-DATA-KEY.                           IX2104.2
019400     SELECT PRINT-FILE ASSIGN TO                                  IX2104.2
019500     "report.log".                                                IX2104.2
019600     SELECT  IX-FS1                                               IX2104.2
019700     ASSIGN TO                                                    IX2104.2
019800     "XXXXX024"                                                   IX2104.2
019900*J   **** X-CARD UNDEFINED ****                                   IX2104.2
...
020800*P                                                                IX2104.2
020900*PD  RAW-DATA.                                                    IX2104.2
021000*P                                                                IX2104.2
021100*P1  RAW-DATA-SATZ.                                               IX2104.2
021200*P   05  RAW-DATA-KEY        PIC X(6).                            IX2104.2
021300*P   05  C-DATE              PIC 9(6).                            IX2104.2
021400*P   05  C-TIME              PIC 9(8).                            IX2104.2
021500*P   05  C-NO-OF-TESTS       PIC 99.                              IX2104.2
021600*P   05  C-OK                PIC 999.                             IX2104.2
021700*P   05  C-ALL               PIC 999.                             IX2104.2
021800*P   05  C-FAIL              PIC 999.                             IX2104.2
021900*P   05  C-DELETED           PIC 999.                             IX2104.2
022000*P   05  C-INSPECT           PIC 999.                             IX2104.2
022100*P   05  C-NOTE              PIC X(13).                           IX2104.2
022200*P   05  C-INDENT            PIC X.                               IX2104.2
022300*P   05  C-ABORT             PIC X(8).                            IX2104.2
...
022800*C   LABEL RECORDS ARE STANDARD                                   IX2104.2
022900*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX2104.2
...
065300*P   OPEN I-O RAW-DATA.                                           IX2104.2
065400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2104.2
065500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2104.2
065600*P   MOVE "ABORTED " TO C-ABORT.                                  IX2104.2
065700*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2104.2
065800*P   ACCEPT C-DATE  FROM DATE.                                    IX2104.2
065900*P   ACCEPT C-TIME  FROM TIME.                                    IX2104.2
066000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2104.2
066100*PND-E-1.                                                         IX2104.2
066200*P   CLOSE RAW-DATA.                                              IX2104.2
...
067600*P   OPEN I-O RAW-DATA.                                           IX2104.2
067700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2104.2
067800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2104.2
067900*P   MOVE "OK.     " TO C-ABORT.                                  IX2104.2
068000*P   MOVE PASS-COUNTER TO C-OK.                                   IX2104.2
068100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2104.2
068200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2104.2
068300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2104.2
068400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2104.2
068500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2104.2
068600*PND-E-2.                                                         IX2104.2
068700*P   CLOSE RAW-DATA.                                              IX2104.2
068800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2104.2
068900 TERMINATE-CCVS.                                                  IX2104.2
069000*S   EXIT PROGRAM.                                                IX2104.2
069100*SERMINATE-CALL.                                                  IX2104.2
...
075700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2104.2
