...
018100     Linux.                                                       IX2094.2
018200 OBJECT-COMPUTER.                                                 IX2094.2
018300     Linux.                                                       IX2094.2
018400 INPUT-OUTPUT SECTION.                                            IX2094.2
018500 FILE-CONTROL.                                                    IX2094.2
018600*P   SELECT RAW-DATA   ASSIGN TO                                  IX2094.2
018700*P   "XXXXX062"                                                   IX2094.2
018800*P          ORGANIZATION IS INDEXED                               IX2094.2
018900*P          ACCESS MODE IS RANDOM                                 IX2094.2
019000*P          RECORD KEY IS RAW-DATA-KEY.                           IX2094.2
019100     SELECT PRINT-FILE ASSIGN TO                                  IX2094.2
019200     "report.log".                                                IX2094.2
019300     SELECT  IX-FS1                                               IX2094.2
019400     ASSIGN TO                                                    IX2094.2
019500     "XXXXX024"                                                   IX2094.2
019600*J   **** X-CARD UNDEFINED ****                                   IX2094.2
...
020500*P                                                                IX2094.2
020600*PD  RAW-DATA.                                                    IX2094.2
020700*P                                                                IX2094.2
020800*P1  RAW-DATA-SATZ.                                               IX2094.2
020900*P   05  RAW-DATA-KEY        PIC X(6).                            IX2094.2
021000*P   05  C-DATE              PIC 9(6).                            IX2094.2
021100*P   05  C-TIME              PIC 9(8).                            IX2094.2
021200*P   05  C-NO-OF-TESTS       PIC 99.                              IX2094.2
021300*P   05  C-OK                PIC 999.                             IX2094.2
021400*P   05  C-ALL               PIC 999.                             IX2094.2
021500*P   05  C-FAIL              PIC 999.                             IX2094.2
021600*P   05  C-DELETED           PIC 999.                             IX2094.2
021700*P   05  C-INSPECT           PIC 999.                             IX2094.2
021800*P   05  C-NOTE              PIC X(13).                           IX2094.2
021900*P   05  C-INDENT            PIC X.                               IX2094.2
022000*P   05  C-ABORT             PIC X(8).                            IX2094.2
...
022500*C   LABEL RECORDS ARE STANDARD                                   IX2094.2
022600*C   DATA RECORD IS IX-FS1R1-F-G-240                              IX2094.2
...
064300*P   OPEN I-O RAW-DATA.                                           IX2094.2
064400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2094.2
064500*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2094.2
064600*P   MOVE "ABORTED " TO C-ABORT.                                  IX2094.2
064700*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2094.2
064800*P   ACCEPT C-DATE  FROM DATE.                                    IX2094.2
064900*P   ACCEPT C-TIME  FROM TIME.                                    IX2094.2
065000*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2094.2
065100*PND-E-1.                                                         IX2094.2
065200*P   CLOSE RAW-DATA.                                              IX2094.2
...
066600*P   OPEN I-O RAW-DATA.                                           IX2094.2
066700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2094.2
066800*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2094.2
066900*P   MOVE "OK.     " TO C-ABORT.                                  IX2094.2
067000*P   MOVE PASS-COUNTER TO C-OK.                                   IX2094.2
067100*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2094.2
067200*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2094.2
067300*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2094.2
067400*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2094.2
067500*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2094.2
067600*PND-E-2.                                                         IX2094.2
067700*P   CLOSE RAW-DATA.                                              IX2094.2
067800     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2094.2
067900 TERMINATE-CCVS.                                                  IX2094.2
068000*S   EXIT PROGRAM.                                                IX2094.2
068100*SERMINATE-CALL.                                                  IX2094.2
...
074700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2094.2
