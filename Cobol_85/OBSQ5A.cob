...
002500     Linux.                                                       OBSQ54.2
002600 OBJECT-COMPUTER.                                                 OBSQ54.2
002700     Linux.                                                       OBSQ54.2
002800 INPUT-OUTPUT SECTION.                                            OBSQ54.2
002900 FILE-CONTROL.                                                    OBSQ54.2
003000*P   SELECT RAW-DATA   ASSIGN TO                                  OBSQ54.2
003100*P   "XXXXX062"                                                   OBSQ54.2
003200*P          ORGANIZATION IS INDEXED                               OBSQ54.2
003300*P          ACCESS MODE IS RANDOM                                 OBSQ54.2
003400*P          RECORD KEY IS RAW-DATA-KEY.                           OBSQ54.2
003500     SELECT PRINT-FILE ASSIGN TO                                  OBSQ54.2
003600     "report.log".                                                OBSQ54.2
003700     SELECT SQ-FS3 ASSIGN TO                                      OBSQ54.2
003800     "XXXXX009".                                                  OBSQ54.2
003900     SELECT SQ-FS5 ASSIGN TO                                      OBSQ54.2
004000     "XXXXX005".                                                  OBSQ54.2
004100     SELECT SQ-FS6 ASSIGN TO                                      OBSQ54.2
004200     "XXXXX011".                                                  OBSQ54.2
004300     SELECT SQ-FS7 ASSIGN TO                                      OBSQ54.2
004400     "XXXXX012".                                                  OBSQ54.2
004500     SELECT SQ-FS8 ASSIGN TO                                      OBSQ54.2
004600     "XXXXX013".                                                  OBSQ54.2
...
005500*P                                                                OBSQ54.2
005600*PD  RAW-DATA.                                                    OBSQ54.2
005700*P                                                                OBSQ54.2
005800*P1  RAW-DATA-SATZ.                                               OBSQ54.2
005900*P   05  RAW-DATA-KEY        PIC X(6).                            OBSQ54.2
006000*P   05  C-DATE              PIC 9(6).                            OBSQ54.2
006100*P   05  C-TIME              PIC 9(8).                            OBSQ54.2
006200*P   05  C-NO-OF-TESTS       PIC 99.                              OBSQ54.2
006300*P   05  C-OK                PIC 999.                             OBSQ54.2
006400*P   05  C-ALL               PIC 999.                             OBSQ54.2
006500*P   05  C-FAIL              PIC 999.                             OBSQ54.2
006600*P   05  C-DELETED           PIC 999.                             OBSQ54.2
006700*P   05  C-INSPECT           PIC 999.                             OBSQ54.2
006800*P   05  C-NOTE              PIC X(13).                           OBSQ54.2
006900*P   05  C-INDENT            PIC X.                               OBSQ54.2
007000*P   05  C-ABORT             PIC X(8).                            OBSQ54.2
...
027600*P   OPEN I-O RAW-DATA.                                           OBSQ54.2
027700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ54.2
027800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     OBSQ54.2
027900*P   MOVE "ABORTED " TO C-ABORT.                                  OBSQ54.2
028000*P   ADD 1 TO C-NO-OF-TESTS.                                      OBSQ54.2
028100*P   ACCEPT C-DATE  FROM DATE.                                    OBSQ54.2
028200*P   ACCEPT C-TIME  FROM TIME.                                    OBSQ54.2
028300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             OBSQ54.2
028400*PND-E-1.                                                         OBSQ54.2
028500*P   CLOSE RAW-DATA.                                              OBSQ54.2
...
030000*P   OPEN I-O RAW-DATA.                                           OBSQ54.2
030100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ54.2
030200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     OBSQ54.2
030300*P   MOVE "OK.     " TO C-ABORT.                                  OBSQ54.2
030400*P   MOVE PASS-COUNTER TO C-OK.                                   OBSQ54.2
030500*P   MOVE ERROR-HOLD   TO C-ALL.                                  OBSQ54.2
030600*P   MOVE ERROR-COUNTER TO C-FAIL.                                OBSQ54.2
030700*P   MOVE DELETE-CNT TO C-DELETED.                                OBSQ54.2
030800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           OBSQ54.2
030900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             OBSQ54.2
031000*PND-E-2.                                                         OBSQ54.2
031100*P   CLOSE RAW-DATA.                                              OBSQ54.2
031200 TERMINATE-CCVS.                                                  OBSQ54.2
031300*S   EXIT PROGRAM.                                                OBSQ54.2
031400*SERMINATE-CALL.                                                  OBSQ54.2
...
037900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  OBSQ54.2
