...
005700     Linux.                                                       IX1034.2
005800 OBJECT-COMPUTER.                                                 IX1034.2
005900     Linux.                                                       IX1034.2
006000 INPUT-OUTPUT SECTION.                                            IX1034.2
006100 FILE-CONTROL.                                                    IX1034.2
006200*P   SELECT RAW-DATA   ASSIGN TO                                  IX1034.2
006300*P   "XXXXX062"                                                   IX1034.2
006400*P          ORGANIZATION IS INDEXED                               IX1034.2
006500*P          ACCESS MODE IS RANDOM                                 IX1034.2
006600*P          RECORD KEY IS RAW-DATA-KEY.                           IX1034.2
006700     SELECT PRINT-FILE ASSIGN TO                                  IX1034.2
006800     "report.log".                                                IX1034.2
006900     SELECT   IX-FS1 ASSIGN TO                                    IX1034.2
007000     "XXXXX024"                                                   IX1034.2
007100*J   **** X-CARD UNDEFINED ****                                   IX1034.2
...
007800*P                                                                IX1034.2
007900*PD  RAW-DATA.                                                    IX1034.2
008000*P                                                                IX1034.2
008100*P1  RAW-DATA-SATZ.                                               IX1034.2
008200*P   05  RAW-DATA-KEY        PIC X(6).                            IX1034.2
008300*P   05  C-DATE              PIC 9(6).                            IX1034.2
008400*P   05  C-TIME              PIC 9(8).                            IX1034.2
008500*P   05  C-NO-OF-TESTS       PIC 99.                              IX1034.2
008600*P   05  C-OK                PIC 999.                             IX1034.2
008700*P   05  C-ALL               PIC 999.                             IX1034.2
008800*P   05  C-FAIL              PIC 999.                             IX1034.2
008900*P   05  C-DELETED           PIC 999.                             IX1034.2
009000*P   05  C-INSPECT           PIC 999.                             IX1034.2
009100*P   05  C-NOTE              PIC X(13).                           IX1034.2
009200*P   05  C-INDENT            PIC X.                               IX1034.2
009300*P   05  C-ABORT             PIC X(8).                            IX1034.2
...
009800*C   LABEL RECORD STANDARD                                        IX1034.2
009900*C   DATA RECORDS ARE  IX-FS1R1-F-G-240                           IX1034.2
...
032900*P   OPEN I-O RAW-DATA.                                           IX1034.2
033000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1034.2
033100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1034.2
033200*P   MOVE "ABORTED " TO C-ABORT.                                  IX1034.2
033300*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1034.2
033400*P   ACCEPT C-DATE  FROM DATE.                                    IX1034.2
033500*P   ACCEPT C-TIME  FROM TIME.                                    IX1034.2
033600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1034.2
033700*PND-E-1.                                                         IX1034.2
033800*P   CLOSE RAW-DATA.                                              IX1034.2
...
035200*P   OPEN I-O RAW-DATA.                                           IX1034.2
035300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1034.2
035400*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1034.2
035500*P   MOVE "OK.     " TO C-ABORT.                                  IX1034.2
035600*P   MOVE PASS-COUNTER TO C-OK.                                   IX1034.2
035700*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1034.2
035800*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1034.2
035900*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1034.2
036000*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1034.2
036100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1034.2
036200*PND-E-2.                                                         IX1034.2
036300*P   CLOSE RAW-DATA.                                              IX1034.2
036400     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1034.2
036500 TERMINATE-CCVS.                                                  IX1034.2
036600*S   EXIT PROGRAM.                                                IX1034.2
036700*SERMINATE-CALL.                                                  IX1034.2
...
043300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1034.2
