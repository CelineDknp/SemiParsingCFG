...
004200     Linux.                                                       IX1214.2
004300 OBJECT-COMPUTER.                                                 IX1214.2
004400     Linux.                                                       IX1214.2
004500 INPUT-OUTPUT SECTION.                                            IX1214.2
004600 FILE-CONTROL.                                                    IX1214.2
004700*P   SELECT RAW-DATA   ASSIGN TO                                  IX1214.2
004800*P   "XXXXX062"                                                   IX1214.2
004900*P          ORGANIZATION IS INDEXED                               IX1214.2
005000*P          ACCESS MODE IS RANDOM                                 IX1214.2
005100*P          RECORD KEY IS RAW-DATA-KEY.                           IX1214.2
005200*                                                                 IX1214.2
005300     SELECT PRINT-FILE ASSIGN TO                                  IX1214.2
005400     "report.log".                                                IX1214.2
005500*                                                                 IX1214.2
...
006600*P                                                                IX1214.2
006700*PD  RAW-DATA.                                                    IX1214.2
006800*P                                                                IX1214.2
006900*P1  RAW-DATA-SATZ.                                               IX1214.2
007000*P   05  RAW-DATA-KEY        PIC X(6).                            IX1214.2
007100*P   05  C-DATE              PIC 9(6).                            IX1214.2
007200*P   05  C-TIME              PIC 9(8).                            IX1214.2
007300*P   05  C-NO-OF-TESTS       PIC 99.                              IX1214.2
007400*P   05  C-OK                PIC 999.                             IX1214.2
007500*P   05  C-ALL               PIC 999.                             IX1214.2
007600*P   05  C-FAIL              PIC 999.                             IX1214.2
007700*P   05  C-DELETED           PIC 999.                             IX1214.2
007800*P   05  C-INSPECT           PIC 999.                             IX1214.2
007900*P   05  C-NOTE              PIC X(13).                           IX1214.2
008000*P   05  C-INDENT            PIC X.                               IX1214.2
008100*P   05  C-ABORT             PIC X(8).                            IX1214.2
008200                                                                  IX1214.2
...
009000*C      DATA RECORDS IX-VS2R1-F-G-240 IX-VS2R1-F-G-200            IX1214.2
009100*C                                    IX-VS2R1-F-G-280            IX1214.2
009200*C      LABEL RECORD STANDARD                                     IX1214.2
...
036800*P   OPEN I-O RAW-DATA.                                           IX1214.2
036900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1214.2
037000*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1214.2
037100*P   MOVE "OK.     " TO C-ABORT.                                  IX1214.2
037200*P   MOVE PASS-COUNTER TO C-OK.                                   IX1214.2
037300*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1214.2
037400*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1214.2
037500*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1214.2
037600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1214.2
037700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1214.2
037800*P-END-E-2.                                                       IX1214.2
037900*P   CLOSE RAW-DATA.                                              IX1214.2
...
038300*S   EXIT PROGRAM.                                                IX1214.2
038400*S-TERMINATE-CALL.                                                IX1214.2
...
043800       WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                    IX1214.2
...
048500*P   OPEN I-O RAW-DATA.                                           IX1214.2
048600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1214.2
048700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1214.2
048800*P   MOVE "ABORTED " TO C-ABORT.                                  IX1214.2
048900*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1214.2
049000*P   ACCEPT C-DATE  FROM DATE.                                    IX1214.2
049100*P   ACCEPT C-TIME  FROM TIME.                                    IX1214.2
049200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1214.2
049300*PND-E-1.                                                         IX1214.2
049400*P   CLOSE RAW-DATA.                                              IX1214.2
...
050800*P   OPEN I-O RAW-DATA.                                           IX1214.2
050900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1214.2
051000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1214.2
051100*P   MOVE "OK.     " TO C-ABORT.                                  IX1214.2
051200*P   MOVE PASS-COUNTER TO C-OK.                                   IX1214.2
051300*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1214.2
051400*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1214.2
051500*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1214.2
051600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1214.2
051700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1214.2
051800*PND-E-2.                                                         IX1214.2
051900*P   CLOSE RAW-DATA.                                              IX1214.2
052000     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1214.2
052100 TERMINATE-CCVS.                                                  IX1214.2
052200*S   EXIT PROGRAM.                                                IX1214.2
052300*SERMINATE-CALL.                                                  IX1214.2
...
058900         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1214.2
