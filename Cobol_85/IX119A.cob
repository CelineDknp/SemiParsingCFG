...
004600*P          ACCESS MODE IS RANDOM                                 IX1194.2
...
006400*P                                                                IX1194.2
006500*P1  RAW-DATA-SATZ.                                               IX1194.2
006600*P   05  RAW-DATA-KEY        PIC X(6).                            IX1194.2
006700*P   05  C-DATE              PIC 9(6).                            IX1194.2
006800*P   05  C-TIME              PIC 9(8).                            IX1194.2
006900*P   05  C-NO-OF-TESTS       PIC 99.                              IX1194.2
...
007500*P   05  C-NOTE              PIC X(13).                           IX1194.2
...
036900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1194.2
...
037600*S-TERMINATE-CALL.                                                IX1194.2
...
043500        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1194.2
...
048300*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1194.2
048400*P   ACCEPT C-DATE  FROM DATE.                                    IX1194.2
048500*P   ACCEPT C-TIME  FROM TIME.                                    IX1194.2
...
058300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1194.2
