...
003200     Linux.                                                       SQ2224.2
003300 OBJECT-COMPUTER.                                                 SQ2224.2
003400     Linux.                                                       SQ2224.2
003500 INPUT-OUTPUT SECTION.                                            SQ2224.2
003600 FILE-CONTROL.                                                    SQ2224.2
003700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2224.2
003800*P   "XXXXX062"                                                   SQ2224.2
003900*P          ORGANIZATION IS INDEXED                               SQ2224.2
004000*P          ACCESS MODE IS RANDOM                                 SQ2224.2
004100*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2224.2
004200     SELECT PRINT-FILE ASSIGN TO                                  SQ2224.2
004300     "report.log".                                                SQ2224.2
...
005000*P                                                                SQ2224.2
005100*PD  RAW-DATA.                                                    SQ2224.2
005200*P                                                                SQ2224.2
005300*P1  RAW-DATA-SATZ.                                               SQ2224.2
005400*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2224.2
005500*P   05  C-DATE              PIC 9(6).                            SQ2224.2
005600*P   05  C-TIME              PIC 9(8).                            SQ2224.2
005700*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2224.2
005800*P   05  C-OK                PIC 999.                             SQ2224.2
005900*P   05  C-ALL               PIC 999.                             SQ2224.2
006000*P   05  C-FAIL              PIC 999.                             SQ2224.2
006100*P   05  C-DELETED           PIC 999.                             SQ2224.2
006200*P   05  C-INSPECT           PIC 999.                             SQ2224.2
006300*P   05  C-NOTE              PIC X(13).                           SQ2224.2
006400*P   05  C-INDENT            PIC X.                               SQ2224.2
006500*P   05  C-ABORT             PIC X(8).                            SQ2224.2
006600 FD  PRINT-FILE                                                   SQ2224.2
006700*C   LABEL RECORDS                                                SQ2224.2
006800*C       OMITTED                                                  SQ2224.2
006900*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2224.2
007000               .                                                  SQ2224.2
007100 01  PRINT-REC PICTURE X(120).                                    SQ2224.2
007200 01  DUMMY-RECORD PICTURE X(120).                                 SQ2224.2
007300 FD  SQ-VS7                                                       SQ2224.2
007400*C   LABEL RECORDS ARE STANDARD                                   SQ2224.2
...
009200     02  FILLER     PICTURE X(21).                                SQ2224.2
...
026900*P   OPEN I-O RAW-DATA.                                           SQ2224.2
027000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2224.2
027100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2224.2
027200*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2224.2
027300*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2224.2
027400*P   ACCEPT C-DATE  FROM DATE.                                    SQ2224.2
027500*P   ACCEPT C-TIME  FROM TIME.                                    SQ2224.2
027600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2224.2
027700*PND-E-1.                                                         SQ2224.2
027800*P   CLOSE RAW-DATA.                                              SQ2224.2
...
029300*P   OPEN I-O RAW-DATA.                                           SQ2224.2
029400*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2224.2
029500*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2224.2
029600*P   MOVE "OK.     " TO C-ABORT.                                  SQ2224.2
029700*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2224.2
029800*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2224.2
029900*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2224.2
030000*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2224.2
030100*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2224.2
030200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2224.2
030300*PND-E-2.                                                         SQ2224.2
030400*P   CLOSE RAW-DATA.                                              SQ2224.2
030500 TERMINATE-CCVS.                                                  SQ2224.2
030600*S   EXIT PROGRAM.                                                SQ2224.2
030700*SERMINATE-CALL.                                                  SQ2224.2
...
037200         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2224.2
