...
003500     Linux.                                                       IX2134.2
003600 OBJECT-COMPUTER.                                                 IX2134.2
003700     Linux.                                                       IX2134.2
003800 INPUT-OUTPUT SECTION.                                            IX2134.2
003900 FILE-CONTROL.                                                    IX2134.2
004000*P   SELECT RAW-DATA   ASSIGN TO                                  IX2134.2
004100*P   "XXXXX062"                                                   IX2134.2
004200*P          ORGANIZATION IS INDEXED                               IX2134.2
004300*P          ACCESS MODE IS RANDOM                                 IX2134.2
004400*P          RECORD KEY IS RAW-DATA-KEY.                           IX2134.2
004500     SELECT PRINT-FILE ASSIGN TO                                  IX2134.2
004600     "report.log".                                                IX2134.2
004700     SELECT IX-FS1                                                IX2134.2
004800     ASSIGN TO                                                    IX2134.2
004900     "XXXXX024"                                                   IX2134.2
005000*J   **** X-CARD UNDEFINED ****                                   IX2134.2
...
006600*P                                                                IX2134.2
006700*PD  RAW-DATA.                                                    IX2134.2
006800*P                                                                IX2134.2
006900*P1  RAW-DATA-SATZ.                                               IX2134.2
007000*P   05  RAW-DATA-KEY        PIC X(6).                            IX2134.2
007100*P   05  C-DATE              PIC 9(6).                            IX2134.2
007200*P   05  C-TIME              PIC 9(8).                            IX2134.2
007300*P   05  C-NO-OF-TESTS       PIC 99.                              IX2134.2
007400*P   05  C-OK                PIC 999.                             IX2134.2
007500*P   05  C-ALL               PIC 999.                             IX2134.2
007600*P   05  C-FAIL              PIC 999.                             IX2134.2
007700*P   05  C-DELETED           PIC 999.                             IX2134.2
007800*P   05  C-INSPECT           PIC 999.                             IX2134.2
007900*P   05  C-NOTE              PIC X(13).                           IX2134.2
008000*P   05  C-INDENT            PIC X.                               IX2134.2
008100*P   05  C-ABORT             PIC X(8).                            IX2134.2
...
008600*C   LABEL RECORDS ARE STANDARD                                   IX2134.2
008700*C   DATA RECORD IS IX-FS1-RECORD                                 IX2134.2
...
028100*P   OPEN I-O RAW-DATA.                                           IX2134.2
028200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2134.2
028300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2134.2
028400*P   MOVE "ABORTED " TO C-ABORT.                                  IX2134.2
028500*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2134.2
028600*P   ACCEPT C-DATE  FROM DATE.                                    IX2134.2
028700*P   ACCEPT C-TIME  FROM TIME.                                    IX2134.2
028800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2134.2
028900*PND-E-1.                                                         IX2134.2
029000*P   CLOSE RAW-DATA.                                              IX2134.2
...
029700*P   OPEN I-O RAW-DATA.                                           IX2134.2
029800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2134.2
029900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2134.2
030000*P   MOVE "OK.     " TO C-ABORT.                                  IX2134.2
030100*P   MOVE PASS-COUNTER TO C-OK.                                   IX2134.2
030200*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2134.2
030300*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2134.2
030400*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2134.2
030500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2134.2
030600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2134.2
030700*PND-E-2.                                                         IX2134.2
030800*P   CLOSE RAW-DATA.                                              IX2134.2
030900     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2134.2
031000 TERMINATE-CCVS.                                                  IX2134.2
031100*S   EXIT PROGRAM.                                                IX2134.2
031200*SERMINATE-CALL.                                                  IX2134.2
...
037800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2134.2
