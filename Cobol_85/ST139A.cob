...
010600     Linux.                                                       ST1394.2
010700 OBJECT-COMPUTER.                                                 ST1394.2
010800     Linux.                                                       ST1394.2
...
014300*C   VALUE OF                                                     ST1394.2
014400*C   OCLABELID                                                    ST1394.2
014500*C   "OCDUMMY"                                                    ST1394.2
014600*C   BLOCK CONTAINS 1 RECORDS                                     ST1394.2
014700*G   SYSIN                                                        ST1394.2
...
016300*C   ; VALUE OF                                                   ST1394.2
016400*C   OCLABELID                                                    ST1394.2
016500*C   IS                                                           ST1394.2
016600*C   "OCDUMMY"                                                    ST1394.2
016700*G   SYSIN                                                        ST1394.2
...
018500*C   ; VALUE OF                                                   ST1394.2
018600*C   OCLABELID                                                    ST1394.2
018700*C   IS                                                           ST1394.2
018800*C   "OCDUMMY"                                                    ST1394.2
018900*G   SYSIN                                                        ST1394.2
...
046700*S   EXIT PROGRAM.                                                ST1394.2
046800*SERMINATE-CALL.                                                  ST1394.2
...
053400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  ST1394.2
...
059400*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
059500*X   WRITE   PRINT-REC.                                           ST1394.2
...
061200*X   WRITE PRINT-REC FROM SQ-FS1R1-F-G-132.                       ST1394.2
061300*X   WRITE PRINT-REC FROM REST-OF-1.                              ST1394.2
061400*X   MOVE SPACES TO PRINT-REC.                                    ST1394.2
...
062300*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
062400*X   WRITE   PRINT-REC.                                           ST1394.2
...
063500*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
063600*X   WRITE   PRINT-REC.                                           ST1394.2
...
064900*X   WRITE PRINT-REC FROM SQ-FS2R1-F-G-132.                       ST1394.2
065000*X   WRITE PRINT-REC FROM REST-OF-2.                              ST1394.2
065100*X   MOVE SPACES TO PRINT-REC.                                    ST1394.2
...
066000*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
066100*X   WRITE   PRINT-REC.                                           ST1394.2
...
067500*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
067600*X   WRITE   PRINT-REC.                                           ST1394.2
...
069200*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
069300*X   WRITE   PRINT-REC.                                           ST1394.2
...
069900*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
070000*X   WRITE   PRINT-REC.                                           ST1394.2
...
071600*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
071700*X   WRITE   PRINT-REC.                                           ST1394.2
...
072300*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
072400*X   WRITE   PRINT-REC.                                           ST1394.2
...
074000*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
074100*X   WRITE   PRINT-REC.                                           ST1394.2
...
074700*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
074800*X   WRITE   PRINT-REC.                                           ST1394.2
...
076400*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
076500*X   WRITE   PRINT-REC.                                           ST1394.2
...
077100*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
077200*X   WRITE   PRINT-REC.                                           ST1394.2
...
078800*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
078900*X   WRITE   PRINT-REC.                                           ST1394.2
...
079500*X   MOVE    SPACES TO PRINT-REC.                                 ST1394.2
079600*X   WRITE   PRINT-REC.                                           ST1394.2
...
085200*X   WRITE PRINT-REC FROM SQ-FS3R1-F-G-132.                       ST1394.2
085300*X   WRITE PRINT-REC FROM REST-OF-3.                              ST1394.2
085400*X   MOVE SPACES TO PRINT-REC.                                    ST1394.2
