...
004900*P         ACCESS MODE  IS RANDOM                                 SQ1394.2
...
006200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1394.2
006300               .                                                  SQ1394.2
...
007100*P   05  C-TIME              PIC 9(8).                            SQ1394.2
...
007800*P   05  C-NOTE              PIC X(13).                           SQ1394.2
...
036600         MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1394.2
036700         MOVE    SPACE TO DUMMY-RECORD                            SQ1394.2
036800         WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES                SQ1394.2
036900         MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1394.2
...
037400         MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1394.2
...
042200*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1394.2
042300*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1394.2
042400*P   ACCEPT  C-DATE      FROM DATE.                               SQ1394.2
042500*P   ACCEPT  C-TIME      FROM TIME.                               SQ1394.2
...
044700*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1394.2
...
045100*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1394.2
...
055200         MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1394.2
055300         MOVE  SPACE TO DUMMY-RECORD                              SQ1394.2
055400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1394.2
...
055800         MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1394.2
