...
003300     Linux.                                                       SQ2214.2
003400 OBJECT-COMPUTER.                                                 SQ2214.2
003500     Linux.                                                       SQ2214.2
003600 INPUT-OUTPUT SECTION.                                            SQ2214.2
003700 FILE-CONTROL.                                                    SQ2214.2
003800*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2214.2
003900*P   "XXXXX062"                                                   SQ2214.2
004000*P          ORGANIZATION IS INDEXED                               SQ2214.2
004100*P          ACCESS MODE IS RANDOM                                 SQ2214.2
004200*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2214.2
004300     SELECT PRINT-FILE ASSIGN TO                                  SQ2214.2
004400     "report.log".                                                SQ2214.2
...
005100*P                                                                SQ2214.2
005200*PD  RAW-DATA.                                                    SQ2214.2
005300*P                                                                SQ2214.2
005400*P1  RAW-DATA-SATZ.                                               SQ2214.2
005500*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2214.2
005600*P   05  C-DATE              PIC 9(6).                            SQ2214.2
005700*P   05  C-TIME              PIC 9(8).                            SQ2214.2
005800*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2214.2
005900*P   05  C-OK                PIC 999.                             SQ2214.2
006000*P   05  C-ALL               PIC 999.                             SQ2214.2
006100*P   05  C-FAIL              PIC 999.                             SQ2214.2
006200*P   05  C-DELETED           PIC 999.                             SQ2214.2
006300*P   05  C-INSPECT           PIC 999.                             SQ2214.2
006400*P   05  C-NOTE              PIC X(13).                           SQ2214.2
006500*P   05  C-INDENT            PIC X.                               SQ2214.2
006600*P   05  C-ABORT             PIC X(8).                            SQ2214.2
006700 FD  PRINT-FILE                                                   SQ2214.2
006800*C   LABEL RECORDS                                                SQ2214.2
006900*C       OMITTED                                                  SQ2214.2
007000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2214.2
007100               .                                                  SQ2214.2
007200 01  PRINT-REC PICTURE X(120).                                    SQ2214.2
007300 01  DUMMY-RECORD PICTURE X(120).                                 SQ2214.2
007400 FD  SQ-VS7                                                       SQ2214.2
007500*C   LABEL RECORDS ARE STANDARD                                   SQ2214.2
...
009400     02  FILLER     PICTURE X(21).                                SQ2214.2
...
027100*P   OPEN I-O RAW-DATA.                                           SQ2214.2
027200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2214.2
027300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2214.2
027400*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2214.2
027500*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2214.2
027600*P   ACCEPT C-DATE  FROM DATE.                                    SQ2214.2
027700*P   ACCEPT C-TIME  FROM TIME.                                    SQ2214.2
027800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2214.2
027900*PND-E-1.                                                         SQ2214.2
028000*P   CLOSE RAW-DATA.                                              SQ2214.2
...
029500*P   OPEN I-O RAW-DATA.                                           SQ2214.2
029600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2214.2
029700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2214.2
029800*P   MOVE "OK.     " TO C-ABORT.                                  SQ2214.2
029900*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2214.2
030000*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2214.2
030100*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2214.2
030200*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2214.2
030300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2214.2
030400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2214.2
030500*PND-E-2.                                                         SQ2214.2
030600*P   CLOSE RAW-DATA.                                              SQ2214.2
030700 TERMINATE-CCVS.                                                  SQ2214.2
030800*S   EXIT PROGRAM.                                                SQ2214.2
030900*SERMINATE-CALL.                                                  SQ2214.2
...
037400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2214.2
