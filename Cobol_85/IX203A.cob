...
005200     Linux.                                                       IX2034.2
005300 OBJECT-COMPUTER.                                                 IX2034.2
005400     Linux.                                                       IX2034.2
005500 INPUT-OUTPUT SECTION.                                            IX2034.2
005600 FILE-CONTROL.                                                    IX2034.2
005700*P   SELECT RAW-DATA   ASSIGN TO                                  IX2034.2
005800*P   "XXXXX062"                                                   IX2034.2
005900*P          ORGANIZATION IS INDEXED                               IX2034.2
006000*P          ACCESS MODE IS RANDOM                                 IX2034.2
006100*P          RECORD KEY IS RAW-DATA-KEY.                           IX2034.2
006200     SELECT PRINT-FILE ASSIGN TO                                  IX2034.2
006300     "report.log".                                                IX2034.2
006400     SELECT   IX-FD1 ASSIGN TO                                    IX2034.2
006500     "XXXXX024"                                                   IX2034.2
006600*J   **** X-CARD UNDEFINED ****                                   IX2034.2
...
007200*P                                                                IX2034.2
007300*PD  RAW-DATA.                                                    IX2034.2
007400*P                                                                IX2034.2
007500*P1  RAW-DATA-SATZ.                                               IX2034.2
007600*P   05  RAW-DATA-KEY        PIC X(6).                            IX2034.2
007700*P   05  C-DATE              PIC 9(6).                            IX2034.2
007800*P   05  C-TIME              PIC 9(8).                            IX2034.2
007900*P   05  C-NO-OF-TESTS       PIC 99.                              IX2034.2
008000*P   05  C-OK                PIC 999.                             IX2034.2
008100*P   05  C-ALL               PIC 999.                             IX2034.2
008200*P   05  C-FAIL              PIC 999.                             IX2034.2
008300*P   05  C-DELETED           PIC 999.                             IX2034.2
008400*P   05  C-INSPECT           PIC 999.                             IX2034.2
008500*P   05  C-NOTE              PIC X(13).                           IX2034.2
008600*P   05  C-INDENT            PIC X.                               IX2034.2
008700*P   05  C-ABORT             PIC X(8).                            IX2034.2
...
009200*C   LABEL RECORD STANDARD                                        IX2034.2
009300*C   DATA RECORDS ARE  IX-FD1R1-F-G-240                           IX2034.2
...
031400*P   OPEN I-O RAW-DATA.                                           IX2034.2
031500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2034.2
031600*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2034.2
031700*P   MOVE "ABORTED " TO C-ABORT.                                  IX2034.2
031800*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2034.2
031900*P   ACCEPT C-DATE  FROM DATE.                                    IX2034.2
032000*P   ACCEPT C-TIME  FROM TIME.                                    IX2034.2
032100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2034.2
032200*PND-E-1.                                                         IX2034.2
032300*P   CLOSE RAW-DATA.                                              IX2034.2
...
033700*P   OPEN I-O RAW-DATA.                                           IX2034.2
033800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2034.2
033900*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2034.2
034000*P   MOVE "OK.     " TO C-ABORT.                                  IX2034.2
034100*P   MOVE PASS-COUNTER TO C-OK.                                   IX2034.2
034200*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2034.2
034300*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2034.2
034400*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2034.2
034500*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2034.2
034600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2034.2
034700*PND-E-2.                                                         IX2034.2
034800*P   CLOSE RAW-DATA.                                              IX2034.2
034900     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2034.2
035000 TERMINATE-CCVS.                                                  IX2034.2
035100*S   EXIT PROGRAM.                                                IX2034.2
035200*SERMINATE-CALL.                                                  IX2034.2
...
041800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2034.2
