...
004600     Linux.                                                       SQ1264.2
004700 OBJECT-COMPUTER.                                                 SQ1264.2
004800     Linux.                                                       SQ1264.2
004900 INPUT-OUTPUT SECTION.                                            SQ1264.2
005000 FILE-CONTROL.                                                    SQ1264.2
005100*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1264.2
005200*P   "XXXXX062"                                                   SQ1264.2
005300*P          ORGANIZATION IS INDEXED                               SQ1264.2
005400*P          ACCESS MODE IS RANDOM                                 SQ1264.2
005500*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1264.2
005600     SELECT PRINT-FILE ASSIGN TO                                  SQ1264.2
005700     "report.log".                                                SQ1264.2
...
006600*P                                                                SQ1264.2
006700*PD  RAW-DATA.                                                    SQ1264.2
006800*P                                                                SQ1264.2
006900*P1  RAW-DATA-SATZ.                                               SQ1264.2
007000*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1264.2
007100*P   05  C-DATE              PIC 9(6).                            SQ1264.2
007200*P   05  C-TIME              PIC 9(8).                            SQ1264.2
007300*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1264.2
007400*P   05  C-OK                PIC 999.                             SQ1264.2
007500*P   05  C-ALL               PIC 999.                             SQ1264.2
007600*P   05  C-FAIL              PIC 999.                             SQ1264.2
007700*P   05  C-DELETED           PIC 999.                             SQ1264.2
007800*P   05  C-INSPECT           PIC 999.                             SQ1264.2
007900*P   05  C-NOTE              PIC X(13).                           SQ1264.2
008000*P   05  C-INDENT            PIC X.                               SQ1264.2
008100*P   05  C-ABORT             PIC X(8).                            SQ1264.2
008200                                                                  SQ1264.2
008300 FD  PRINT-FILE                                                   SQ1264.2
008400*C   LABEL RECORDS                                                SQ1264.2
008500*C       OMITTED                                                  SQ1264.2
008600*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1264.2
008700               .                                                  SQ1264.2
008800                                                                  SQ1264.2
...
009400*C      LABEL RECORD STANDARD                                     SQ1264.2
009500               .                                                  SQ1264.2
009600                                                                  SQ1264.2
...
031100*P   OPEN I-O RAW-DATA.                                           SQ1264.2
031200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1264.2
031300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1264.2
031400*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1264.2
031500*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1264.2
031600*P   ACCEPT C-DATE  FROM DATE.                                    SQ1264.2
031700*P   ACCEPT C-TIME  FROM TIME.                                    SQ1264.2
031800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1264.2
031900*PND-E-1.                                                         SQ1264.2
032000*P   CLOSE RAW-DATA.                                              SQ1264.2
...
033800*P   OPEN I-O RAW-DATA.                                           SQ1264.2
033900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1264.2
034000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1264.2
034100*P   MOVE "OK.     " TO C-ABORT.                                  SQ1264.2
034200*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1264.2
034300*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1264.2
034400*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1264.2
034500*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1264.2
034600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1264.2
034700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1264.2
034800*PND-E-2.                                                         SQ1264.2
034900*P   CLOSE RAW-DATA.                                              SQ1264.2
035000 TERMINATE-CCVS.                                                  SQ1264.2
035100*S   EXIT PROGRAM.                                                SQ1264.2
035200*SERMINATE-CALL.                                                  SQ1264.2
...
044500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1264.2
