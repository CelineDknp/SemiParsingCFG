...
003500     Linux.                                                       SQ2204.2
003600 OBJECT-COMPUTER.                                                 SQ2204.2
003700     Linux.                                                       SQ2204.2
003800 INPUT-OUTPUT SECTION.                                            SQ2204.2
003900 FILE-CONTROL.                                                    SQ2204.2
004000*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2204.2
004100*P   "XXXXX062"                                                   SQ2204.2
004200*P          ORGANIZATION IS INDEXED                               SQ2204.2
004300*P          ACCESS MODE IS RANDOM                                 SQ2204.2
004400*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2204.2
004500     SELECT PRINT-FILE ASSIGN TO                                  SQ2204.2
004600     "report.log".                                                SQ2204.2
...
005300*P                                                                SQ2204.2
005400*PD  RAW-DATA.                                                    SQ2204.2
005500*P                                                                SQ2204.2
005600*P1  RAW-DATA-SATZ.                                               SQ2204.2
005700*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2204.2
005800*P   05  C-DATE              PIC 9(6).                            SQ2204.2
005900*P   05  C-TIME              PIC 9(8).                            SQ2204.2
006000*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2204.2
006100*P   05  C-OK                PIC 999.                             SQ2204.2
006200*P   05  C-ALL               PIC 999.                             SQ2204.2
006300*P   05  C-FAIL              PIC 999.                             SQ2204.2
006400*P   05  C-DELETED           PIC 999.                             SQ2204.2
006500*P   05  C-INSPECT           PIC 999.                             SQ2204.2
006600*P   05  C-NOTE              PIC X(13).                           SQ2204.2
006700*P   05  C-INDENT            PIC X.                               SQ2204.2
006800*P   05  C-ABORT             PIC X(8).                            SQ2204.2
006900 FD  PRINT-FILE                                                   SQ2204.2
007000*C   LABEL RECORDS                                                SQ2204.2
007100*C       OMITTED                                                  SQ2204.2
007200*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2204.2
007300               .                                                  SQ2204.2
007400 01  PRINT-REC PICTURE X(120).                                    SQ2204.2
007500 01  DUMMY-RECORD PICTURE X(120).                                 SQ2204.2
007600 FD  SQ-VS7                                                       SQ2204.2
007700*C   LABEL RECORDS ARE STANDARD                                   SQ2204.2
...
009700     02  FILLER     PICTURE X(21).                                SQ2204.2
...
027400*P   OPEN I-O RAW-DATA.                                           SQ2204.2
027500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2204.2
027600*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2204.2
027700*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2204.2
027800*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2204.2
027900*P   ACCEPT C-DATE  FROM DATE.                                    SQ2204.2
028000*P   ACCEPT C-TIME  FROM TIME.                                    SQ2204.2
028100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2204.2
028200*PND-E-1.                                                         SQ2204.2
028300*P   CLOSE RAW-DATA.                                              SQ2204.2
...
029800*P   OPEN I-O RAW-DATA.                                           SQ2204.2
029900*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2204.2
030000*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2204.2
030100*P   MOVE "OK.     " TO C-ABORT.                                  SQ2204.2
030200*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2204.2
030300*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2204.2
030400*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2204.2
030500*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2204.2
030600*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2204.2
030700*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2204.2
030800*PND-E-2.                                                         SQ2204.2
030900*P   CLOSE RAW-DATA.                                              SQ2204.2
031000 TERMINATE-CCVS.                                                  SQ2204.2
031100*S   EXIT PROGRAM.                                                SQ2204.2
031200*SERMINATE-CALL.                                                  SQ2204.2
...
037700         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2204.2
