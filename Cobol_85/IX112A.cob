...
003800     Linux.                                                       IX1124.2
003900 OBJECT-COMPUTER.                                                 IX1124.2
004000     Linux.                                                       IX1124.2
004100 INPUT-OUTPUT SECTION.                                            IX1124.2
004200 FILE-CONTROL.                                                    IX1124.2
004300*P   SELECT RAW-DATA   ASSIGN TO                                  IX1124.2
004400*P   "XXXXX062"                                                   IX1124.2
004500*P          ORGANIZATION IS INDEXED                               IX1124.2
004600*P          ACCESS MODE IS RANDOM                                 IX1124.2
004700*P          RECORD KEY IS RAW-DATA-KEY.                           IX1124.2
004800*                                                                 IX1124.2
004900     SELECT PRINT-FILE ASSIGN TO                                  IX1124.2
005000     "report.log".                                                IX1124.2
005100*                                                                 IX1124.2
...
006200*P                                                                IX1124.2
006300*PD  RAW-DATA.                                                    IX1124.2
006400*P                                                                IX1124.2
006500*P1  RAW-DATA-SATZ.                                               IX1124.2
006600*P   05  RAW-DATA-KEY        PIC X(6).                            IX1124.2
006700*P   05  C-DATE              PIC 9(6).                            IX1124.2
006800*P   05  C-TIME              PIC 9(8).                            IX1124.2
006900*P   05  C-NO-OF-TESTS       PIC 99.                              IX1124.2
007000*P   05  C-OK                PIC 999.                             IX1124.2
007100*P   05  C-ALL               PIC 999.                             IX1124.2
007200*P   05  C-FAIL              PIC 999.                             IX1124.2
007300*P   05  C-DELETED           PIC 999.                             IX1124.2
007400*P   05  C-INSPECT           PIC 999.                             IX1124.2
007500*P   05  C-NOTE              PIC X(13).                           IX1124.2
007600*P   05  C-INDENT            PIC X.                               IX1124.2
007700*P   05  C-ABORT             PIC X(8).                            IX1124.2
007800                                                                  IX1124.2
...
008600*C      DATA RECORDS IX-VS2R1-F-G-240 IX-VS2R1-F-G-200            IX1124.2
008700*C                                    IX-VS2R1-F-G-280            IX1124.2
008800*C      LABEL RECORD STANDARD                                     IX1124.2
...
036400*P   OPEN I-O RAW-DATA.                                           IX1124.2
036500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1124.2
036600*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1124.2
036700*P   MOVE "OK.     " TO C-ABORT.                                  IX1124.2
036800*P   MOVE PASS-COUNTER TO C-OK.                                   IX1124.2
036900*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1124.2
037000*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1124.2
037100*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1124.2
037200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1124.2
037300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1124.2
037400*P-END-E-2.                                                       IX1124.2
037500*P   CLOSE RAW-DATA.                                              IX1124.2
...
037900*S   EXIT PROGRAM.                                                IX1124.2
038000*S-TERMINATE-CALL.                                                IX1124.2
...
043400       WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                    IX1124.2
...
048100*P   OPEN I-O RAW-DATA.                                           IX1124.2
048200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1124.2
048300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1124.2
048400*P   MOVE "ABORTED " TO C-ABORT.                                  IX1124.2
048500*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1124.2
048600*P   ACCEPT C-DATE  FROM DATE.                                    IX1124.2
048700*P   ACCEPT C-TIME  FROM TIME.                                    IX1124.2
048800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1124.2
048900*PND-E-1.                                                         IX1124.2
049000*P   CLOSE RAW-DATA.                                              IX1124.2
...
050400*P   OPEN I-O RAW-DATA.                                           IX1124.2
050500*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1124.2
050600*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1124.2
050700*P   MOVE "OK.     " TO C-ABORT.                                  IX1124.2
050800*P   MOVE PASS-COUNTER TO C-OK.                                   IX1124.2
050900*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1124.2
051000*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1124.2
051100*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1124.2
051200*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1124.2
051300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1124.2
051400*PND-E-2.                                                         IX1124.2
051500*P   CLOSE RAW-DATA.                                              IX1124.2
051600     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1124.2
051700 TERMINATE-CCVS.                                                  IX1124.2
051800*S   EXIT PROGRAM.                                                IX1124.2
051900*SERMINATE-CALL.                                                  IX1124.2
...
058500         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1124.2
