...
004400     Linux.                                                       SQ1074.2
004500 OBJECT-COMPUTER.                                                 SQ1074.2
004600     Linux.                                                       SQ1074.2
004700 INPUT-OUTPUT SECTION.                                            SQ1074.2
004800 FILE-CONTROL.                                                    SQ1074.2
004900*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1074.2
005000*P   "XXXXX062"                                                   SQ1074.2
005100*P          ORGANIZATION IS INDEXED                               SQ1074.2
005200*P          ACCESS MODE IS RANDOM                                 SQ1074.2
005300*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1074.2
005400     SELECT PRINT-FILE ASSIGN TO                                  SQ1074.2
005500     "report.log".                                                SQ1074.2
...
006200*P                                                                SQ1074.2
006300*PD  RAW-DATA.                                                    SQ1074.2
006400*P                                                                SQ1074.2
006500*P1  RAW-DATA-SATZ.                                               SQ1074.2
006600*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1074.2
006700*P   05  C-DATE              PIC 9(6).                            SQ1074.2
006800*P   05  C-TIME              PIC 9(8).                            SQ1074.2
006900*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1074.2
007000*P   05  C-OK                PIC 999.                             SQ1074.2
007100*P   05  C-ALL               PIC 999.                             SQ1074.2
007200*P   05  C-FAIL              PIC 999.                             SQ1074.2
007300*P   05  C-DELETED           PIC 999.                             SQ1074.2
007400*P   05  C-INSPECT           PIC 999.                             SQ1074.2
007500*P   05  C-NOTE              PIC X(13).                           SQ1074.2
007600*P   05  C-INDENT            PIC X.                               SQ1074.2
007700*P   05  C-ABORT             PIC X(8).                            SQ1074.2
007800 FD  PRINT-FILE                                                   SQ1074.2
007900*C   LABEL RECORDS                                                SQ1074.2
008000*C       OMITTED                                                  SQ1074.2
008100*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1074.2
008200               .                                                  SQ1074.2
008300 01  PRINT-REC PICTURE X(120).                                    SQ1074.2
008400 01  DUMMY-RECORD PICTURE X(120).                                 SQ1074.2
008500 FD  SQ-VS7                                                       SQ1074.2
008600*C   LABEL RECORDS ARE STANDARD                                   SQ1074.2
...
010400     02  FILLER     PICTURE X(21).                                SQ1074.2
...
028100*P   OPEN I-O RAW-DATA.                                           SQ1074.2
028200*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1074.2
028300*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1074.2
028400*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1074.2
028500*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1074.2
028600*P   ACCEPT C-DATE  FROM DATE.                                    SQ1074.2
028700*P   ACCEPT C-TIME  FROM TIME.                                    SQ1074.2
028800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1074.2
028900*PND-E-1.                                                         SQ1074.2
029000*P   CLOSE RAW-DATA.                                              SQ1074.2
...
030500*P   OPEN I-O RAW-DATA.                                           SQ1074.2
030600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1074.2
030700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1074.2
030800*P   MOVE "OK.     " TO C-ABORT.                                  SQ1074.2
030900*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1074.2
031000*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1074.2
031100*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1074.2
031200*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1074.2
031300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1074.2
031400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1074.2
031500*PND-E-2.                                                         SQ1074.2
031600*P   CLOSE RAW-DATA.                                              SQ1074.2
031700 TERMINATE-CCVS.                                                  SQ1074.2
031800*S   EXIT PROGRAM.                                                SQ1074.2
031900*SERMINATE-CALL.                                                  SQ1074.2
...
038400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1074.2
