...
003800     Linux.                                                       SQ1304.2
003900 OBJECT-COMPUTER.                                                 SQ1304.2
004000     Linux.                                                       SQ1304.2
004100*                                                                 SQ1304.2
004200 INPUT-OUTPUT SECTION.                                            SQ1304.2
004300 FILE-CONTROL.                                                    SQ1304.2
004400     SELECT PRINT-FILE ASSIGN TO                                  SQ1304.2
004500     "report.log".                                                SQ1304.2
004600*                                                                 SQ1304.2
004700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1304.2
004800*P   "XXXXX062"                                                   SQ1304.2
004900*P         ORGANIZATION IS INDEXED                                SQ1304.2
005000*P         ACCESS MODE  IS RANDOM                                 SQ1304.2
005100*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1304.2
005200*P                                                                SQ1304.2
...
006100*C   LABEL RECORDS                                                SQ1304.2
006200*C       OMITTED                                                  SQ1304.2
006300*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1304.2
006400               .                                                  SQ1304.2
006500 01  PRINT-REC    PICTURE X(120).                                 SQ1304.2
006600 01  DUMMY-RECORD PICTURE X(120).                                 SQ1304.2
006700*P                                                                SQ1304.2
006800*PD  RAW-DATA.                                                    SQ1304.2
006900*P1  RAW-DATA-SATZ.                                               SQ1304.2
007000*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1304.2
007100*P   05  C-DATE              PIC 9(6).                            SQ1304.2
007200*P   05  C-TIME              PIC 9(8).                            SQ1304.2
007300*P   05  NO-OF-TESTS         PIC 99.                              SQ1304.2
007400*P   05  C-OK                PIC 999.                             SQ1304.2
007500*P   05  C-ALL               PIC 999.                             SQ1304.2
007600*P   05  C-FAIL              PIC 999.                             SQ1304.2
007700*P   05  C-DELETED           PIC 999.                             SQ1304.2
007800*P   05  C-INSPECT           PIC 999.                             SQ1304.2
007900*P   05  C-NOTE              PIC X(13).                           SQ1304.2
008000*P   05  C-INDENT            PIC X.                               SQ1304.2
008100*P   05  C-ABORT             PIC X(8).                            SQ1304.2
008200*                                                                 SQ1304.2
008300 FD  SQ-FS1                                                       SQ1304.2
008400*C   LABEL RECORD IS STANDARD                                     SQ1304.2
008500                .                                                 SQ1304.2
...
030300*P   OPEN    I-O RAW-DATA.                                        SQ1304.2
030400*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1304.2
030500*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1304.2
030600*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1304.2
030700*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1304.2
030800*P   ACCEPT  C-DATE      FROM DATE.                               SQ1304.2
030900*P   ACCEPT  C-TIME      FROM TIME.                               SQ1304.2
031000*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1304.2
031100*PND-E-1.                                                         SQ1304.2
031200*P   CLOSE   RAW-DATA.                                            SQ1304.2
...
033000*P   OPEN    I-O RAW-DATA.                                        SQ1304.2
033100*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1304.2
033200*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1304.2
033300*P   MOVE   "OK.     " TO C-ABORT.                                SQ1304.2
033400*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1304.2
033500*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1304.2
033600*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1304.2
033700*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1304.2
033800*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1304.2
033900*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1304.2
034000*PND-E-2.                                                         SQ1304.2
034100*P   CLOSE   RAW-DATA.                                            SQ1304.2
034200 TERMINATE-CCVS.                                                  SQ1304.2
034300*S   EXIT    PROGRAM.                                             SQ1304.2
...
043500     IF RECORD-COUNT GREATER 50                                   SQ1304.2
043600         MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1304.2
043700         MOVE  SPACE TO DUMMY-RECORD                              SQ1304.2
043800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1304.2
043900         MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1304.2
044000         MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1304.2
044100         MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1304.2
044200         MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1304.2
044300         MOVE  ZERO TO RECORD-COUNT.                              SQ1304.2
