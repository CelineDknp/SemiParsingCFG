...
007300*P                                                                OBSQ34.2
007400*PD  RAW-DATA.                                                    OBSQ34.2
007500*P                                                                OBSQ34.2
007600*P1  RAW-DATA-SATZ.                                               OBSQ34.2
007700*P   05  RAW-DATA-KEY        PIC X(6).                            OBSQ34.2
007800*P   05  C-DATE              PIC 9(6).                            OBSQ34.2
007900*P   05  C-TIME              PIC 9(8).                            OBSQ34.2
008000*P   05  C-NO-OF-TESTS       PIC 99.                              OBSQ34.2
008100*P   05  C-OK                PIC 999.                             OBSQ34.2
008200*P   05  C-ALL               PIC 999.                             OBSQ34.2
008300*P   05  C-FAIL              PIC 999.                             OBSQ34.2
008400*P   05  C-DELETED           PIC 999.                             OBSQ34.2
008500*P   05  C-INSPECT           PIC 999.                             OBSQ34.2
008600*P   05  C-NOTE              PIC X(13).                           OBSQ34.2
008700*P   05  C-INDENT            PIC X.                               OBSQ34.2
008800*P   05  C-ABORT             PIC X(8).                            OBSQ34.2
...
030500*P   OPEN I-O RAW-DATA.                                           OBSQ34.2
030600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ34.2
030700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     OBSQ34.2
030800*P   MOVE "ABORTED " TO C-ABORT.                                  OBSQ34.2
030900*P   ADD 1 TO C-NO-OF-TESTS.                                      OBSQ34.2
031000*P   ACCEPT C-DATE  FROM DATE.                                    OBSQ34.2
031100*P   ACCEPT C-TIME  FROM TIME.                                    OBSQ34.2
031200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             OBSQ34.2
031300*PND-E-1.                                                         OBSQ34.2
031400*P   CLOSE RAW-DATA.                                              OBSQ34.2
...
032900*P   OPEN I-O RAW-DATA.                                           OBSQ34.2
033000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            OBSQ34.2
033100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     OBSQ34.2
033200*P   MOVE "OK.     " TO C-ABORT.                                  OBSQ34.2
033300*P   MOVE PASS-COUNTER TO C-OK.                                   OBSQ34.2
033400*P   MOVE ERROR-HOLD   TO C-ALL.                                  OBSQ34.2
033500*P   MOVE ERROR-COUNTER TO C-FAIL.                                OBSQ34.2
033600*P   MOVE DELETE-CNT TO C-DELETED.                                OBSQ34.2
033700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           OBSQ34.2
033800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             OBSQ34.2
033900*PND-E-2.                                                         OBSQ34.2
034000*P   CLOSE RAW-DATA.                                              OBSQ34.2
034100 TERMINATE-CCVS.                                                  OBSQ34.2
034200*S   EXIT PROGRAM.                                                OBSQ34.2
034300*SERMINATE-CALL.                                                  OBSQ34.2
...
040800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  OBSQ34.2
