...
007200     Linux.                                                       IX2044.2
007300 OBJECT-COMPUTER.                                                 IX2044.2
007400     Linux.                                                       IX2044.2
007500 INPUT-OUTPUT SECTION.                                            IX2044.2
007600 FILE-CONTROL.                                                    IX2044.2
007700*P   SELECT RAW-DATA   ASSIGN TO                                  IX2044.2
007800*P   "XXXXX062"                                                   IX2044.2
007900*P          ORGANIZATION IS INDEXED                               IX2044.2
008000*P          ACCESS MODE IS RANDOM                                 IX2044.2
008100*P          RECORD KEY IS RAW-DATA-KEY.                           IX2044.2
008200     SELECT PRINT-FILE ASSIGN TO                                  IX2044.2
008300     "report.log".                                                IX2044.2
008400     SELECT IX-FD2 ASSIGN                                         IX2044.2
008500     "XXXXX025"                                                   IX2044.2
008600*J   **** X-CARD UNDEFINED ****                                   IX2044.2
...
009300*P                                                                IX2044.2
009400*PD  RAW-DATA.                                                    IX2044.2
009500*P                                                                IX2044.2
009600*P1  RAW-DATA-SATZ.                                               IX2044.2
009700*P   05  RAW-DATA-KEY        PIC X(6).                            IX2044.2
009800*P   05  C-DATE              PIC 9(6).                            IX2044.2
009900*P   05  C-TIME              PIC 9(8).                            IX2044.2
010000*P   05  C-NO-OF-TESTS       PIC 99.                              IX2044.2
010100*P   05  C-OK                PIC 999.                             IX2044.2
010200*P   05  C-ALL               PIC 999.                             IX2044.2
010300*P   05  C-FAIL              PIC 999.                             IX2044.2
010400*P   05  C-DELETED           PIC 999.                             IX2044.2
010500*P   05  C-INSPECT           PIC 999.                             IX2044.2
010600*P   05  C-NOTE              PIC X(13).                           IX2044.2
010700*P   05  C-INDENT            PIC X.                               IX2044.2
010800*P   05  C-ABORT             PIC X(8).                            IX2044.2
...
011300*C   LABEL RECORDS ARE STANDARD                                   IX2044.2
011400*C   DATA RECORDS IX-FD2R1-F-G-240                                IX2044.2
...
036700*P   OPEN I-O RAW-DATA.                                           IX2044.2
036800*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2044.2
036900*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX2044.2
037000*P   MOVE "ABORTED " TO C-ABORT.                                  IX2044.2
037100*P   ADD 1 TO C-NO-OF-TESTS.                                      IX2044.2
037200*P   ACCEPT C-DATE  FROM DATE.                                    IX2044.2
037300*P   ACCEPT C-TIME  FROM TIME.                                    IX2044.2
037400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX2044.2
037500*PND-E-1.                                                         IX2044.2
037600*P   CLOSE RAW-DATA.                                              IX2044.2
...
039000*P   OPEN I-O RAW-DATA.                                           IX2044.2
039100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX2044.2
039200*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX2044.2
039300*P   MOVE "OK.     " TO C-ABORT.                                  IX2044.2
039400*P   MOVE PASS-COUNTER TO C-OK.                                   IX2044.2
039500*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX2044.2
039600*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX2044.2
039700*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX2044.2
039800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX2044.2
039900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX2044.2
040000*PND-E-2.                                                         IX2044.2
040100*P   CLOSE RAW-DATA.                                              IX2044.2
040200     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX2044.2
040300 TERMINATE-CCVS.                                                  IX2044.2
040400*S   EXIT PROGRAM.                                                IX2044.2
040500*SERMINATE-CALL.                                                  IX2044.2
...
047100         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX2044.2
