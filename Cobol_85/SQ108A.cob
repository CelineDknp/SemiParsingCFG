...
003200     Linux.                                                       SQ1084.2
003300 OBJECT-COMPUTER.                                                 SQ1084.2
003400     Linux.                                                       SQ1084.2
003500 INPUT-OUTPUT SECTION.                                            SQ1084.2
003600 FILE-CONTROL.                                                    SQ1084.2
003700*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1084.2
003800*P   "XXXXX062"                                                   SQ1084.2
003900*P          ORGANIZATION IS INDEXED                               SQ1084.2
004000*P          ACCESS MODE IS RANDOM                                 SQ1084.2
004100*P          RECORD KEY IS RAW-DATA-KEY.                           SQ1084.2
004200     SELECT PRINT-FILE ASSIGN TO                                  SQ1084.2
004300     "report.log".                                                SQ1084.2
...
005000*P                                                                SQ1084.2
005100*PD  RAW-DATA.                                                    SQ1084.2
005200*P                                                                SQ1084.2
005300*P1  RAW-DATA-SATZ.                                               SQ1084.2
005400*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1084.2
005500*P   05  C-DATE              PIC 9(6).                            SQ1084.2
005600*P   05  C-TIME              PIC 9(8).                            SQ1084.2
005700*P   05  C-NO-OF-TESTS       PIC 99.                              SQ1084.2
005800*P   05  C-OK                PIC 999.                             SQ1084.2
005900*P   05  C-ALL               PIC 999.                             SQ1084.2
006000*P   05  C-FAIL              PIC 999.                             SQ1084.2
006100*P   05  C-DELETED           PIC 999.                             SQ1084.2
006200*P   05  C-INSPECT           PIC 999.                             SQ1084.2
006300*P   05  C-NOTE              PIC X(13).                           SQ1084.2
006400*P   05  C-INDENT            PIC X.                               SQ1084.2
006500*P   05  C-ABORT             PIC X(8).                            SQ1084.2
006600 FD  PRINT-FILE                                                   SQ1084.2
006700*C   LABEL RECORDS                                                SQ1084.2
006800*C       OMITTED                                                  SQ1084.2
006900*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1084.2
007000               .                                                  SQ1084.2
007100 01  PRINT-REC PICTURE X(120).                                    SQ1084.2
007200 01  DUMMY-RECORD PICTURE X(120).                                 SQ1084.2
007300 FD  SQ-FS8                                                       SQ1084.2
007400*C   LABEL RECORD STANDARD                                        SQ1084.2
...
027500*P   OPEN I-O RAW-DATA.                                           SQ1084.2
027600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1084.2
027700*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1084.2
027800*P   MOVE "ABORTED " TO C-ABORT.                                  SQ1084.2
027900*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ1084.2
028000*P   ACCEPT C-DATE  FROM DATE.                                    SQ1084.2
028100*P   ACCEPT C-TIME  FROM TIME.                                    SQ1084.2
028200*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1084.2
028300*PND-E-1.                                                         SQ1084.2
028400*P   CLOSE RAW-DATA.                                              SQ1084.2
...
029900*P   OPEN I-O RAW-DATA.                                           SQ1084.2
030000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1084.2
030100*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1084.2
030200*P   MOVE "OK.     " TO C-ABORT.                                  SQ1084.2
030300*P   MOVE PASS-COUNTER TO C-OK.                                   SQ1084.2
030400*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ1084.2
030500*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ1084.2
030600*P   MOVE DELETE-CNT TO C-DELETED.                                SQ1084.2
030700*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1084.2
030800*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1084.2
030900*PND-E-2.                                                         SQ1084.2
031000*P   CLOSE RAW-DATA.                                              SQ1084.2
031100 TERMINATE-CCVS.                                                  SQ1084.2
031200*S   EXIT PROGRAM.                                                SQ1084.2
031300*SERMINATE-CALL.                                                  SQ1084.2
...
037800         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1084.2
