...
003500     Linux.                                                       SQ1374.2
003600 OBJECT-COMPUTER.                                                 SQ1374.2
003700     Linux.                                                       SQ1374.2
003800*                                                                 SQ1374.2
003900 INPUT-OUTPUT SECTION.                                            SQ1374.2
004000 FILE-CONTROL.                                                    SQ1374.2
004100     SELECT PRINT-FILE ASSIGN TO                                  SQ1374.2
004200     "report.log".                                                SQ1374.2
004300*                                                                 SQ1374.2
004400*P   SELECT RAW-DATA   ASSIGN TO                                  SQ1374.2
004500*P   "XXXXX062"                                                   SQ1374.2
004600*P         ORGANIZATION IS INDEXED                                SQ1374.2
004700*P         ACCESS MODE  IS RANDOM                                 SQ1374.2
004800*P         RECORD-KEY   IS RAW-DATA-KEY.                          SQ1374.2
004900*P                                                                SQ1374.2
...
005800*C   LABEL RECORDS                                                SQ1374.2
005900*C       OMITTED                                                  SQ1374.2
006000*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1374.2
006100               .                                                  SQ1374.2
006200 01  PRINT-REC    PICTURE X(120).                                 SQ1374.2
006300 01  DUMMY-RECORD PICTURE X(120).                                 SQ1374.2
006400*P                                                                SQ1374.2
006500*PD  RAW-DATA.                                                    SQ1374.2
006600*P1  RAW-DATA-SATZ.                                               SQ1374.2
006700*P   05  RAW-DATA-KEY        PIC X(6).                            SQ1374.2
006800*P   05  C-DATE              PIC 9(6).                            SQ1374.2
006900*P   05  C-TIME              PIC 9(8).                            SQ1374.2
007000*P   05  NO-OF-TESTS         PIC 99.                              SQ1374.2
007100*P   05  C-OK                PIC 999.                             SQ1374.2
007200*P   05  C-ALL               PIC 999.                             SQ1374.2
007300*P   05  C-FAIL              PIC 999.                             SQ1374.2
007400*P   05  C-DELETED           PIC 999.                             SQ1374.2
007500*P   05  C-INSPECT           PIC 999.                             SQ1374.2
007600*P   05  C-NOTE              PIC X(13).                           SQ1374.2
007700*P   05  C-INDENT            PIC X.                               SQ1374.2
007800*P   05  C-ABORT             PIC X(8).                            SQ1374.2
007900*                                                                 SQ1374.2
008000 FD  SQ-FS4                                                       SQ1374.2
008100*C   LABEL RECORD IS STANDARD                                     SQ1374.2
...
040200     IF RECORD-COUNT GREATER 50                                   SQ1374.2
040300         MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1374.2
040400         MOVE    SPACE TO DUMMY-RECORD                            SQ1374.2
040500         WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES                SQ1374.2
040600         MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1374.2
040700         MOVE    CCVS-C-2 TO DUMMY-RECORD                         SQ1374.2
040800         PERFORM DECL-WRT-LN 2 TIMES                              SQ1374.2
040900         MOVE    HYPHEN-LINE TO DUMMY-RECORD                      SQ1374.2
041000         PERFORM DECL-WRT-LN                                      SQ1374.2
041100         MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1374.2
041200         MOVE    ZERO TO RECORD-COUNT.                            SQ1374.2
...
045500*P   OPEN    I-O RAW-DATA.                                        SQ1374.2
045600*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1374.2
045700*P   READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1374.2
045800*P   MOVE   "ABORTED "   TO C-ABORT.                              SQ1374.2
045900*P   ADD     1           TO C-NO-OF-TESTS.                        SQ1374.2
046000*P   ACCEPT  C-DATE      FROM DATE.                               SQ1374.2
046100*P   ACCEPT  C-TIME      FROM TIME.                               SQ1374.2
046200*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1374.2
046300*PND-E-1.                                                         SQ1374.2
046400*P   CLOSE   RAW-DATA.                                            SQ1374.2
...
048200*P   OPEN    I-O RAW-DATA.                                        SQ1374.2
048300*P   MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1374.2
048400*P   READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1374.2
048500*P   MOVE   "OK.     " TO C-ABORT.                                SQ1374.2
048600*P   MOVE    PASS-COUNTER  TO C-OK.                               SQ1374.2
048700*P   MOVE    ERROR-HOLD    TO C-ALL.                              SQ1374.2
048800*P   MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1374.2
048900*P   MOVE    DELETE-CNT    TO C-DELETED.                          SQ1374.2
049000*P   MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1374.2
049100*P   REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1374.2
049200*PND-E-2.                                                         SQ1374.2
049300*P   CLOSE   RAW-DATA.                                            SQ1374.2
049400 TERMINATE-CCVS.                                                  SQ1374.2
049500*S   EXIT    PROGRAM.                                             SQ1374.2
...
058700     IF RECORD-COUNT GREATER 50                                   SQ1374.2
058800         MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1374.2
058900         MOVE  SPACE TO DUMMY-RECORD                              SQ1374.2
059000         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ1374.2
059100         MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1374.2
059200         MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1374.2
059300         MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1374.2
059400         MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1374.2
059500         MOVE  ZERO TO RECORD-COUNT.                              SQ1374.2
