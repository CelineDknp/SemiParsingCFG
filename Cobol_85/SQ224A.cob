...
002900     Linux.                                                       SQ2244.2
003000 OBJECT-COMPUTER.                                                 SQ2244.2
003100     Linux.                                                       SQ2244.2
003200 INPUT-OUTPUT SECTION.                                            SQ2244.2
003300 FILE-CONTROL.                                                    SQ2244.2
003400*P   SELECT RAW-DATA   ASSIGN TO                                  SQ2244.2
003500*P   "XXXXX062"                                                   SQ2244.2
003600*P          ORGANIZATION IS INDEXED                               SQ2244.2
003700*P          ACCESS MODE IS RANDOM                                 SQ2244.2
003800*P          RECORD KEY IS RAW-DATA-KEY.                           SQ2244.2
003900     SELECT PRINT-FILE ASSIGN TO                                  SQ2244.2
004000     "report.log".                                                SQ2244.2
...
004700*PD  RAW-DATA.                                                    SQ2244.2
004800*P                                                                SQ2244.2
004900*P1  RAW-DATA-SATZ.                                               SQ2244.2
005000*P   05  RAW-DATA-KEY        PIC X(6).                            SQ2244.2
005100*P   05  C-DATE              PIC 9(6).                            SQ2244.2
005200*P   05  C-TIME              PIC 9(8).                            SQ2244.2
005300*P   05  C-NO-OF-TESTS       PIC 99.                              SQ2244.2
005400*P   05  C-OK                PIC 999.                             SQ2244.2
005500*P   05  C-ALL               PIC 999.                             SQ2244.2
005600*P   05  C-FAIL              PIC 999.                             SQ2244.2
005700*P   05  C-DELETED           PIC 999.                             SQ2244.2
005800*P   05  C-INSPECT           PIC 999.                             SQ2244.2
005900*P   05  C-NOTE              PIC X(13).                           SQ2244.2
006000*P   05  C-INDENT            PIC X.                               SQ2244.2
006100*P   05  C-ABORT             PIC X(8).                            SQ2244.2
006200 FD  PRINT-FILE                                                   SQ2244.2
006300*C   LABEL RECORDS                                                SQ2244.2
006400*C       OMITTED                                                  SQ2244.2
006500*C   DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2244.2
006600               .                                                  SQ2244.2
006700 01  PRINT-REC PICTURE X(120).                                    SQ2244.2
006800 01  DUMMY-RECORD PICTURE X(120).                                 SQ2244.2
006900 FD  SQ-VS7                                                       SQ2244.2
007000*C   LABEL RECORDS ARE STANDARD                                   SQ2244.2
...
008500     02  FILLER     PICTURE X(21).                                SQ2244.2
...
027600*P   OPEN I-O RAW-DATA.                                           SQ2244.2
027700*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2244.2
027800*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2244.2
027900*P   MOVE "ABORTED " TO C-ABORT.                                  SQ2244.2
028000*P   ADD 1 TO C-NO-OF-TESTS.                                      SQ2244.2
028100*P   ACCEPT C-DATE  FROM DATE.                                    SQ2244.2
028200*P   ACCEPT C-TIME  FROM TIME.                                    SQ2244.2
028300*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2244.2
028400*PND-E-1.                                                         SQ2244.2
028500*P   CLOSE RAW-DATA.                                              SQ2244.2
...
029500*P   OPEN I-O RAW-DATA.                                           SQ2244.2
029600*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2244.2
029700*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2244.2
029800*P   MOVE "OK.     " TO C-ABORT.                                  SQ2244.2
029900*P   MOVE PASS-COUNTER TO C-OK.                                   SQ2244.2
030000*P   MOVE ERROR-HOLD   TO C-ALL.                                  SQ2244.2
030100*P   MOVE ERROR-COUNTER TO C-FAIL.                                SQ2244.2
030200*P   MOVE DELETE-CNT TO C-DELETED.                                SQ2244.2
030300*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2244.2
030400*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2244.2
030500*PND-E-2.                                                         SQ2244.2
030600*P   CLOSE RAW-DATA.                                              SQ2244.2
030700 TERMINATE-CCVS.                                                  SQ2244.2
030800*S   EXIT PROGRAM.                                                SQ2244.2
030900*SERMINATE-CALL.                                                  SQ2244.2
...
037400         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  SQ2244.2
