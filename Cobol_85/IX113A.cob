...
003900     Linux.                                                       IX1134.2
004000 OBJECT-COMPUTER.                                                 IX1134.2
004100     Linux.                                                       IX1134.2
004200 INPUT-OUTPUT SECTION.                                            IX1134.2
004300 FILE-CONTROL.                                                    IX1134.2
004400*P   SELECT RAW-DATA   ASSIGN TO                                  IX1134.2
004500*P   "XXXXX062"                                                   IX1134.2
004600*P          ORGANIZATION IS INDEXED                               IX1134.2
004700*P          ACCESS MODE IS RANDOM                                 IX1134.2
004800*P          RECORD KEY IS RAW-DATA-KEY.                           IX1134.2
004900*                                                                 IX1134.2
005000     SELECT PRINT-FILE ASSIGN TO                                  IX1134.2
005100     "report.log".                                                IX1134.2
005200*                                                                 IX1134.2
...
006300*P                                                                IX1134.2
006400*PD  RAW-DATA.                                                    IX1134.2
006500*P                                                                IX1134.2
006600*P1  RAW-DATA-SATZ.                                               IX1134.2
006700*P   05  RAW-DATA-KEY        PIC X(6).                            IX1134.2
006800*P   05  C-DATE              PIC 9(6).                            IX1134.2
006900*P   05  C-TIME              PIC 9(8).                            IX1134.2
007000*P   05  C-NO-OF-TESTS       PIC 99.                              IX1134.2
007100*P   05  C-OK                PIC 999.                             IX1134.2
007200*P   05  C-ALL               PIC 999.                             IX1134.2
007300*P   05  C-FAIL              PIC 999.                             IX1134.2
007400*P   05  C-DELETED           PIC 999.                             IX1134.2
007500*P   05  C-INSPECT           PIC 999.                             IX1134.2
007600*P   05  C-NOTE              PIC X(13).                           IX1134.2
007700*P   05  C-INDENT            PIC X.                               IX1134.2
007800*P   05  C-ABORT             PIC X(8).                            IX1134.2
007900                                                                  IX1134.2
...
008700*C      DATA RECORDS IX-FS3R1-F-G-240                             IX1134.2
008800*C      LABEL RECORD STANDARD                                     IX1134.2
...
036000*P   OPEN I-O RAW-DATA.                                           IX1134.2
036100*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1134.2
036200*P   READ RAW-DATA INVALID KEY GO TO D-END-E-2.                   IX1134.2
036300*P   MOVE "OK.     " TO C-ABORT.                                  IX1134.2
036400*P   MOVE PASS-COUNTER TO C-OK.                                   IX1134.2
036500*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1134.2
036600*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1134.2
036700*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1134.2
036800*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1134.2
036900*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO D-END-E-2.           IX1134.2
037000*P-END-E-2.                                                       IX1134.2
037100*P   CLOSE RAW-DATA.                                              IX1134.2
...
037500*S   EXIT PROGRAM.                                                IX1134.2
037600*S-TERMINATE-CALL.                                                IX1134.2
...
043500        WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                   IX1134.2
...
047900*P   OPEN I-O RAW-DATA.                                           IX1134.2
048000*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1134.2
048100*P   READ RAW-DATA INVALID KEY GO TO END-E-1.                     IX1134.2
048200*P   MOVE "ABORTED " TO C-ABORT.                                  IX1134.2
048300*P   ADD 1 TO C-NO-OF-TESTS.                                      IX1134.2
048400*P   ACCEPT C-DATE  FROM DATE.                                    IX1134.2
048500*P   ACCEPT C-TIME  FROM TIME.                                    IX1134.2
048600*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             IX1134.2
048700*PND-E-1.                                                         IX1134.2
048800*P   CLOSE RAW-DATA.                                              IX1134.2
...
050200*P   OPEN I-O RAW-DATA.                                           IX1134.2
050300*P   MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            IX1134.2
050400*P   READ RAW-DATA INVALID KEY GO TO END-E-2.                     IX1134.2
050500*P   MOVE "OK.     " TO C-ABORT.                                  IX1134.2
050600*P   MOVE PASS-COUNTER TO C-OK.                                   IX1134.2
050700*P   MOVE ERROR-HOLD   TO C-ALL.                                  IX1134.2
050800*P   MOVE ERROR-COUNTER TO C-FAIL.                                IX1134.2
050900*P   MOVE DELETE-COUNTER TO C-DELETED.                            IX1134.2
051000*P   MOVE INSPECT-COUNTER TO C-INSPECT.                           IX1134.2
051100*P   REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             IX1134.2
051200*PND-E-2.                                                         IX1134.2
051300*P   CLOSE RAW-DATA.                                              IX1134.2
051400     PERFORM END-ROUTINE THRU END-ROUTINE-13. CLOSE PRINT-FILE.   IX1134.2
051500 TERMINATE-CCVS.                                                  IX1134.2
051600*S   EXIT PROGRAM.                                                IX1134.2
051700*SERMINATE-CALL.                                                  IX1134.2
...
058300         WRITE DUMMY-RECORD AFTER ADVANCING 1 LINES                  IX1134.2
